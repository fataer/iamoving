...
class informeBasicoController extends Controller
{
    ...
    public function store(Request $request) 
    {
		...
		if($request->has('adosado_chalet')) $informe->adosado_chalet = $request->adosado_chalet;
		//
		//
        $informe->lift = $request->lift;
        $informe->ventana_climalit = $request->ventana_climalit;
        ...
        $informe->gastos_incluido_tbasura = $request->gastos_incluido_tbasura;
        ...
        $informe->gastos_tbasura = $request->gastos_tbasura;
        ...
        $informe->garaje_comprar = $request->garaje_comprar;
        $informe->precio_compra_garaje = $request->precio_compra_garaje;
        $informe->garaje_alquilar = $request->garaje_alquilar;
        $informe->precio_alquilar_garaje = $request->precio_alquilar_garaje;
        ...
        if ($request->has('comision_iamoving')) $informe->comision_iamoving = $request->comision_iamoving;
        if ($request->has('comision_iva')) $informe->comision_iva = $request->comision_iva;
        if ($request->has('arras')) $informe->arras = $request->arras;
        if ($request->has('plazo_formalizar')) $informe->plazo_formalizar = $request->plazo_formalizar;
