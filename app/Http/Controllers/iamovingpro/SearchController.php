...
class SearchController extends Controller
{
    ...
    public function index() 
    {
		...
		//->orderBy('created_at', 'DESC')->get();
            ...
            $max = \App\InformeDetalladoCabecera::where('is_sale', '=', request()->category)->where('published',true)->whereIn('estado_inmueble', ['Disponible', 'Reservado','Alquilado','Vendido'])->max('propiedad_precio');           
        ...
        return view('iamovingpro.search.index', compact('data','category','max','city','cityId'));
    }
