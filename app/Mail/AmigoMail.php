...
class AmigoMail extends Mailable
{
    ...
    public function build()
    {
		...
		return $this->subject($this->subject)->view('emails.colaborador', compact('name','email','phone','nombre_calle','numero_calle','piso_calle','ciudad','codigo_postal', 'amigo','es_venta','path_contrato'))->attachData($path_condiciones, 'condiciones_propietario_colaborador_iamoving.pdf')
