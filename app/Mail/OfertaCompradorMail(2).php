...
class OfertaCompradorMail extends Mailable
{
    ...
    public $primerNombre; // Nueva variable para el nombre del primer comprador
    ...
    public function __construct($subject, $inmueble_id, $num_oferta, $email, $arras, $path_contrato, $primerNombre = null)
    {
        ...
        $this->primerNombre = $primerNombre; // Inicializamos la nueva propiedad
    }
    ...
    public function build()
    {
        ...
        $primerNombre = $this->primerNombre; // Obtenemos el valor para pasarlo a la vista
