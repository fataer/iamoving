...
class PropietarioEmail extends Mailable
{
    ...
    public function build()
    {
        ...
        return $this->subject($subject)->view('emails.propietario_registro_inmueble', compact('detalle'))->attachData($path_condiciones, 'condiciones_iamoving.pdf')
