...
class PaqueteserviciosMail extends Mailable
{
    ...
    public function build()
    {
		...
		return $this->subject($this->subject)->view('emails.colabora', compact('dni','name','email','phone','address','avatar','nif_image','nif_image2',  'paquete_servicios','path_contrato'))->attachData($path_condiciones, 'condiciones_paqueteservicios_colaborador_iamoving.pdf')
