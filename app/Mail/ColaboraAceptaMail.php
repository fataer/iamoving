...
class ColaboraAceptaMail extends Mailable
{
   ...
   // public $web;
    ...
    public function build()
    {
		...
		return $this->subject($this->subject)->view('emails.colabora_acepta', compact('dni','name','email','phone','address','avatar','nif_image','nif_image2'))->attachData($path_condiciones, 'condiciones_colaborador_iamoving.pdf')
