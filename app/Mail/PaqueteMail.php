...
class PaqueteMail extends Mailable
{
   ...
   // public $web;
    ...
    public function build()
    {
		...
		return $this->subject($this->subject)->view('emails.colabora', compact('dni','name','email','phone','address','avatar','nif_image','nif_image2', 'paquete_servicios'))->attachData($path_condiciones, 'condiciones_colaborador_paquete_servicios_iamoving_preunies.pdf')
