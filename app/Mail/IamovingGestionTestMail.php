...
class IamovingGestionMail extends Mailable
{
    ...
    public function build()
    {
        ...
        return $this->subject($subject)->view('emails.iamoving_gestion', compact('user','visita','inmueble','admin','isPedido'))->attachData($path_condiciones, 'Terminos_de_Intermediacion_IAMOVING_ONLINE_para_Comprador.pdf')->attachData($path_politicas, 'politica_privacidad_iamoving.pdf');
    }
}
