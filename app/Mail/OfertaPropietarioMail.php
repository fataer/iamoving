...
class OfertaPropietarioMail extends Mailable
{
...
$email= $this->email;
       ...
       $path_condiciones =  file_get_contents("https://iamoving.com/storage/oferta/".$num_oferta."/".$path_contrato);
		...
		->attachData($path_condiciones, 'Oferta Ref. '.$inmueble_id.'.pdf');
    }
}
