...
Route::namespace('iamovingpro')->group(function() {
	// home iamovingpro
	Route::get('/', 'HomeController@index_ini');
	Route::get('/home','HomeController@index_ini')->name('home'); // index

	Route::get('/{lan}', 'HomeController@index');
	Route::get('/home/{lan}','HomeController@index')->name('home'); // index	
