...
mso-bidi-font-family:"Segoe UI Emoji"'>&#128221;</span> 
					Detailed report {{ getTitle(primary) }} <!-- .replace('Dormitorio','Dorm.') }} -->   
                    </a>
...
export default {
    ...
    data() {
        return {
			...
			estancia:0,
            primary: {},
	        hiddenIfNo:['Ensuite bathroom in the bedroom:'],
            currentIndex: 0,
            totalPic:0,
            allPics:[],
            cardTitle:'',
    ...
    methods: {
        ...
        setTitle(idx){
            ...
            this.primary = data;
            //let title = data.title.substring(data.title.indexOf("|", 0)+1,data.title.indexOf("*", 0));
	...
	switch (title) {
				...
				case 'Distribuidor':
					title='Distributor';
					break;	
				case 'Habitación de servicio':
					title='Service Bedroom';
					break;					
				case 'Baño de servicio':
					title='Service Bathroom';
					break;	
				case 'Recibidor':
					title='Hall';
					break;
