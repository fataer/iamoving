    ...
    <Modal>
        <template v-slot:content>
            ...
            <div class="text-center terms" v-if="mode == 1 || mode == 2">
                Al iniciar sesion estas aceptando los <a href="/terminosC-condiciones">términos y condiciones</a> y las <a href="/politica-privacidad">politicas de privacidad</a> de <b>IAMOVING</b>
            </div>
...
export default {
    ...
    methods: {
        register(request) {
            axios.post('/autho/register', request)
                .then((response) => {
        ...
        login(request) {
            axios.post('/autho/login', request)
                .then((response) => {
                    if (response.status == 200) {
        ...
        forgot(request){
            console.log(request);
            axios.post('/autho/retrieve', request)
                .then((response) => {
                    if (response.status == 200) {
                        console.log(response);
        ...
        reset(request,valid){
            if(valid){
                console.log(request);
                axios.post('/autho/reset', request)
                    .then((response) => {
                        if (response.status == 200) {
                            console.log(response);
