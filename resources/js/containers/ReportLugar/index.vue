<template>
    <div class="modal-content animated fadeIn">
        ...
        <div class="modal-body">
            <div class="row"><div class="col-12 text-center"><h5  	style="font-weight:bold;color:#EADD1B;">Barrio: {{ barrio.replace("-","") }}</h5></div>
		</div>
            <div class="lugares-container">
                ...
                <div class="collapse-content" id="lugares">
					...
					<b>Explorando el barrio</b> <!-- .replace('Dormitorio','Dorm.') }} -->   
                    </a>
