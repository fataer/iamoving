    ...
    <div class="modal-content animated fadeIn">
        ...
        <div class="modal-body">
            <div class="edificios-container">
                ...
                <div class="collapse-content" id="edificios">
					<a class="btn-collapse" data-toggle="collapse" href="#collapseedificios" role="button" aria-expanded="true" aria-controls="collapseedificios">
					<i class="far fa-list-alt fa-fw"></i>
					Informe detallado {{ getTitle(primary) }} <!-- .replace('Dormitorio','Dorm.') }} -->   
                    </a>
                    <div class="in collapse show" id="collapseedificios">
                        <div class="row">
...
<script>
import Carousel from '../../components/Carousel/CarouselEdificio'
...
export default {
    ...
    created() {
        axios.post(`/api/edificios/${this.reference}`).then((res) => {
    ...
    computed: {
        ...
        columns() 
        {
            ...
            let mid = Math.ceil(edificios.length / 2)

            for (let col = 0; col < 2; col++) 
            {
                columns.push(edificios.slice(col * mid, col * mid + mid))
            }
            return columns;
        },
        metadata() 
