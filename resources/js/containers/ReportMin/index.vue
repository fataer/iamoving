        ...
        <div class="modal-body">
            <div class="details-container">
                ...
                <!--<div class="collapse-content" id="details">
					<a class="btn-collapse" data-toggle="collapse" href="#collapseDetails" role="button" aria-expanded="false" aria-controls="collapseDetails">
					<i class="far fa-list-alt fa-fw"></i>
					Informe detallado {{ getTitle(primary) }}  
                    </a>
            ...
            for (var i = 0; i < this.cards.length; i++) {
                for (var j = 0; j < this.cards[i].multimedia.length; j++) {
                    if (this.cards[i].multimedia[j].fotos_detalle) {
						...
						this.cards[i].multimedia[j].fotos_detalle = fileNameWithoutExtension + ".jpeg";
                    }
                }
            }
