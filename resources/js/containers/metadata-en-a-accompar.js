        ...
        // Cocina
        {
            ...
            'estado_cocina': {
                ...
                template(data) {
					...
					{
						let template = 'In good state';
					}
					else if (data.estado_cocina == 'Recién reformada' )
					{
						let template = 'Newly renovated';
					}					
          ...
          //  'tipo_cama_dormitorio': 'Tipo de cama:',
            'tipo_cama_dormitorio': {
                ...
                template(data) {
					...
					{
						let template = '2 Singles';
					}	
					else if (data.tipo_cama_dormitorio == 'Mediana' )
					{
						let template = 'Medium size';
					}	
    ...
    'armario': {
      ...
      template: function template(data) {
		...
		//GARAJE
		{
			...
			'situacion': 'Is it in the same building?:'
        },
		//trastero
		{
			'tamano': 'M<sup>2</sup> approx.:',
