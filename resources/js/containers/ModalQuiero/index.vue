                ...
                <template v-if="step == 0">
                    ...
                    <div v-if="!auth">
                        <div class="form-group">
                            <input placeholder="Nombre" type="text" v-model="account.name" class="form-control" autofocus required>
                        </div>
                        <div class="form-group">
                            <input placeholder="Apellidos" type="text" v-model="account.lastname" class="form-control" required>
                        </div>
                        <div class="form-group">
                            <input placeholder="NIF/NIE/PASAPORTE" type="text" v-model="account.dni" class="form-control" required>
                        </div>						
                        <div class="form-group">
                            <input placeholder="Teléfono móvil" type="text" v-model="account.phone" class="form-control" required>
                        </div>
                        <div class="form-group">
                            <input placeholder="Email" type="email" v-model="account.email" class="form-control" required>
                        </div>
                        <div class="form-group">
                            <input placeholder="confirmar email" type="email" v-model="account.email_confirmation" class="form-control" autocomplete="false" required>
                        </div>
                        <div class="form-group">
                            <input placeholder="Clave" type="password" v-model="account.password" class="form-control" required>
                        </div>
                        <div class="form-group">
                            <input placeholder="Confimar Clave" type="password" v-model="account.password_confirmation" class="form-control"  autocomplete="false" required>
                        </div>
                    </div>
                </template>
