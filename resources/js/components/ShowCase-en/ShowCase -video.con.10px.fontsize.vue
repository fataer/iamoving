<template>
    <div class="feature-item">
        <div class="feature-pic set-bg">
            <iframe frameborder="0" height="100%" width="100%" :src="`https://www.youtube.com/embed/${data.video_primary}?autoplay=0&amp;controls=1&amp;showinfo=0&amp;autohide=1&amp;modestbranding=1&amp;rel=0`"></iframe>
            ...
            <div class="room-info-warp">
                <div class="room-info">
                    ...
                    <div class="rf-right">
						...
						<p v-if="!data.bathrooms && data.tipo_inmueble=='Local/Oficina' && data.aseos" ><i class="fas fa-bath"></i> Aseos: {{data.aseos}} </p>
                    </div>
                </div>
            </div>
        </div>
