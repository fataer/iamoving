		...
		<div class="row"  style="background: #f4f3f3;">
			<div class="col-12"  style="background: #f4f3f3;">
				<div class="site-navbar">
					...
					<a href="/iamoving-to-spain" class="site-logo"><img src="{{asset('img/iamoving_blanco.jpeg')}}" style="margin-right: 50px;margin-bottom: 15px;" alt="" width="170px"></a>
					...
					<ul class="main-menu" style="margin-bottom: 14px;">
						...
						<li>
							<a href="/quienes-somos">@if (strpos(url()->current(),"/en")) ABOUT US @else QUIENES SOMOS @endif</a>
						</li>	
						<li>
							<!--<a href="/iamoving-to-spain">@if (strpos(url()->current(),"/en")) ABOUT US @else CONSULTA @endif</a>-->
							<a href="/iamoving-to-spain?ref=external">@if (strpos(url()->current(),"/en")) ABOUT US @else CONSULTA @endif</a>
