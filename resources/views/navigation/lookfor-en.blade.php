...
<!--izquierda-->
 ...
 <div class="d-none d-sm-none d-md-block">
	  ...
	  <div class="header--main-text">
		...
		<h5 class="mt-4 mb-1 d-block d-sm-block d-md-none" style="font-size:1.3em;font-weight:bold;">Do your first visit without leaving home</h5>
		<h5 class="mt-1 mb-1 d-block d-sm-block d-md-none" style="font-size:1.2em;">Easy to rent, buy and sell</h5>
    			...
    			<!--	<select name="category" class="custom-select " style="font-size:1.2em;text-align:center;background-color:#EADD03;font-weight:bold;color:#2D2D37;opacity:.9;">
    				...
    				<div class="btn-group btn-group-toggle" data-toggle="buttons" style="width:67%">
    					<label class="btn btn-outline-dark btn-lg active" id="lblAlquilar" style="border-radius: .01rem;">
    						<input type="radio" name="category" autocomplete="off" checked value="0" id="alquilar" onclick="clickAlquiler();" data-label="#lblAlquilar"> To Rent
    					</label>
    					<label class="btn btn-outline-dark btn-lg"  id="lblComprar" style="margin-left:5px;border-radius: .01rem;">
    						<input type="radio" name="category" autocomplete="off"  value="1"  id="comprar"  onclick="clickComprar();" data-label="#lblComprar"> To Buy
    					</label>
    				</div>				
    			</div>
    		</div>
    		...
    		<form class="row justify-content-center" id="form-reference">-->
    			...
    			<div class="form-group col-6"  style="padding:0">
    				<input type="number" 
    						...
    						placeholder="Nº Ref." style="height: 95.78%;width:64.92%;text-align:center;color:#495057;opacity:.9;border:1px solid #495057;font-size:1.125rem;border-radius: .01rem;padding: .498rem 1.126rem;"  min="1" max="999"
  ...
  <img src="img/familia.jpeg" alt="Mi titulo de la imagen">
	<h2 style="position: absolute;top: 98px;left: 100px;width: 100%;"><span>Do your first visit without leaving home<span>&nbsp;</span><br><span>&nbsp;</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Easy to rent, buy and sell</span></h2>
  </div>  
</div>	
