		...
		<!--<div class="row" style="padding-left: 300px;">-->
			...
			<div class="col-lg-4 col-md-4 footer-widget">
				<div class="contact-widget" style="color: #2d2e35 !important;">				
					<p class="ml-5" style="color: #2d2e35 !important;"><i class="fas fa-gavel"></i><a style="color: #333333" href="/terminosP-condiciones" target="_blank"> Términos y condiciones</a></p>
					...
					<p class="ml-5" style="color: #2d2e35 !important;"><i class="fa fa-phone"></i> <a style="color: #333333" href="{{ url('trabaja-con-nosotros') }}"> Trabaja con Nosotros</a></p>
					<p class="ml-5" style="color: #2d2e35 !important;"><i class="fa fa-envelope"></i> <a style="color: #333333"  href="{{ url('contactanos') }}"> Contáctanos</a></p>															
				</div>
			</div>
			<div class="col-lg-4 col-md-4 footer-widget">
				<div class="contact-widget" style="color: #2d2e35 !important;">
