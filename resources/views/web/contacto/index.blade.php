    ...
    <div class="container my-5">
        <div class="row text-center justify-content-center">
            <div class="col-10">
                ...
                <!--<form action="{{ url('contacto_send') }}"  method="post" id="frm_colabora" onsubmit="loading()" enctype="multipart/form-data">-->
                    <form action="{{ url('contacto_send') }}"  method="post" id="frm_colabora" onsubmit="return validateForm()" enctype="multipart/form-data">                    
                    {!! csrf_field() !!}
