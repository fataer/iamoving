...
@section('content')
<!-- page -->
<section class="page-section single-blog  mt-5">
    <div class="container">
            <div class="row">
            ...
            <div class="col-md-10 singel-blog-content">
                ...
                <div class="row justify-content-center">
                    <div class="col text-center">
                        <img src="/img/logo.iampro.png" alt="IAMPRO logotipo" width="175" class="m-0">
                    </div>
                </div>
                ...
                <p class="my-1 text-center">
                    ...
                    <h2 class="my-4 text-center"><b>¿Conoces a alguien que vaya a alquilar o vender su piso? </b></h2>

                </p>
				<p class="my-4 text-center">
					Indícanos pisos y nosotros nos encargamos de todo. Hacemos fotos, videos, tomamos medidas, y publicamos el inmueble, no sólo en nuestra plataforma, también en los principales medios del sector. Organizamos visitas con potenciales interesados, y realizamos hasta la formalización del contrato.
				</p>	

				<p class="my-4 text-center">
					Cuando tengamos un real potencial inquilino o comprador, te lo enviamos para que tú decidas qué perfil u oferta es más conveniente al interés de tu conocido, la propiedad.
				</p>				
			   ...
			   <button type="button" class="btn btn-iamoving btn-lg btn-block border-warning" 
					...
					<!--<div class="collapse" id="collapseExample">-->
					  <div class="card card-body bg-transparent border-warning">
							<div class="card-body text-success">
							  <p class="card-text text-center">Te llevarás el 50% de la comisión. Es decir, si el piso se alquila por 1000 €/mes, tú, te llevas 500€.</p>
							</div>
					  </div>
					<!--</div>-->
				  ...
				  <div class="col-sm-6">
					...
					<!--<div class="collapse" id="collapseExample">-->
					  <div class="card card-body bg-transparent border-warning">
							<div class="card-body text-success">
							  <p class="card-text text-center">Te llevarás un 1%, es decir, si el piso se vende por 500.000 €, tú, llevas 5.000 €</p>
							</div>
					  </div>
					<!--</div>-->
				...
				<p class="my-4 text-center font-weight-bold subtitle_feature">
					<button type="button" class="btn btn-iamoving  btn-lg active" style=";font-weight:bold;"  data-toggle="modal" data-target="#modalAnuncia">Indica aquí tu piso</button>
				</p>				
				</p>
                ...
                <p class="my-1 text-center">
                    ...
                    <h2 class="my-4 text-center"><b>¿Eres un profesional del sector inmobiliario, llevas muchos inmuebles y no tienes tiempo de atenderlos a todos?</b></h2>

                </p>
				<p class="my-4 text-center">
					Podrás ahorrar muchísimo tiempo y dinero con todo lo que lleva hasta la firma de un contrato. Reportaje fotográfico, miles de llamadas, emails, visitas frustradas, sin contar los costes con publicidad y personal para todas estas gestiones.
				</p>	

				<p class="my-4 text-center">
					Indícanos pisos y nosotros nos encargamos de todo. Hacemos fotos, videos y publicamos el inmueble, no sólo en nuestra plataforma, también en los principales medios del sector. Organizamos visitas con potenciales interesados y cuando tengamos un real potencial inquilino o comprador, te lo enviamos para que tú decidas qué perfil u oferta es más conveniente al interés de tus clientes, la propiedad.
				</p>				
			   ...
			   <button type="button" class="btn btn-iamoving btn-lg btn-block border-warning" 
				  ...
				  <div class="col-sm-6">
					...
					<!--<div class="collapse" id="collapseExample">-->
					  <div class="card card-body bg-transparent border-warning">
							<div class="card-body text-success">
							  <p class="card-text text-center">Nuestra tarifa de servicios es del 1%, es decir, si el piso se vende por 500.000 €, y si tus honorarios son un 4%, serían 15.000 € para ti y 5.000 € para LA PLATAFORMA Iamoving.</p>
							</div>
					  </div>
					<!--</div>-->
				...
				<p class="my-0">
				  ...
				  <!--<button type="button" class="btn btn-iamoving btn-lg btn-block border-warning" data-target="#collapseExample" aria-expanded="false" 
				  aria-controls="collapseExample" aria-haspopup="true">-->
				  Conviértete en agente IamoPro
			      </button>
					...
					<div class="row">
					  <div class="col-sm-6 mb-3 mb-md-0">
						  ...
						  <div class="card-body text-success">
							...
							<p class="card-text text-center">El mercado inmobiliario en el mundo está empezando a cambiar. Las empresas y los profesionales ya han sentido la necesidad de adaptar su visión tradicional, al nuevo mundo en el que vivimos.</p>
							<p class="card-text text-center">Dadas estas enormes transformaciones por las que atraviesan los diferentes modelos de negocios, y también sus consecuencias, uno de los problemas latentes que el futuro apunta, es la falta de empleos.</p>						
							<p class="card-text text-center">Pensando en cómo podemos ayudar a resolver este problema, tenemos la oportunidad única de ofrecer a cualquier persona, una nueva profesión, aquí llamada <img src="/img/logo.iampro.png" alt="IAMPRO logotipo" width="75" class="m-0"></p>						
						  </div>					
					  </div>

					  <div class="col-sm-6">
						  <div class="card-body text-success">
							<p class="card-text text-center">La tecnología, empleada en nuestro modelo de trabajo, significa más libertad para conseguir un mercado sano y seguro. La creencia no debe ser que la tecnología reemplazará a los seres humanos, sino que les ayudará a lograr su mejor versión.</p>						
							<p class="card-text text-center">El modelo de negocio de Iamoving tiene posibilidades de distribuir ganancias en escala, y eso significa ayudar a miles de familias a realizar sus sueños, y llevar una vida digna y armoniosa.</p>						
						  </div>										
					  </div>
					</div>					
				  </div>
                ...
                <!--<div class="text-center my-3">
                     <p></p>
                    <img src="/img/logo.iampro.png" alt="IAMPRO logotipo" class="m-0"  width="175">
				
                                                        
                                                   <h3 class="text-center">Indícanos y ganarás</h3>
                
                </div>				 -->

			@include('web.iampro.includes.anuncia')
