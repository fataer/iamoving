    ...
    <div class="container mb-5">
        <div class="row text-center justify-content-center">
            <div class="col-10">
                ...
                <form action="{{ url('publicado_venta') }}" method="post" id="frm_publicado" onsubmit="loading()" enctype="multipart/form-data">
                    {!! csrf_field() !!}
                   <!-- <div class="row">
             ...
             <div class="form-group">
               <!-- <h2 class="mt-4 mb-4 text-center"><b>VENDIENDO CON IAMOVING</b></h2>-->
                ...
                <p class="my-1 text-center">
                     ...
                     Ahórrate lo más valioso, tu tiempo.
...
<!--              <div class="form-group">
				...
				<b>Confirmanos el día que te gustaría que vayamos para hacer el video, las fotos y los informes del inmueble:</b>
                    ...
                    <div class="form-group form-check text-center">
						<input type="hidden" id="subject" name="subject"  value="Venta">
