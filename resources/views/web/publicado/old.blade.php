    ...
    <div class="container mb-5">
        <div class="row text-center justify-content-center">
            <div class="col-10">
                ...
                <form action="{{ url('publicado_antiguo') }}" method="post" id="frm_publicado" onsubmit="loading()" enctype="multipart/form-data">
                    {!! csrf_field() !!}
                   <!-- <div class="row">
...
<!--              <div class="form-group">
				...
				<b>Confirmanos el día que te gustaría que vayamos para hacer el video, las fotos y los informes del inmueble:</b>
					...
					<input type="hidden" id="subject" name="subject"  value="Antiguo">
