...
@section('content')
    <section class="gallery-section spad" style="padding-top: 20px;padding-bottom: 0px;">
                ...
                @endif													
											...
											<div class="container my-3">
															<div class="section-title text-center my-0"  style="padding-top: 0px;padding-bottom: 0px;">
																...
																<h3 class="text-center mb-0"><b><font face="Agency FB">ALQUILA TOTALMENTE GRATIS Y SIN EXLUSIVAS</font></b></h3>
																<h3 class="text-center mb-0"><b><font face="Agency FB"> Y </font></b></h3>
																<h3 class="text-center mb-0"><b><font face="Agency FB">ADEMÁS GANARÁS UNA BONIFICACIÓN EN EFECTIVO</font></b></h3>
																@else
																	<h3 class="text-center mb-0"><b><font face="Agency FB">VENDE TOTALMENTE GRATIS Y SIN EXLUSIVAS</font></b></h3>
																<h3 class="text-center mb-0"><b><font face="Agency FB"> Y </font></b></h3>
																<h3 class="text-center mb-0"><b><font face="Agency FB">ADEMÁS GANARÁS UNA BONIFICACIÓN EN EFECTIVO</font></b></h3>																
																@endif
															</div>																

															<!--<div class="section-title text-center my-4"  style="padding-top: 0px;padding-bottom: 0px;">
																<h3 class="text-center mb-0"><b><font face="Agency FB">COLABORA CON IAMOVING Y GANARÁS BOFICACIÓN EN FECTIVO</font></b></h3>
															</div>-->
			...
			<section class="collapse-content">
							<div class="container my-0 mt-3">
								<div class="collapse-item">
									<button  class="btn-collapse text-left" style="cursor:pointer;width:100%;border: none;outline:none;"  
									data-toggle="collapse" href="#collapse-busqueda" role="button" aria-expanded="false" aria-controls="collapse-busqueda">
											...
											<ul class="list-group list-group-flush">
												...
												<li class="list-group-item">
													<span class="text-muted">
														Bajo la petición de nuestros usuarios, le buscamos su casa ideal.
													</span>
												</li>
											</ul>
										</div>
								...
								<div class="collapse-item">
									<button  class="btn-collapse text-left" style="cursor:pointer;width:100%;border: none;outline:none;"  
									data-toggle="collapse" href="#collapse-busqueda1" role="button" aria-expanded="false" aria-controls="collapse-busqueda1">
										<!--<i class="fas fa-calendar fa-fw"></i>-->
										2. PUBLICACIÓN
									</button>
									<div class="collapse" id="collapse-busqueda1"> 
										<div class="content-collapse">
											<ul class="list-group list-group-flush">
												...
												<li class="list-group-item">
													<span class="text-muted">
														Creamos un anuncio con una información detallada de tu inmueble, lo publicitamos y así nuestros usuarios podrán conocer en detalle tu piso antes de cada visita, evitándoles visitas innecesarias.
													</span>
												</li>
											</ul>
										</div>
								...
								<!--<div class="collapse-item">
									<button  class="btn-collapse text-left" style="cursor:pointer;width:100%;border: none;outline:none;"  
									data-toggle="collapse" href="#collapse-busqueda2" role="button" aria-expanded="false" aria-controls="collapse-busqueda2">
										
										3. PUBLICACIÓN
									</button>
									<div class="collapse" id="collapse-busqueda2"> 
										<div class="content-collapse">
											<ul class="list-group list-group-flush">

												<li class="list-group-item">
													<span class="text-muted">
														Publicitamos tu inmueble en nuestra plataforma, nuestras redes sociales y en <a href="https://www.idealista.com/" target="_blank">www.idealista.com</a>
													</span>
												</li>
											</ul>
										</div>
								...
								<div class="collapse-item">
									<button  class="btn-collapse text-left" style="cursor:pointer;width:100%;border: none;outline:none;"  
									data-toggle="collapse" href="#collapse-busqueda3" role="button" aria-expanded="false" aria-controls="collapse-busqueda3">
										<!--<i class="fas fa-calendar fa-fw"></i>-->
										3. VISITAS
									</button>
									<div class="collapse" id="collapse-busqueda3"> 
										<div class="content-collapse">
											<ul class="list-group list-group-flush">
												...
												<li class="list-group-item">
													<span class="text-muted">
														Recibirás peticiones de visitas de nuestros usuarios inquilinos, donde tu podrás conocer su perfil antes de cada visita y confirmarla si te interesa, en caso contrario, rechazarla. Escoge el día, la hora y el inquilino que tú prefieras para enseñarle el piso y conocerle en persona.              
													</span>
												</li>
												<li class="list-group-item">
													<span class="text-muted">
														De esta manera, nadie pierde el tiempo visitando o recibiendo visitas que no aportan en nada, nuestro usuario solo visita los inmuebles que realmente les interesa y eliminamos las visitas sin potencial para la propiedad.
													</span>
												</li>												
											</ul>
										</div>
								...
								<!--<div class="collapse-item">
									<button  class="btn-collapse text-left" style="cursor:pointer;width:100%;border: none;outline:none;"  
									data-toggle="collapse" href="#collapse-busqueda4" role="button" aria-expanded="false" aria-controls="collapse-busqueda4">
										4. ESTUDIO DE SOLVENCIA  
									</button>
									<div class="collapse" id="collapse-busqueda4"> 
										<div class="content-collapse">
											<ul class="list-group list-group-flush">

												<li class="list-group-item">
													<span class="text-muted">
														Escoge el día, la hora y el inquilino que tú prefieras para enseñarle el piso en persona.
													</span>
												</li>
											</ul>
										</div>
								...
								<div class="collapse-item">
									<button  class="btn-collapse text-left" style="cursor:pointer;width:100%;border: none;outline:none;"  
									data-toggle="collapse" href="#collapse-busqueda5" role="button" aria-expanded="false" aria-controls="collapse-busqueda5">
										<!--<i class="fas fa-calendar fa-fw"></i>-->
										4. ESTUDIO DE SOLVENCIA
									</button>
									<div class="collapse" id="collapse-busqueda5"> 
										<div class="content-collapse">
											<ul class="list-group list-group-flush">
												<li class="list-group-item">
													<span class="text-muted">
														Me encantó la visita, me cuadra el inquilino, pero ¿puedo comprobar que sea fiable y no un inquilino moroso?
													</span>
												</li>
												<li class="list-group-item">
													<span class="text-muted">
														Sí, a través de un análisis de solvencia, morosidad y viabilidad, comprobaremos que el potencial inquilino sea fiable y no un inquilino moroso.
													</span>
												</li>												
											</ul>
										</div>
								...
								<div class="collapse-item">
									<button  class="btn-collapse text-left" style="cursor:pointer;width:100%;border: none;outline:none;"  
									data-toggle="collapse" href="#collapse-busqueda6" role="button" aria-expanded="false" aria-controls="collapse-busqueda6">
										<!--<i class="fas fa-calendar fa-fw"></i>-->
										5. ASESORÍA JURÍDICA Y FISCAL
									</button>
									<div class="collapse" id="collapse-busqueda6"> 
										<div class="content-collapse">
											<ul class="list-group list-group-flush">
												<li class="list-group-item">
													<span class="text-muted">
														Negociación y redacción del contrato de alquiler en tu nombre y en defensa de tus intereses.
													</span>
												</li>
												<li class="list-group-item">
													<span class="text-muted">
														Resolución de consultas relativas al contrato de arrendamiento por escrito, mediante correo electrónico.
													</span>
												</li>
												<li class="list-group-item">
													<span class="text-muted">
														Redacción y envío de todas aquellas comunicaciones que deban ser remitidas al arrendatario.
													</span>
												</li>
												<li class="list-group-item">
													<span class="text-muted">
														Actualización de la renta anual según IPC.
													</span>
												</li>	
												<li class="list-group-item">
													<span class="text-muted">
														Asesoramiento en cuanto a las distintas obligaciones fiscales que puedan derivarse del contrato de arrendamiento: alta en Hacienda como Arrendador y liquidación de IVA.
													</span>
												</li>
												<li class="list-group-item">
													<span class="text-muted">
														Reclamaciones extrajudiciales en caso de impago de rentas o cualquier otra cantidad asimilable.
													</span>
												</li>											
											</ul>
										</div>
								...
								<div class="collapse-item">
									<button  class="btn-collapse text-left" style="cursor:pointer;width:100%;border: none;outline:none;"  
									data-toggle="collapse" href="#collapse-busqueda7" role="button" aria-expanded="false" aria-controls="collapse-busqueda7">
										<!--<i class="fas fa-calendar fa-fw"></i>-->
										6. ALQUILA GRATIS
									</button>
									<div class="collapse" id="collapse-busqueda7"> 
										<div class="content-collapse">
											<ul class="list-group list-group-flush">
												<li class="list-group-item">
													<span class="text-muted">
														ALQUILA tu casa con IAMOVING, totalmente gratuito, fácil y seguro.
													</span>
												</li>										
											</ul>
										</div>
								...
								<div class="collapse-item">
									<button  class="btn-collapse text-left" style="cursor:pointer;width:100%;border: none;outline:none;"  
									data-toggle="collapse" href="#collapse-busqueda8" role="button" aria-expanded="false" aria-controls="collapse-busqueda8">
										<!--<i class="fas fa-calendar fa-fw"></i>-->
										7. AÚN MÁS…BONIFICACIÓN EN EFECTIVO
									</button>
									<div class="collapse" id="collapse-busqueda8"> 
										<div class="content-collapse">
											<ul class="list-group list-group-flush">
												<li class="list-group-item">
													<span class="text-muted">
														Si nuestro usuario alquila tu casa tu ganarás la mitad de nuestros honorarios que nos paga él, que es una mensualidad de alquiler, es decir si se alquilará por (1.000,00€) tu recibirás de IAMOVING (500,00€) de bonificación en efectivo por alquilar con nosotros. 
													</span>
												</li>										
											</ul>
										</div>
								...
								<div class="collapse-item">
									<button  class="btn-collapse text-left" style="cursor:pointer;width:100%;border: none;outline:none;"  
									data-toggle="collapse" href="#collapse-busqueda9" role="button" aria-expanded="false" aria-controls="collapse-busqueda9">
										<!--<i class="fas fa-calendar fa-fw"></i>-->
										4. ASESORÍA JURÍDICA Y FISCAL
									</button>
									<div class="collapse" id="collapse-busqueda9"> 
										<div class="content-collapse">
											<ul class="list-group list-group-flush">
												<li class="list-group-item">
													<span class="text-muted">
														Negociación y redacción del contrato de arras en tu nombre y en defensa de tus intereses.
													</span>
												</li>										
												<li class="list-group-item">
													<span class="text-muted">
								...
								<div class="collapse-item">
									<button  class="btn-collapse text-left" style="cursor:pointer;width:100%;border: none;outline:none;"  
									data-toggle="collapse" href="#collapse-busqueda10" role="button" aria-expanded="false" aria-controls="collapse-busqueda10">
										<!--<i class="fas fa-calendar fa-fw"></i>-->
										5. VENDE GRATIS
									</button>
								...
								<div class="collapse-item">
									<button  class="btn-collapse text-left" style="cursor:pointer;width:100%;border: none;outline:none;"  
									data-toggle="collapse" href="#collapse-busqueda11" role="button" aria-expanded="false" aria-controls="collapse-busqueda11">
										<!--<i class="fas fa-calendar fa-fw"></i>-->
										6. AÚN MÁS…BONIFICACIÓN EN EFECTIVO
									</button>
									<div class="collapse" id="collapse-busqueda11"> 
										<div class="content-collapse">
											<ul class="list-group list-group-flush">
												<li class="list-group-item">
													<span class="text-muted">
														Si nuestro usuario compra tu casa tu ganarás la mitad de nuestros honorarios que nos paga él, que es un 3%, es decir si se vendiera por (350.000€) tu recibirás de IAMOVING (5.250€) de bonificación en efectivo por vender con nosotros
													</span>
												</li>											
											</ul>
										</div>
			...
			<div class="container my-0 mt-3">				
				...
				@if (strpos(url()->current(),"propietario-alquiler")) 
				<form action="{{ url('propietario-colaborador-iamigo?venta=0') }}" method="post" id="frm_colabora" onsubmit="loading()" enctype="multipart/form-data">
                @else
				<form action="{{ url('propietario-colaborador-iamigo?venta=1') }}" method="post" id="frm_colabora" onsubmit="loading()" enctype="multipart/form-data">
				@endif
                    {!! csrf_field() !!}
                    <div class="row mt-5">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
							...
							@if (strpos(url()->current(),"propietario-alquiler")) 
							<label>**Por razones de seguridad, nuestro usuario solo tendrá acceso al número de la finca una vez que tu veas su perfil de inquilino y confirmes su visita.</label>
							@else
								<label>**Por razones de seguridad, nuestro usuario solo tendrá acceso al número de la finca una vez que tu veas su perfil de comprador y confirmes su visita.</label>
							@endif
                        </div>	
                        <div class="form-group">
							<input placeholder="Piso" type="text" height="1010px" id="piso_calle" name="piso_calle" maxlength="20" class="form-control" required>
							<label>**Por seguridad, no damos el piso a nadie, recomendamos quedar con nuestro usuario en la puerta de la finca. Necesitamos el dato del piso para comprobar la veracidad del inmueble y así proteger a nuestros usuarios de pisos que no existen anunciados en portales inmobiliarios.</label>
                        </div>
                        <div class="form-group">
						...
						@else
						<input type="hidden" name="es_venta" name="es_venta" value="1">	
						@endif
                    <div class="form-group">
                    ...
                    <div class="form-group form-check text-center">
						...
						<label class="form-check-label" for="conditions">He leído y estoy de acuerdo con <a href="/terminos-colaboracion-iamigo" target="_blank">los términos y condiciones</a> y <a href="/politica-privacidad" target="_blank">la política de privacidad </a>de IAMOVING</label>
                    </div>							
                    <!--<div class="form-group">
