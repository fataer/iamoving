    ...
    <div class="container mb-5">
        <div class="row text-center justify-content-center">
            <div class="col-10">
                ...
                <form action="{{ url('colabora_notificar_ceo') }}" method="post" id="frm_colabora" onsubmit="loading()" enctype="multipart/form-data">
                    {!! csrf_field() !!}
                   <!-- <div class="row">
                    ...
                    <div class="form-group form-check text-center">
						...
						<label class="form-check-label" for="conditions">He leído y estoy de acuerdo con <a href="/terminos-ceo" target="_blank">los términos de colaboración CEO</a> y <a href="/politica-privacidad" target="_blank">la política de privacidad </a>de IAMOVING</label>
                    </div>							
                    <!--<div class="form-group">
