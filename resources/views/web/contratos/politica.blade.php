...
<section class="container">
    <div class="text-center mt-5">
        ...
        <h2 class="display-5 py-3">POLÍTICA DE TRATAMIENTO Y PROTECCIÓN DE DATOS</h2>
    </div>    
    <ol class="list-unstyled">
        <li>
            <p>
                La presente politica regula el uso, tratamiento e protección de datos del sitio web <a href="https://www.iamoving.com" style="color:#EADD03;">www.iamoving.com</a> 
            </p>
            <p>
                Responsable: IAMOVING ONLINE, S.L. 
            </p>
            <p>
                Finalidad: Prestar los servicios solicitados y realizar la gestión contable, fiscal y administrativa, así como enviarle comunicaciones comerciales sobre nuestros productos y/o servicios. y enviar comunicaciones comerciales. 
            </p>
            <p>
            ...
            <p>
                Derechos: Tiene derecho a acceder, rectificar y suprimir los datos, así como otros derechos, indicados en la información adicional, que puede ejercer enviando un correo electrónico con copia de NIF a nuestra dirección electrónica: <a href="&#109;&#097;&#105;&#108;&#116;&#111;:&#105;&#110;&#102;&#111;&#064;&#105;&#097;&#109;&#111;&#118;&#105;&#110;&#103;&#046;&#099;&#111;&#109;" style="color:#EADD03;">info@iamoving.com</a></li>
            </p>   
            <p>
                Procedencia: El propio interesado.
            </p>  
            <p>
                Información adicional: Puede consultar información adicional y detallada sobre Protección de Datos en nuestra página web: <a href="https://www.iamoving.com" style="color:#EADD03;">www.iamoving.com</a> 
            </p>                                                           
        </li>
        <li>
            ...
            <!--<ol type="" style="margin-left: 3rem; font-size: 1.125rem; margin-bottom: 1rem;">-->
                <ul style="margin-left: 3rem; font-size: 1.125rem; margin-bottom: 1rem;">
                    <li><b>IAMOVING ONLINE, S.L.</b></li>
                    <li><b>B88297825</b></li>
                    <li><b>Calle Serrano 93, 3º E</b></li>
                    <li><b>Tel: 649623700</b></li>
                    <li><b>Email: <a href="&#109;&#097;&#105;&#108;&#116;&#111;:&#105;&#110;&#102;&#111;&#064;&#105;&#097;&#109;&#111;&#118;&#105;&#110;&#103;&#046;&#099;&#111;&#109;" style="color:#EADD03;">info@iamoving.com</a></b></li>
                </ul>
        ...
        <li>
            <h4>2 - ¿Con qué finalidad tratamos sus datos?</h4>
            <p>
            ...
            <ol type="I" style="margin-left: 3rem; font-size: 1.125rem; margin-bottom: 1rem;">
                <li>
                <p>
        ...
        <li>
            <h4>4 - ¿Cuál es la base de legitimación para el tratamiento de sus datos?</h4>
            <p>
...
<tr>
 <td>Gestión Contable: gestión de facturación con clientes y/o proveedores</td>
 <td>Mantenimiento, desarrollo y control de la relación contractual entre las partes</td>
</tr>
<tr>
 <td>Gestión fiscal: aplicación de retenciones, bonificaciones, etc.</td>
 <td>Mantenimiento, desarrollo y control de la relación contractual entre las partes; Cumplimiento obligaciones legales</td>
</tr>
<tr>
 <td>Gestión administrativa: gestión de logística, almacén, entregas al cliente, recepción de mercancías, etc.</td>
 <td>Mantenimiento, desarrollo y control de la relación contractual entre las partes</td>
</tr>
<tr>
 <td>Marketing: Acciones comerciales sobre nuestros productos o servicios dirigidas a nuestros clientes o aquellas personas que nos han solicitado información relativa en el pasado incluyendo la realización de encuestas de satisfacción a nuestros clientes.</td>
 <td>Consentimiento libre e inequívoco del propio interesado (clientes potenciales), le hacemos constar que la retirada de este consentimiento en ningún caso puede condicionar la ejecución del contrato que hubiera entre las partes; interés legítimo de la compañía sobre la promoción y comercialización de productos o servicios similares a los obtenidos o solicitados por las personas interesadas en el pasado.</td>
</tr>
</table>
            </p>
        ...
        <li>
            ...
            <p>
                Le informamos que sus datos no van a ser cedidos o comunicados a terceros la empresa la única responsable para su tratamiento y custodia.
            </p>
            <p>
        ...
        <li>
            <h4>7 - ¿Cuáles son sus derechos como interesado?</h4>
            <p>
            ...
            <p>
                  <a href="http://www.agpd.es/portalwebAGPD/index-ides-idphp.php" target="_blank" style="color:#EADD03;"> http://www.agpd.es/portalwebAGPD/index-ides-idphp.php</a>
            </p>
            <h4>8 - Publicidad</h4>
            <p>
                De acuerdo con lo dispuesto en la Ley 34/2002, de 11 de Julio, de Servicios de la Sociedad de Información y de Comercio Electrónico, nos comprometemos a no enviar publicidad a través del correo electrónico sin haber recabado antes la expresa autorización del destinatario. El Usuario podrá oponerse al envío de publicidad marcando la casilla correspondiente.
            </p>
            <p>
            </p>
        </li>                                
