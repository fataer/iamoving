    ...
    <section class="gallery-section spad" style="padding-top: 20px;padding-bottom: 0px;">
                ...
                @endif													
														...
														<!--	 <div class="row mt-3">
															...
															<h2 class="card-text text-center mb-5">COLOBORADOR PAQUETE SERVICIOS IAMOVING y BED4EXCHANGE</h2>											
			...
			<div class="container my-0 mt-3">				
				...
				<form action="{{ url('paqueteservicios-colaborador?venta=0') }}" method="post" id="frm_colabora" onsubmit="loading()" enctype="multipart/form-data">
                @else
				<form action="{{ url('paqueteservicios-colaborador?venta=1') }}" method="post" id="frm_colabora" onsubmit="loading()" enctype="multipart/form-data">
				@endif
                    {!! csrf_field() !!}
                    ...
                    <div class="form-group form-check text-center">
						...
						<label class="form-check-label" for="conditions">Al dejarnos tus datos acepto que he leído y estoy de acuerdo con <a href="/terminos-paqueteservicios" target="_blank">los términos de condiciones del paquete de servicios que ofrezco a iamoving y bed4exhange en www.iamoving.com y www.bed4exchange.com</a> y <a href="/politica-privacidad" target="_blank">la política de privacidad </a>de IAMOVING</label>
                    </div>							
                    <!--<div class="form-group">
