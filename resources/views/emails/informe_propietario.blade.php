    ...
    <div style="max-width: 600px; margin: 0 auto;" class="email-container">
            	...
            	<tr>
            		<td class="hero hero-2 bg_black">
                      <div class="text" style="padding: 01em;background-color:white;">
                            ...
                            @if($informe->is_sale == '0')
							<p><span style="color:black">Te envío abajo un par de enlaces con la visita virtual de tu piso y las ventajas de alquilar con nosotros.</span></p>
							@else
							<p><span style="color:black">Te envío abajo un par de enlaces con la visita virtual de tu piso y las ventajas de vender con nosotros.</span></p>
							@endif
                            <p><span style="color:black"><b>VISITA VIRTUAL,</b> <a href="https://iamoving.com/anuncio/{{$informe->id}}" target="_blank"  style="color:#0563C1;">https://iamoving.com/anuncio/{{$informe->id}}</a> ¿Has encontrado algún error en la visita virtual?, por favor, indícanoslo.</span></p>
							 @if($informe->is_sale == '0')
							...
							@else
							<p><span style="color:black"><b>VENTAJAS,</b> <a href="https://iamoving.com/vender" target="_blank"  style="color:#0563C1;">https://iamoving.com/vender</a> (VENDES 100% GRATIS Y SIN EXCLUSIVA).</span></p>
							@endif						
	  ...
	  <!-- <hr>
            <p><span style="color:black">
			 ...
			 <p><span style="color:black">¿Te ha gustado el video? Si quieres, podemos entregarte el video que hemos creado.</span></p>
            <p><span style="color:black">
               <b><u>1. ¿CÓMO FUNCIONA Y QUÉ CONSEGUIMOS?</u></b>
            </span></p>
            <p><span style="color:black">
                Podrás subir el video y las fotos en tus anuncios que ya están publicados en otros canales.
            </span></p>
				...
				@else
                <p><span style="color:black">
                    b. Los compradores dicen que un <b>Tour Virtual</b> les da más confianza que una serie de fotografías convencionales, siendo un valor decisivo a la hora de filtrar sus visitas.
                </span></p>					
				@endif
                <p><span style="color:black">
            ...
            <p><span style="color:black">
				<b>AVISO IMPORTANTE:</b> Todas las imágenes y el vídeo de tu inmueble que hemos creado son exclusivas de <a href="https://iamoving.com/" target="_blank"  style="color:#0563C1;">IAMOVING.COM</a>.
            </span></p>	
            <p><span style="color:black">
