...
<body width="100%" style="margin: 0; padding: 0 !important; mso-line-height-rule: exactly;background-color: #222222;">
    ...
    <div style="max-width: 600px; margin: 0 auto;" class="email-container">
	  ...
	  <!-- <hr>
            ...
            <p><span style="color:black">
				<b>AVISO IMPORTANTE:</b> Todas las imágenes y el vídeo de tu inmueble que hemos creado, son exclusivos de <a href="https://iamoving.com/anuncio/{{$detalle->id}}" target="_blank"  style="color:#0563C1;">IAMOVING.COM</a>.
            </span></p>	
            <p><span style="color:black">
