...
@if ($nif_image) 
	<p><a href="{{str_replace(' ','%20',$nif_image)}}" target="_blank" style="color: #2596be;">{{str_replace(" ","%20",$nif_image)}}</a></p>  
@endif
@if ($nif_image2)  
	<p><a href="{{str_replace(' ','%20',$nif_image2)}}" target="_blank" style="color: #2596be;">{{str_replace(" ","%20",$nif_image2)}}</a></p>  
@endif
@if ($nif2_image)     
	<p><a href="{{str_replace(' ','%20',$nif2_image)}}" target="_blank" style="color: #2596be;">{{str_replace(" ","%20",$nif2_image)}}</a></p>
@endif
@if ($nif2_image2)     
	<p><a href="{{str_replace(' ','%20',$nif2_image2)}}" target="_blank" style="color: #2596be;">{{str_replace(" ","%20",$nif2_image2)}}</a></p>	
@endif
@if ($nif3_image)     
	<p><a href="{{str_replace(' ','%20',$nif3_image)}}" target="_blank" style="color: #2596be;">{{str_replace(" ","%20",$nif3_image)}}</a></p>
@endif
@if ($nif3_image2)     
	<p><a href="{{str_replace(' ','%20',$nif3_image2)}}" target="_blank" style="color: #2596be;">{{str_replace(" ","%20",$nif3_image2)}}</a></p>
@endif
@if ($nif4_image)     
	<p><a href="{{str_replace(' ','%20',$nif4_image)}}" target="_blank" style="color: #2596be;">{{str_replace(" ","%20",$nif4_image)}}</a></p>	
@endif
@if ($nif4_image2)     
	<p><a href="{{str_replace(' ','%20',$nif4_image2)}}" target="_blank" style="color: #2596be;">{{str_replace(" ","%20",$nif4_image2)}}</a></p>
@endif
@if ($nif5_image)     
	<p><a href="{{str_replace(' ','%20',$nif5_image)}}" target="_blank" style="color: #2596be;">{{str_replace(" ","%20",$nif5_image)}}</a></p>	
@endif
@if ($nif5_image2)     
	<p><a href="{{str_replace(' ','%20',$nif5_image2)}}" target="_blank" style="color: #2596be;">{{str_replace(" ","%20",$nif5_image2)}}</a></p>	
@endif
@if ($contrato_image) 
<p><span style="color:black"></u>Contratos</u>:</p>
@endif
@if ($contrato_image)     
	<p><a href="{{str_replace(' ','%20',$contrato_image)}}" target="_blank" style="color: #2596be;">{{str_replace(" ","%20",$contrato_image)}}</a></p>	
@endif
@if ($contrato_image2)     
	<p><a href="{{str_replace(' ','%20',$contrato_image2)}}" target="_blank" style="color: #2596be;">{{str_replace(" ","%20",$contrato_image2)}}</a></p>	
@endif
@if ($contrato2_image)     
	<p><a href="{{str_replace(' ','%20',$contrato2_image)}}" target="_blank" style="color: #2596be;">{{str_replace(" ","%20",$contrato2_image)}}</a></p>	
@endif
@if ($contrato2_image2)     
	<p><a href="{{str_replace(' ','%20',$contrato2_image2)}}" target="_blank" style="color: #2596be;">{{str_replace(" ","%20",$contrato2_image2)}}</a></p>	
@endif
@if ($contrato3_image)     
	<p><a href="{{str_replace(' ','%20',$contrato3_image)}}" target="_blank" style="color: #2596be;">{{str_replace(" ","%20",$contrato3_image)}}</a></p>	
@endif
@if ($contrato3_image2)     
	<p><a href="{{str_replace(' ','%20',$contrato3_image2)}}" target="_blank" style="color: #2596be;">{{str_replace(" ","%20",$contrato3_image2)}}</a></p>	
@endif
@if ($contrato4_image)     
	<p><a href="{{str_replace(' ','%20',$contrato4_image)}}" target="_blank" style="color: #2596be;">{{str_replace(" ","%20",$contrato4_image)}}</a></p>	
@endif
@if ($contrato4_image2)     
	<p><a href="{{str_replace(' ','%20',$contrato4_image2)}}" target="_blank" style="color: #2596be;">{{str_replace(" ","%20",$contrato4_image2)}}</a></p>	
@endif
@if ($contrato5_image)     
	<p><a href="{{str_replace(' ','%20',$contrato5_image)}}" target="_blank" style="color: #2596be;">{{str_replace(" ","%20",$contrato5_image)}}</a></p>	
@endif
@if ($contrato5_image2)     
	<p><a href="{{str_replace(' ','%20',$contrato5_image2)}}" target="_blank" style="color: #2596be;">{{str_replace(" ","%20",$contrato5_image2)}}</a></p>	
@endif
@if ($nomina_image)
<p></u>2 últimas nóminas</u>:</p>
@endif
@if ($nomina_image)     
	<p><a href="{{str_replace(' ','%20',$nomina_image)}}" target="_blank" style="color: #2596be;">{{str_replace(" ","%20",$nomina_image)}}</a></p>	
@endif
@if ($nomina_image2)     
	<p><a href="{{str_replace(' ','%20',$nomina_image2)}}" target="_blank" style="color: #2596be;">{{str_replace(" ","%20",$nomina_image2)}}</a></p>	
@endif
@if ($nomina2_image)     
	<p><a href="{{str_replace(' ','%20',$nomina2_image)}}" target="_blank" style="color: #2596be;">{{str_replace(" ","%20",$nomina2_image)}}</a></p>	
@endif
@if ($nomina2_image2)     	
	<p><a href="{{str_replace(' ','%20',$nomina2_image2)}}" target="_blank" style="color: #2596be;">{{str_replace(" ","%20",$nomina2_image2)}}</a></p>
@endif
@if ($nomina3_image)     
	<p><a href="{{str_replace(' ','%20',$nomina3_image)}}" target="_blank" style="color: #2596be;">{{str_replace(" ","%20",$nomina3_image)}}</a></p>	
@endif
@if ($nomina3_image2)     
	<p><a href="{{str_replace(' ','%20',$nomina3_image2)}}" target="_blank" style="color: #2596be;">{{str_replace(" ","%20",$nomina3_image2)}}</a></p>	
@endif
@if ($nomina4_image)     
	<p><a href="{{str_replace(' ','%20',$nomina4_image)}}" target="_blank" style="color: #2596be;">{{str_replace(" ","%20",$nomina4_image)}}</a></p>	
@endif
@if ($nomina4_image2)     
	<p><a href="{{str_replace(' ','%20',$nomina4_image2)}}" target="_blank" style="color: #2596be;">{{str_replace(" ","%20",$nomina4_image2)}}</a></p>	
@endif
@if ($nomina5_image)     
	<p><a href="{{str_replace(' ','%20',$nomina5_image)}}" target="_blank" style="color: #2596be;">{{str_replace(" ","%20",$nomina5_image)}}</a></p>	
@endif
@if ($nomina5_image2)     
	<p><a href="{{str_replace(' ','%20',$nomina5_image2)}}" target="_blank" style="color: #2596be;">{{str_replace(" ","%20",$nomina5_image2)}}</a></p>	
@endif
...
<p><span style="color:black"></u>Documentos NIF/NIE/Pasaporte</u>:</p>
		@if ($nif_aval_image)     
			<p><a href="{{str_replace(' ','%20',$nif_aval_image)}}" target="_blank" style="color: #2596be;">{{str_replace(" ","%20",$nif_aval_image)}}</a></p>	
		@endif
		@if ($nif_aval_image2)     
			<p><a href="{{str_replace(' ','%20',$nif_aval_image2)}}" target="_blank" style="color: #2596be;">{{str_replace(" ","%20",$nif_aval_image2)}}</a></p>	
		@endif
		@if ($nif2_aval_image)     
			<p><a href="{{str_replace(' ','%20',$nif2_aval_image)}}" target="_blank" style="color: #2596be;">{{str_replace(" ","%20",$nif2_aval_image)}}</a></p>	
		@endif
		@if ($nif2_aval_image2)     
			<p><a href="{{str_replace(' ','%20',$nif2_aval_image2)}}" target="_blank" style="color: #2596be;">{{str_replace(" ","%20",$nif2_aval_image2)}}</a></p>	
		@endif
		@if ($nif3_aval_image)     
			<p><a href="{{str_replace(' ','%20',$nif3_aval_image)}}" target="_blank" style="color: #2596be;">{{str_replace(" ","%20",$nif3_aval_image)}}</a></p>	
		@endif
		@if ($nif3_aval_image2)     
			<p><a href="{{str_replace(' ','%20',$nif3_aval_image2)}}" target="_blank" style="color: #2596be;">{{str_replace(" ","%20",$nif3_aval_image2)}}</a></p>	
		@endif
		@if ($nif4_aval_image)     
			<p><a href="{{str_replace(' ','%20',$nif4_aval_image)}}" target="_blank" style="color: #2596be;">{{str_replace(" ","%20",$nif4_aval_image)}}</a></p>	
		@endif
		@if ($nif4_aval_image2)     
			<p><a href="{{str_replace(' ','%20',$nif4_aval_image2)}}" target="_blank" style="color: #2596be;">{{str_replace(" ","%20",$nif4_aval_image2)}}</a></p>	
		@endif
		@if ($nif5_aval_image)     
			<p><a href="{{str_replace(' ','%20',$nif5_aval_image)}}" target="_blank" style="color: #2596be;">{{str_replace(" ","%20",$nif5_aval_image)}}</a></p>	
		@endif
		@if ($nif5_aval_image2)     
			<p><a href="{{str_replace(' ','%20',$nif5_aval_image2)}}" target="_blank" style="color: #2596be;">{{str_replace(" ","%20",$nif5_aval_image2)}}</a></p>	
		@endif
		@if ($contrato_aval_image) 		
<p><span style="color:black"></u>Contratos</u>:</p>
		@endif
		@if ($contrato_aval_image)     
			<p><a href="{{str_replace(' ','%20',$contrato_aval_image)}}" target="_blank" style="color: #2596be;">{{str_replace(" ","%20",$contrato_aval_image)}}</a></p>	
		@endif
		@if ($contrato_aval_image2)     
			<p><a href="{{str_replace(' ','%20',$contrato_aval_image2)}}" target="_blank" style="color: #2596be;">{{str_replace(" ","%20",$contrato_aval_image2)}}</a></p>	
		@endif
		@if ($contrato2_aval_image)     
			<p><a href="{{str_replace(' ','%20',$contrato2_aval_image)}}" target="_blank" style="color: #2596be;">{{str_replace(" ","%20",$contrato2_aval_image)}}</a></p>	
		@endif
		@if ($contrato2_aval_image2)     
			<p><a href="{{str_replace(' ','%20',$contrato2_aval_image2)}}" target="_blank" style="color: #2596be;">{{str_replace(" ","%20",$contrato2_aval_image2)}}</a></p>	
		@endif
		@if ($contrato3_aval_image)     
			<p><a href="{{str_replace(' ','%20',$contrato3_aval_image)}}" target="_blank" style="color: #2596be;">{{str_replace(" ","%20",$contrato3_aval_image)}}</a></p>	
		@endif
		@if ($contrato3_aval_image2)     
			<p><a href="{{str_replace(' ','%20',$contrato3_aval_image2)}}" target="_blank" style="color: #2596be;">{{str_replace(" ","%20",$contrato3_aval_image2)}}</a></p>	
		@endif
		@if ($contrato4_aval_image)     
			<p><a href="{{str_replace(' ','%20',$contrato4_aval_image)}}" target="_blank" style="color: #2596be;">{{str_replace(" ","%20",$contrato4_aval_image)}}</a></p>	
		@endif
		@if ($contrato4_aval_image2)     
			<p><a href="{{str_replace(' ','%20',$contrato4_aval_image2)}}" target="_blank" style="color: #2596be;">{{str_replace(" ","%20",$contrato4_aval_image2)}}</a></p>	
		@endif
		@if ($contrato5_aval_image)     
			<p><a href="{{str_replace(' ','%20',$contrato5_aval_image)}}" target="_blank" style="color: #2596be;">{{str_replace(" ","%20",$contrato5_aval_image)}}</a></p>	
		@endif
		@if ($contrato5_aval_image2)     
			<p><a href="{{str_replace(' ','%20',$contrato5_aval_image2)}}" target="_blank" style="color: #2596be;">{{str_replace(" ","%20",$contrato5_aval_image2)}}</a></p>	
		@endif
		@if ($nomina_aval_image) 
<p><span style="color:black"></u>2 últimas nóminas</u>:</p>	
		@endif
		@if ($nomina_aval_image)     
			<p><a href="{{str_replace(' ','%20',$nomina_aval_image)}}" target="_blank" style="color: #2596be;">{{str_replace(" ","%20",$nomina_aval_image)}}</a></p>	
		@endif
		@if ($nomina_aval_image2)     
			<p><a href="{{str_replace(' ','%20',$nomina_aval_image2)}}" target="_blank" style="color: #2596be;">{{str_replace(" ","%20",$nomina_aval_image2)}}</a></p>	
		@endif
		@if ($nomina2_aval_image)     
			<p><a href="{{str_replace(' ','%20',$nomina2_aval_image)}}" target="_blank" style="color: #2596be;">{{str_replace(" ","%20",$nomina2_aval_image)}}</a></p>	
		@endif
		@if ($nomina2_aval_image2)     
			<p><a href="{{str_replace(' ','%20',$nomina2_aval_image2)}}" target="_blank" style="color: #2596be;">{{str_replace(" ","%20",$nomina2_aval_image2)}}</a></p>	
		@endif
		@if ($nomina3_aval_image)     
			<p><a href="{{str_replace(' ','%20',$nomina3_aval_image)}}" target="_blank" style="color: #2596be;">{{str_replace(" ","%20",$nomina3_aval_image)}}</a></p>	
		@endif
		@if ($nomina3_aval_image2)     
			<p><a href="{{str_replace(' ','%20',$nomina3_aval_image2)}}" target="_blank" style="color: #2596be;">{{str_replace(" ","%20",$nomina3_aval_image2)}}</a></p>	
		@endif
		@if ($nomina4_aval_image)     
			<p><a href="{{str_replace(' ','%20',$nomina4_aval_image)}}" target="_blank" style="color: #2596be;">{{str_replace(" ","%20",$nomina4_aval_image)}}</a></p>	
		@endif
		@if ($nomina4_aval_image2)     
			<p><a href="{{str_replace(' ','%20',$nomina4_aval_image2)}}" target="_blank" style="color: #2596be;">{{str_replace(" ","%20",$nomina4_aval_image2)}}</a></p>	
		@endif
		@if ($nomina5_aval_image)     
			<p><a href="{{str_replace(' ','%20',$nomina5_aval_image)}}" target="_blank" style="color: #2596be;">{{str_replace(" ","%20",$nomina5_aval_image)}}</a></p>	
		@endif
		@if ($nomina5_aval_image2)     
			<p><a href="{{str_replace(' ','%20',$nomina5_aval_image2)}}" target="_blank" style="color: #2596be;">{{str_replace(" ","%20",$nomina5_aval_image2)}}</a></p>	
		@endif
@endif		
...
target="_blank" style="color: #2596be;"><span style='mso-bookmark:_MailAutoSig'><span style='color:
...
href="http://www.iamoving.com/" target="_blank" style="color: #2596be;"><span style='mso-bookmark:_MailAutoSig'><span
...
href="mailto:info@iamoving.com" target="_blank" style="color: #2596be;"><span style='mso-bookmark:_MailAutoSig'><span
style='font-size:8.0pt;line-height:107%;mso-fareast-font-family:"Times New Roman";
...
href="https://iamoving.com/terminosI-condiciones" target="_blank" style="color: #2596be;"><span
style='mso-bookmark:_MailAutoSig'><span style='font-size:8.0pt;line-height:
107%;mso-fareast-font-family:"Times New Roman";mso-fareast-theme-font:minor-fareast;
...
href="https://iamoving.com/politica-privacidad" target="_blank" style="color: #2596be;"><span
style='mso-bookmark:_MailAutoSig'><span style='font-size:8.0pt;line-height:
107%;mso-fareast-font-family:"Times New Roman";mso-fareast-theme-font:minor-fareast;
...
href="http://iamoving.com/" target="_blank" style="color: #2596be;"><span style='mso-bookmark:_MailAutoSig'><span
