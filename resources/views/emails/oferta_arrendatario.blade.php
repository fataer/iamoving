            	...
            	<tr>
            		<td class="hero hero-2 bg_black">
                      <div class="text" style="padding: 01em;background-color:white;">
                            ...
                            <p><span style="color:black">Adjunto el documento de oferta de arrendamiento para formalizar el interés.</span></p>
                            <p><span style="color:black">Por favor, cuando hayas realizado la transferencia ({{ number_format($importe, 2, ',', '.') }}€), envíame el justificante por whatsapp al telefono <a href="tel:+34649623700">+34 649623700</a> o por correo a <a href="mailto:roberto@iamoving.com">roberto@iamoving.com</a>, con el documento adjunto firmado para informar a la propiedad. </p>
							<p><span style="color:black">Gracias. </p>
