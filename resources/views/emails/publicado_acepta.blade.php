            ...
            <table>
            	...
            	<tr>
            		<td>
                            ...
                            <p><span style="color:black">Hola  {{ $name }}, soy Roberto de IAMOVING.</span></p>
							<!--<p><span style="color:black">Tu solicitud ha sido confirmada. En breve, te confirmaré, por WhatsApp o por correo electrónico, los datos de uno de nuestros colaboradores audiovisuales que realizará el video, las fotos y el informe del inmueble.</span></p>-->
							<p><span style="color:black">Tu solicitud ha sido confirmada, será en la fecha {{ $visit_date }}. En breve, Te llamaré o te contactaré por WhatsApp para confirmarte la hora que mejor te convenga.</span></p>
                            <p><span style="color:black">También te adjunto a este correo una copia de los términos y condiciones y la política de privacidad de IAMOVING que has aceptado.</span></p>
							<p><span style="color:black">Cualquier duda o pregunta, estoy a tu disposición.</span></p>
...
mso-bidi-font-family:Calibri;color:black ;mso-themecolor:background2;
mso-themeshade:26;mso-ansi-language:IT;mso-fareast-language:ES;mso-no-proof:
yes'>Móvil +34 648 462 450</span></i></span><span style='mso-bookmark:_MailAutoSig'><span
