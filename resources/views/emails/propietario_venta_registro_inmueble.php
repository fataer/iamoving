      ...
      <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: auto;background-color:white;">
            	...
            	<tr>
            		<td class="hero hero-2 bg_black">
                      <div class="text" style="padding: 01em;background-color:white;">
                            ...
                            <p><span style="color:black">Hola  {{$cabecera_detalle->nombre_e}}, soy Roberto de IAMOVING.</span></p>
                            <p><span style="color:black">Te envío abajo un par de enlaces con la visita virtual de tu piso y las ventajas de vender con nosotros. También te adjunto en este correo los términos y política de privacidad que has aceptado.</span></p>
                            <p><span style="color:black"><b>VISITA VIRTUAL,</b> <a href="https://iamoving.com/anuncio/{{$cabecera_detalle->id}}" target="_blank"  style="color:#0563C1;">https://iamoving.com/anuncio/{{$cabecera_detalle->id}}</a> ¿Has encontrado algún error en la visita virtual?, por favor, indícanoslo.</span></p>
							<p><span style="color:black"><b>VENTAJAS,</b> <a href="https://iamoving.com/vendiendo-con-iamoving" target="_blank"  style="color:#0563C1;">https://iamoving.com/vendiendo-con-iamoving</a> (ANUNCIA GRATIS Y SIN EXCLUSIVA. SOLO PAGAS, SI VENDES).</span></p>
       ...
       <!-- <li>-->
            <p><span style="color:black">
			 ...
			 <p><span style="color:black">Si quieres, podemos entregarte el video que hemos creado.</span></p>
            <p><span style="color:black">
               <b><u>1. ¿CÓMO FUNCIONA Y QUÉ CONSEGUIMOS?</u></b>
            </span></p>
            <p><span style="color:black">
                Podrás subir el video en tus anuncios que ya están publicados en otros canales.
            </span></p>
            <p><span style="color:black">
				<b><u>2. AUMENTAMOS TUS POSIBILIDADES DE VENDER</u></b> 
            </span></p>		
                <p><span style="color:black">
                    a. Ganarás más visibilidad y tu anuncio estará por delante en los portales inmobiliarios, consiguiendo muchos más contactos y visitas. 
                </span></p>
                <p><span style="color:black">
                    b. Los compradores dicen que un Tour Virtual les da más confianza que una serie de fotografías convencionales, siendo un valor decisivo a la hora de ellos filtraren sus visitas. 
                </span></p>               
                <p><span style="color:black">
                    c. <b>Interesados de otras provincias y otros países</b>:  el no tener que viajar para ver la propiedad, genera una atracción para los inversores, expatriados y trabajadores que se encuentran en el extranjero o en otras provincias. 
                </span></p>				
            <p><span style="color:black">
...
<!--                <p><span style="color:black">
            ...
            <!--<p><span style="color:black">
				<b>1 HAZ UNA PRIMERA VISITA VIRTUAL</b>
            </span></p>	
            <p><span style="color:black">
				<b>2 ¿TE CUADRA? SOLICITA UNA VISITA PRESENCIAL</b>
            </span></p>	
            <p><span style="color:black">
				<b>3 ALQUILA O COMPRA SIN VISITAS INNECESARIAS</b>
            </span></p>	-->
            <p><span style="color:black">
				<b>¿Cómo?</b>
            </span></p>				
           <!-- <p><span style="color:black">
				<b>Opción 1. Totalmente GRATIS:</b> Si nos dejas tu piso en exclusiva (solo 15 días de exclusividad) 
            </span></p>	-->
            <p><span style="color:black">
				<b>Pago único…49€ (+iva) </b>
            </span></p>	
            <p><span style="color:black">
			Te enviamos las fotos y el video en alta resolución y en baja resolución, ya que en algunos portales no es posible subir videos en alta resolución. 
            </span></p>				
			<p><span style="color:black">
			Cualquier duda o pregunta, estoy a tu disposición. 
            </span></p>				
			<p><span style="color:black">
			Un saludo,
            </span></p>	
