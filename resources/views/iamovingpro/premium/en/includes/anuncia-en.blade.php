...
<br>
      ...
      <div class="modal-body" style="padding: 0.5rem;">
            <form id="publicarForm" action="{{ url('publicar_gratis') }}" method="post"  enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="form-group col-md-12">
                            <input placeholder="Mobile" type="text" id="phone" name="phone" class="form-control" maxlength="15"  required onkeyup="preventSpecials(event)">
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-md-12">
                    ...
                    <div class="form-group form-check text-center">
						...
						<label class="form-check-label" for="conditions">I have read and agree with <a href="/terminosI-condiciones" target="_blank">terms</a> y <a href="/politica-privacidad" target="_blank">privacy policy </a>of IAMOVING</label>
                    </div>					
                    <hr>
