							...
							<div class="container my-4">
								  <div class="row mt-0">
									<div class="col-md-1">
										...
										<div class="col-md-10 text-center mb-0">
												<h2 class="card-text text-center">📞Atención personalizada por llamadas solo para usuarios premium</h2>
																						</div>
									<div class="col-md-1">
									</div>
								  ...
								  <div class="row mt-0">
									<div class="col-md-2">
										...
										<div class="col-md-8 text-center mb-0">
												<img src="/img/iamoving_premium_grey_transparent.png"  width="410" height="126" style="margin-bottom:0px;" alt="playa">  
																						</div>
											...
											<div class="container my-2">
													 <!--<div class="row mt-3">
														...
														<div class="col-md-2">
															...
															<h2 class="card-text text-center">¿Qué es IAMOVING PREMIUM?</h2>
																 <!--<p class="card-text text-center">MEJORAMOS TU FORMA DE ALQUILAR</p>-->

															
															<!--<span id="dots"></span><span id="more">-->
															<div class="text-success my-1">
																<p class="card-text text-center">Escuchamos atentamente todas tus peticiones y te atendemos de una forma totalmente personalizada, telefónicamente si lo prefieres, ayudándote paso a paso a la hora de alquilar o comprar un inmueble en Madrid.</p>
															</div>											
					...
					<div class="row  justify-content-center">
						<div class="col-12">
							...
							<!--<div class="collapse  my-0" id="collapseExample23">-->
							  <div class="card bg-transparent border-transparent my-0">
								<div class="card-body text-success my-0">
											  <!--<h2 class="card-text text-center">Realizamos visitas</h2>-->
									<!--<h5 class="card-text text-center"><b>Asesoría inmobiliaria personalizada:</b></h5>-->
										<div class="col-md-12 ml-2">
											...
											<ul class="ml-0">
											  ...
											  <li style="list-style:none;" class="ml-0 mt-4"><h5 class="display-5" >📝 <b>Asesoría inmobiliaria personalizada:</b></h5></li>
											  <li  class="ml-4 mt-1"><i class="icon ion-md-checkmark-circle-outline"></i><h5 class="display-5" > &nbsp;&nbsp;Escuchamos tus peticiones y buscaremos tu inmueble ideal en el mercado.</h5></li>
											  ...
											  <li class="ml-4 mt-1"><i class="icon ion-md-checkmark-circle-outline"></i><h5 class="display-5" > &nbsp;&nbsp;¿Qué inmueble podría alquilar o comprar con mi presupuesto?</h5></li>
											  <li class="ml-4 mt-1"><i class="icon ion-md-checkmark-circle-outline"></i><h5 class="display-5" > &nbsp;&nbsp;¿Cuáles son los requisitos que necesito para alquilar un inmueble en España?</h5></li>
											  <li class="ml-4 mt-1"><i class="icon ion-md-checkmark-circle-outline"></i><h5 class="display-5" > &nbsp;&nbsp;Consulta telefónica sobre inmuebles.</h5></li>
											  <li class="ml-4 mt-1"><i class="icon ion-md-checkmark-circle-outline"></i><h5 class="display-5" > &nbsp;&nbsp;¿Dónde vivir en España?</h5></li>
											  <li class="ml-4 mt-1"><i class="icon ion-md-checkmark-circle-outline"></i><h5 class="display-5" > &nbsp;&nbsp;¿Podéis orientarme sobre los barrios/zonas también?</h5></li>
											  <li class="ml-4 mt-1"><i class="icon ion-md-checkmark-circle-outline"></i><h5 class="display-5" > &nbsp;&nbsp;¿Sabéis decirme aprox. los costes de luz, agua, internet?</h5></li>
											  <li style="list-style:none;" class="ml-0 mt-4"><h5 class="display-5" >🎥 <b>Hacemos visitas por ti:</b> </br>Entendemos que puede resultarte difícil realizar visitas si está ocupado o no vives cerca del inmueble, por lo cual vamos al inmueble por ti y te enseñamos todo en directo por videollamada.</h5></li>
											  <li style="list-style:none;" class="ml-0 mt-4"><h5 class="display-5" >⚖️ <b>Asesoría Jurídica:</b> </br>Nuestro equipo jurídico llevará a cabo el chequeo de todo lo necesario y hará la revisión de contratos y documentación para asegurarte que todo esté al día y en orden antes de alquilar o comprar un inmueble.</h5></li>
											  <li style="list-style:none;" class="ml-0 mt-4"><h5 class="display-5" >💡 <b>TIPS asesoría:</b> </br>¿Sabéis decir los costes de transporte, alimentación, escuelas, etc, en España? </br>¿Podéis ayudarme a encontrar profesionales de confianza, como: Mudanza, reformistas, cleaner?</h5></li>
											  <!--<li class="ml-0 mt-4"><i class="icon ion-md-checkmark-circle-outline"></i><h5 class="display-5" > <b>¿Podéis ayudarme a encontrar profesionales de confianza, como: Mudanza, reformistas, cleaner? </b></h5></li>-->
												<li style="list-style:none;" class="ml-0 mt-4"><h5 class="display-5" >💵 <b>Asesoramiento fiscal:</b> </br>Te proporcionamos una ayuda profesional y así, orientarte en los diferentes asuntos fiscales y tributarios a los que tendrás que hacer frente en el proceso de compra.</h5></li>
											  <li style="list-style:none;" class="ml-0 mt-4"><h5 class="display-5" >💰 <b>Préstamo hipotecario:</b> </br>Tendrás un experto financiero asignado para solucionar tus dudas a la hora de comprar.</h5></li>
											  <li style="list-style:none;" class="ml-0 mt-4"><h5 class="display-5" >🔶 <b>Asesoría Golden Visa:</b> </br>¿Cómo invertir en España y conseguir la residencia? Nuestro equipo te mostrará todos los pasos a seguir.</h5></li>
									  ...
									  <h5 class="mt-5 card-text text-center"><b>¿Por qué pasarte a Premium?</b></h2>
									  <h4  class="card-text text-center"><b>Convertimos lo difícil en algo Fácil y Seguro 😉</b></h4>
											<p class="mt-3 text-center">
												<button type="button" id="btn_premium" name="btn_premium" class="btn btn-iamoving btn-lg" style="color:default;" data-toggle="modal" data-target="#modalAnuncia"><b>REGÍSTRATE COMO USUARIO PREMIUM</b></button>
											</p>
											<h4  class="card-text text-center"><b>Precio.........50€</b></h4>
											<p class="my-1 text-center">
												Servicio válido durante 1 mes.
											</p>									  
									</div>					
								</div>
							 <!--</div>	-->				  
...
<span id="dots3"></span><span id="more4">
        ...
        <div class="container my-0 mt-4">												
          ...
          -->                          
            ...
            <br>
                @include('iamovingpro.premium.includes.anuncia')
       ...
       $(document).ready(function() { 
            ...
            function processJson(data) { 
                ...
                if(data.success){
                    ...
                    Swal.fire(
                        'Gracias',
                        'Hemos enviado a tu correo nuestros datos bancarios para la realización del pago',
                        'success'
                    );
                    ...
                    Swal.fire(
                        'Lo sentimos',
                        'No hemos podido recibir tu información. Inténtelo nuevamente',
                        'error'
                    );
                }
            }
			...
			$("#btn_premium").click(function(){
				$("#tipo_publicacion").val("iamoving_premium");
			});	
