...
<!--							<div class="d-none d-md-block d-lg-block d-xl-block">
				...
				<!--</div>-->	
														...
														<div class="card">
															<nav class="nav nav-pills nav-justified border-bottom" role="tablist">
																<a class="nav-item nav-link active" href="#tab11" data-toggle="tab"
																	...
																	<span class="display-5 d-block">COMPRADORES</span>
										...
										<div class="col-sm-5  d-block d-sm-block d-md-none">
											<ul class="ml-4">
											  <li class="ml-1"><i class="icon ion-md-checkmark-circle-outline"></i><h5 class="display-5" > Haz tu primera visita sin salir de casa </h5></li>
											  ...
											  <li class="ml-1"><i class="icon ion-md-checkmark-circle-outline"></i><h5 class="display-5" > Verificamos todos los pisos evitándote visitas innecesarias</h5></li>
											  
											  
											</ul>
											<p  class="ml-1 mt-3" style="color: #2d2e35 !important;"><i class="fa fa-check"></i> Aumentamos tus posibilidades de encontrar tu hogar, ahorrándote tiempo y dinero a la hora de comprar</p>
										</div>
											...
											<ul class="ml-4">
												<ul class="ml-5">
													<ul class="ml-5">
														<ul class="ml-5">
															<ul class="ml-4">
															  <li class="ml-5"><i class="icon ion-md-checkmark-circle-outline"></i><h5 class="display-5" > Haz tu primera visita sin salir de casa </h5></li>
															  ...
															  <li class="ml-5"><i class="icon ion-md-checkmark-circle-outline"></i><h5 class="display-5" > Verificamos todos los pisos evitándote visitas innecesarias</h5></li>
															  
															</ul>
															<p  class="ml-5 mt-3" style="color: #2d2e35 !important;"><i class="fa fa-check"></i> Aumentamos tus posibilidades de encontrar tu hogar, ahorrándote tiempo y dinero a la hora de comprar</p>
														</ul>
													</ul>
												</ul>
											</ul>
										...
										<div class="col-sm-5  d-block d-sm-block d-md-none">
											<ul class="ml-4">
											  <li class="ml-1"><i class="icon ion-md-checkmark-circle-outline"></i><h5 class="display-5" > Reportaje completo, video, fotos e infome detallado de tu casa</h5></li>
											  <li class="ml-1"><i class="icon ion-md-checkmark-circle-outline"></i><h5 class="display-5" > Sin pérdida de tiempo con llamadas respondiendo siempre las mismas cosas</h5></li>
											  <li class="ml-1"><i class="icon ion-md-checkmark-circle-outline"></i><h5 class="display-5" > Eliminamos miles de visitas innecesarias</h5></li>
											</ul>
											...
											<ul class="ml-4">
												<ul class="ml-5">
													<ul class="ml-5">
														<ul class="ml-5">
															<ul class="ml-4">
															  <li class="ml-5"><i class="icon ion-md-checkmark-circle-outline"></i><h5 class="display-5" > Reportaje completo, video, fotos e infome detallado de tu casa</h5></li>
															  <li class="ml-5"><i class="icon ion-md-checkmark-circle-outline"></i><h5 class="display-5" > Sin pérdida de tiempo con llamadas respondiendo siempre las mismas cosas</h5></li>
															  <li class="ml-5"><i class="icon ion-md-checkmark-circle-outline"></i><h5 class="display-5" > Eliminamos miles de visitas innecesarias</h5></li>
															</ul>
															<p  class="ml-5 mt-3" style="color: #2d2e35 !important;"><i class="fa fa-check"></i> Aumentamos tus posibilidades de vender y ahorrarás tiempo y dinero</p>
														</ul>
													</ul>
												</ul>
											</ul>
						...
						<div class="container my-3">
								<div class="row mt-0">
									...
									<div class="col-md-2">
										...
										<div class="section-title text-center my-0"  style="padding-top: 0px;padding-bottom: 0px;">
											<h4 class="text-center mb-4"><b>VISITA LOS PISOS DESDE LA PLAYA</b></h4>
										</div>					
																...
																<div role="tabpanel" class="tab-pane" id="tab2">
																	...
																	<div class="my-0" id="collapseExample3">
																	  <div class="card  bg-transparent border-dark my-0">
																			  <div class="card-body text-success  my-0">
																				<!--<h5 class="card-title">Success card title</h5>-->
																				<h5 class="display-5 text-center text-center my-1" >2-¿Te gustó la visita virtual? Solicita una visita presencial.</h5>
																			  </div>					
																		  </div>
																	  </div>												
																</div>
																...
																<div role="tabpanel" class="tab-pane" id="tab4">	
																	<div class="my-0" id="collapseExample3">
																	  <div class="card  bg-transparent border-dark my-0">
																			  <div class="card-body text-success  my-0">
																				<!--<h5 class="card-title">Success card title</h5>-->
																				<h5 class="display-5 text-center text-center my-1" >3-Compra y ahórrate miles de visitas innecesarias🙂</h5>
																			  </div>					
																		  </div>
																	  </div>	
					...
					<div class="row  justify-content-center">
						<div class="col-12">
							...
							<p class="my-0">
							  ...
							  AHORRAMOS EL BIEN MÁS VALIOSO, TU TIEMPO
							  </button>
							</p>
									  ...
									  <div class="card-body text-success my-0">
											...
											<div class="col-md-12 ml-2">
												...
												<ul class="ml-0">
												  ...
												  <li class="ml-0 mt-4"><i class="icon ion-md-checkmark-circle-outline"></i><h5 class="display-5" > <b>Sin llamadas y emails</b></h5></li>								  
												  <li class="ml-0" style="list-style:none;"><h5 class="display-5" >Olvídate de todas las llamadas y correos electrónicos no respondidos para obtener más información sobre las propiedades que te interesan. Con Iamoving, no hay necesidad de hacer cientos de llamadas o correos electrónicos para obtener más información, tendrá todas las respuestas a tus preguntas a mano, las 24 horas del día, a tu disposición.</h5></li>								  								  																								
												  <li class="ml-0 mt-4"><i class="icon ion-md-checkmark-circle-outline"></i><h5 class="display-5" > <b>Realizar las visitas frustradas</b></h5></li>								  
												  <li class="ml-0" style="list-style:none;"><h5 class="display-5" >Tiempo que tomaría llegar a la propiedad para hacer visitas.</h5></li>								  								  
												  ...
												  <li class="ml-0" style="list-style:none;"><h5 class="display-5" >Tiempo perdido con visitas que no aportan nada.</h5></li>								  					
												  <li class="ml-0" style="list-style:none;"><h5 class="display-5" >Más el tiempo que lleva regresar a casa.</h5></li>								  					
												  <li class="ml-0 mt-4"><i class="icon ion-md-checkmark-circle-outline"></i><h5 class="display-5" > <b>¿Cuánto vale tu tiempo?</b></h5></li>								  
												  <li class="ml-0" style="list-style:none;"><h5 class="display-5" >Estar con tu familia, amigos o haciendo dinero y no perdiendo tiempo con miles de llamadas, correos electrónicos y visitas frustradas.</h5></li>								  					
					...
					<div class="row  justify-content-center">
						<div class="col-12">
							...
							<p class="my-0">
							  ...
							  style="font-weight:bold;border-radius:0%; !important;;outline:none !important;outline-width: 0 !important; box-shadow: none;-moz-box-shadow: none;-webkit-box-shadow: none;" >
							  AUMENTAMOS TUS POSIBILIDADES DE COMPRAR 
							  </button>
							</p>
									  ...
									  <div class="card-body text-success my-0">
											...
											<div class="col-md-12 ml-2">
												...
												<ul class="ml-0">
												  ...
												  <li class="ml-0 mt-4"><i class="icon ion-md-checkmark-circle-outline"></i><h5 class="display-5" > <b>Visita virtual</b></h5></li>								  
												  <li class="ml-0" style="list-style:none;"><h5 class="display-5" >Realmente muestra en qué estado se encuentra la propiedad, al contrario de lo que sucede con las fotografías, donde solo se muestran unos pocos espacios, verificamos piso por piso, evitando anuncios fraudulentos, visitas frustradas y aumentando tus posibilidades de encontrar lo que realmente te interesa.</h5></li>								  								  																								
												  <li class="ml-0 mt-4"><i class="icon ion-md-checkmark-circle-outline"></i><h5 class="display-5" > <b>Estarás por delante</b></h5></li>								  
												  <li class="ml-0" style="list-style:none;"><h5 class="display-5" >Una buena oportunidad se vende muy rápido, nos quitan de las manos, esto es muy común debido a la falta de tiempo que tenemos para hacer visitas o incluso si estamos en otra provincia o país. Con Iamoving, puedes visitar desde cualquier lugar a través de nuestro recorrido virtual, aclarando si te gusta la propiedad o no, de modo que ya pueda transmitir tu interés real al propietario, comenzando una primera negociación y sin dejar que se escape.</h5></li>								  								  
												  <li class="ml-0 mt-4"><i class="icon ion-md-checkmark-circle-outline"></i><h5 class="display-5" > <b>Respuestas 24h al día</b></h5></li>								  
												  <li class="ml-0" style="list-style:none;"><h5 class="display-5" >Nuestro modelo de presentación de propiedades responde automáticamente todas tus preguntas o consultas sobre la propiedad que te interesa las 24 horas del día, ya que un correo electrónico o una llamada perdida reducirán inmediatamente tus posibilidades de visitas y decisiones.</h5></li>								  					

												  <li class="ml-0 mt-4"><i class="icon ion-md-checkmark-circle-outline"></i><h5 class="display-5" > <b>Sin frustraciones</b></h5></li>								  
												  <li class="ml-0" style="list-style:none;"><h5 class="display-5" >A veces, encontramos la propiedad ideal, pero al reprogramar una segunda visita con amigos o familiares, para que puedan dejarnos su importante opinión, la propiedad fue vendida o reservada, convirtiéndose en una gran frustración. Con Iamoving, puede enviar de inmediato el recorrido virtual a sus conocidos y obtener su opinión rápidamente, para que no se pierdan.</h5></li>								  					

												  <li class="ml-0 mt-4"><i class="icon ion-md-checkmark-circle-outline"></i><h5 class="display-5" > <b>¿Vives en otra ciudad o país?</b></h5></li>								  
												  <li class="ml-0" style="list-style:none;"><h5 class="display-5" >No tiene que viajar para visitar la propiedad, puede hacerlo las 24 horas del día, los 365 días del año, FROM ANYWHERE.</h5></li>								  					
						...
						<div class="col-12">
							...
							<div class="col-md-12 ml-2">
								...
								<ul class="ml-0">
								  ...
								  <li class="ml-0 mt-4"><i class="icon ion-md-checkmark-circle-outline"></i><h5 class="display-5" > <b>Sin visitas innecesarias</b></h5></li>								  
								  <li class="ml-0" style="list-style:none;"><h5 class="display-5" >Gastos continuos con visitas que no aportan nada, tales como: transporte, combustible, parking, taxi, etc..</h5></li>								  								  
