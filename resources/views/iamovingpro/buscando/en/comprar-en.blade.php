								  ...
								  <div class="row mt-0">
									<div class="col-md-2">
										...
										<div class="col-md-8 text-center mb-0">
												<img src="/img/compra.png"  width="760" height="50" style="margin-bottom:0px;" alt="playa">  
																						</div>
...
<!--							<div class="d-none d-md-block d-lg-block d-xl-block">
				...
				<!--</div>-->	
										...
										<div class="col-sm-5  d-block d-sm-block d-md-none">
											...
											<p  class="ml-1 mt-3" style="color: #2d2e35 !important;"><i class="fa fa-check"></i> We increase your chances of finding your home, saving you time and money when buying</p>
										</div>
												...
												<ul class="ml-5">
													<ul class="ml-5">
														<ul class="ml-5">
															...
															<p  class="ml-5 mt-3" style="color: #2d2e35 !important;"><i class="fa fa-check"></i> We increase your chances of finding your home, saving you time and money when buying</p>
														</ul>
													</ul>
												</ul>
											</ul>
						...
						<div class="container my-3">
								<div class="row mt-0">
									...
									<div class="col-md-2">
										...
										<div class="section-title text-center my-0"  style="padding-top: 0px;padding-bottom: 0px;">
											<h4 class="text-center mb-4"><b>VISIT THE APARTMENTS FROM THE BEACH</b></h4>
										</div>					
																...
																<div role="tabpanel" class="tab-pane active" id="tab1">	
																	<div class="my-0" id="collapseExample3">
																	  <div class="card  bg-transparent border-dark my-0">
																			  <div class="card-body text-success  my-0">
																				<!--<h5 class="card-title">Success card title</h5>-->
																				<h5 class="display-5 text-center text-center my-1" >1-Find your home on Imoving.com and make a first visit without leaving home (from anywhere).</h5>
																...
																<div role="tabpanel" class="tab-pane" id="tab2">
																	...
																	<div class="my-0" id="collapseExample3">
																	  <div class="card  bg-transparent border-dark my-0">
																			  <div class="card-body text-success  my-0">
																				<!--<h5 class="card-title">Success card title</h5>-->
																				<h5 class="display-5 text-center text-center my-1" >2-Did you like the virtual tour? Request an in-person visit.</h5>
																			  </div>					
																		  </div>
																	  </div>												
																</div>
																...
																<div role="tabpanel" class="tab-pane" id="tab4">	
																	<div class="my-0" id="collapseExample3">
																	  <div class="card  bg-transparent border-dark my-0">
																			  <div class="card-body text-success  my-0">
																				<!--<h5 class="card-title">Success card title</h5>-->
																				<h5 class="display-5 text-center text-center my-1" >3-Buy and save thousands of unnecessary visits🙂</h5>
																			  </div>					
																		  </div>
																	  </div>	
...
<!--							<div class="d-none d-md-block d-lg-block d-xl-block">
				...
				<!--<div class="container mt-5 my-1">
					<div class="row grid-divider">
						...
						<p class="ml-4 text-center">Basta enviar por WhatsApp o email el enlace <a href="https://www.iamoving.com/VisitaVirtual/568" target="_blank">https://www.iamoving.com/VisitaVirtual/568</a> de tu visita virtual que hemos realizado a todos los interesados que te contacten, mediante las plataformas inmobiliarias o a través de otros canales. Si lo preferires, escribe directamente en la descripción de tu propio anuncio, explicándoles.</p>
									  ...
									  <div class="card-body text-success my-0">
											...
											<div class="col-md-12 ml-2">
												...
												<ul class="ml-0">
												  ...
												  <li class="ml-0 mt-4"><i class="icon ion-md-checkmark-circle-outline"></i><h5 class="display-5" > <b>No calls and emails</b></h5></li>
<li class="ml-0" style="list-style:none;"><h5 class="display-5" >Forget all the unanswered calls and emails to find out more about the properties you are interested in . With Iamoving, there is no need to make hundreds of calls or emails to get more information, you will have all the answers to your questions at hand, 24 hours a day, at your disposal.</h5></li>
<li class="ml-0 mt-4"><i class="icon ion-md-checkmark-circle-outline"></i><h5 class="display-5" > <b>Perform visits frustrated</b></h5></li>
<li class="ml-0" style="list-style:none;"><h5 class="display-5" >Time it would take to get to the property for viewings.</h5></li>
...
<li class="ml-0 mt-4"><i class="icon ion-md-checkmark-circle-outline"></i><h5 class="display-5" > <b>How much is it worth your time?</b></h5></li>
<li class="ml-0" style="list-style:none;"><h5 class="display-5" >Being with your family, friends or making money and not wasting time with thousands of calls, emails and frustrated visits.</h5></li>

<!--												  <li class="ml-0 mt-4"><i class="icon ion-md-checkmark-circle-outline"></i><h5 class="display-5" > <b>Una segunda opinión</b></h5></li>								  
												  <li class="ml-0" style="list-style:none;"><h5 class="display-5" >Otra ventaja es que, además de que la parte interesada puede visitar la propiedad tantas veces como lo desee en el día y en el lugar que prefiera, también puede mostrar la propiedad a su familia y amigos antes de señalizar, dándoles más confianza y aumentando tus posibilidades de vender.</h5></li>								  					-->
					...
					<div class="row  justify-content-center">
						<div class="col-12">
							...
							<p class="my-0">
							  ...
							  style="font-weight:bold;border-radius:0%; !important;;outline:none !important;outline-width: 0 !important; box-shadow: none;-moz-box-shadow: none;-webkit-box-shadow: none;" >
							  WE INCREASE YOUR POSSIBILITIES OF BUYING
							  </button>
							</p>
									  ...
									  <div class="card-body text-success my-0">
											...
											<div class="col-md-12 ml-2">
												...
												<ul class="ml-0">
												  ...
												  <li class="ml-0 mt-4"><i class="icon ion-md-checkmark-circle-outline"></i><h5 class="display-5" > <b>Virtual tour</b></h5></li>
<li class="ml-0" style="list-style:none;"><h5 class="display-5" >It really shows what condition the property is in, unlike the photos, where only a few spaces are shown, we verify floor by floor, avoiding fraudulent ads, frustrated visits and increasing your chances of finding what really interests you.</h5></li>
<li class="ml-0 mt-4"><i class="icon ion-md-checkmark-circle-outline"></i><h5 class="display-5" > <b>You will be ahead </b></h5></li>
<li class="ml-0" style="list-style:none;"><h5 class="display-5" >A good opportunity is sold very quickly, we are taken from our hands, this is very common due to the lack of time we have to make visits or even if we are in another province or country. With Iamoving, you can visit from anywhere through our virtual tour, clarifying whether you like the property or not, so that you can already convey your real interest to the owner, starting a first negotiation and not letting it slip away.</h5 ></li>
<li class="ml-0 mt-4"><i class="icon ion-md-checkmark-circle-outline"></i><h5 class="display-5" > <b>24h responses to day</b></h5></li>
<li class="ml-0" style="list-style:none;"><h5 class="display-5" >Our property presentation model automatically answers all your questions or queries about the property you are interested in 24 hours a day, since a missed email or call will immediately reduce your chances of visits and decisions.</h5></li>

<li class="ml-0 mt-4"><i class="icon ion-md-checkmark-circle-outline"></i><h5 class="display-5" > <b>No frustrations</b></h5></li>
<li class="ml-0" style="list-style:none;"><h5 class="display-5" >Sometimes we find the ideal property, but rescheduling a second visit with friends or family, to that they can leave us their important opinion, the property was sold or reserved, becoming a great frustration. With Iamoving, you can immediately send the virtual tour to your friends and get their feedback quickly, so they don't get lost.</h5></li>

<li class="ml-0 mt-4"><i class="icon ion-md-checkmark-circle-outline"></i><h5 class="display-5" > <b>Do you live in another city or country?</b></h5></li>
<li class="ml-0" style="list-style:none;"><h5 class="display-5" >You don't have to travel to visit the property, you can do it 24 hours a day, 365 days of the year, FROM ANYWHERE.</h5></li>								  					
...
-->
					...
					<!--	<p class="my-5 text-center">
							<button type="button" id="btn_visita" name="btn_visita" class="btn btn-iamoving btn-lg" style="color:#2d2e35;" data-toggle="modal" data-target="#modalAnuncia">Infórmate GRATIS</button>
						</p>-->
			...
			<!--<div class="section-title text-center my-4">
                <h3 class="font-weight-bold subtitle_feature">EXPERIENCIAS DE COMPRADORES CON IAMOVING</h3>
            </div>			
            ...
            <br>
                @include('iamovingpro.buscando.en.includes.anuncia-en')
<!--capa Ahorrando-->
      			...
      			{!! csrf_field() !!} 
	          		<div class="col-md-12">
	          			<div class="form-group">
	          				<label><b>Sin llamadas y emails</b></label>
	          				<ul>
								<li class="ml-5">
	          				...
	          				<label><b>Realizar las visitas frustradas</b></label>
	          				<ul>
								<li class="ml-5">
	          				...
	          				<label><b>¿Cuánto vale tu tiempo?</b></label>
	          				<ul>
								<li class="ml-5">
									Estar con tu familia, amigos o haciendo dinero y no perdiendo tiempo con miles de llamadas, correos electrónicos y visitas frustradas.
								</li>
							</ul>
...
<div id="modalAumentando" class="modal fade" role="dialog">
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <h4 id="modal-request-title" class="modal-title">Aumentamos tus posibilidades de comprar</h4>
      </div>
      <div class="modal-body">
      			{!! csrf_field() !!} 
	          		<div class="col-md-12">
	          			<div class="form-group">
	          				<label><b>Visita virtual</b></label>
	          				<ul>
								<li class="ml-5">
									Realmente muestra en qué estado se encuentra la propiedad, al contrario de lo que sucede con las fotografías, donde solo se muestran unos pocos espacios, verificamos piso por piso, evitando anuncios fraudulentos, visitas frustradas y aumentando tus posibilidades de encontrar lo que realmente te interesa.
								</li>
							</ul>
	          				<label><b>Estarás por delante</b></label>
	          				<ul>
								<li class="ml-5">
									Una buena oportunidad se vende muy rápido, nos quitan de las manos, esto es muy común debido a la falta de tiempo que tenemos para hacer visitas o incluso si estamos en otra provincia o país. Con Iamoving, puedes visitar desde cualquier lugar a través de nuestro recorrido virtual, aclarando si te gusta la propiedad o no, de modo que ya pueda transmitir tu interés real al propietario, comenzando una primera negociación y sin dejar que se escape.
								</li>
					<!--			<li class="ml-5">
									La mayoría de las agencias o plataformas inmobiliarias no cobran ninguna comisión al comprador, sino al propietario, pero no piensen que no está pagando nada.
								</li>
								<li class="ml-5">
									Por lo general, el propietario incrementa el precio de la venta para cubrir los gastos que tuvo con los intermediarios. En Iamoving, no recibimos ninguna comisión del propietario, por lo que el propietario no aumenta el precio de la venta para cubrir las comisiones de agencias, plataformas o intermediarios, como suele pasar. 
								</li>
								<ul class="ml-5">
									<li class="ml-5">
									...
									<li class="ml-5">
										Conseguimos bajar muchísimo su precio final  
									</li>
									<li class="ml-5">
	          				...
	          				<label><b>Respuestas 24h al día</b></label>
	          				<ul>
								<li class="ml-5">
	          				...
	          				<label><b>Sin frustraciones  </b></label>
	          				<ul>
								<li class="ml-5">
									A veces, encontramos la propiedad ideal, pero al reprogramar una segunda visita con amigos o familiares, para que puedan dejarnos su importante opinión, la propiedad fue vendida o reservada, convirtiéndose en una gran frustración. Con Iamoving, puede enviar de inmediato el recorrido virtual a sus conocidos y obtener su opinión rápidamente, para que no se pierdan.
								</li>

							</ul>
	          				<label><b>¿Vives en otra ciudad o país?</b></label>
	          				<ul>
								<li class="ml-5">
	          				...
	          				<ul>
								...
								<li class="ml-5">
									Por lo tanto, no ocultamos defectos o información sobre las propiedades y tampoco “maquillamos” las fotos, cosas puede suceder en este proceso. Evitamos anuncios fraudulentos, visitas frustradas y aumentando tus posibilidades de encontrar lo que realmente te interesa.
								</li>								
							</ul>-->
	          			<!--	<label><b>Sin intermediarios</b></label>
	          				<ul>
								<li class="ml-5">
									En  Iamoving, no hay agencias ni intermediarios; de esa manera, encontrará fácilmente los pisos de particulares, ya que normalmente se mezclan entre miles de agencias en los portales inmobiliarios, lo que hace que este proceso sea muy aburrido y difícil.
								</li>
							</ul>-->
	          				<!--<label><b>8-Sin comisiones ocultas</b></label>
	          				<ul>
								<li class="ml-5">
									Es una gran impotencia encontrar tu hogar ideal y no poder comprar, ya que su precio final aumenta demasiado con las comisiones metidas dentro del precio. 
								</li>
								<li class="ml-5">
									La mayoría de las agencias o plataformas inmobiliarias no cobran ninguna comisión al comprador, sino al propietario, pero no piensen que no está pagando nada.
								</li>
								...
								<ul class="ml-5">								
									...
									<li class="ml-5">
										Conseguimos bajar muchísimo el precio final
									</li>
									<li class="ml-5">
										Aumentamos tus posibilidades de encontrar tu hogar ideal
									</li>
							...
							-->
	          				<!--<label><b>9-Sin comisiones al comprador </b></label>
	          				<ul>
								<li class="ml-5">
									Algunas plataformas o intermediarios también cobran al comprador una tarifa plana o comisiones. En Iamoving, no hay comisión de ningún tipo, no encareciendo costes al comprador.
								</li>
...
<div id="modalEvitando" class="modal fade" role="dialog">
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <h4 id="modal-request-title" class="modal-title">Evitamos gastos innecesarios</h4>
      </div>
      <div class="modal-body">
      			{!! csrf_field() !!} 
	          		<div class="col-md-12">
	          			<div class="form-group">
	          				<label><b>Sin visitas frustradas</b></label>
	          				<ul>
								<li class="ml-5">
									Gastos continuos con visitas que no aportan nada, tales como: transporte, combustible, parking, taxi, etc
								</li>
							</ul>
	          				<!--<label><b>2-Sin comisiones al comprador</b></label>
	          				<ul>
								<li class="ml-5">
									Ahorrando miles de euros en comisiones.
								</li>
							</ul>-->
	    <!--      				<label><b>3-Sin comisiones ocultas</b></label>
	          				<ul>
								<li class="ml-5">
									Calcule cuanto ahorrarás.
								</li>
							</ul>-->
	          			</div>
    ...
    <script>
        $(document).ready(function() { 
			...
			$("#btn_inicio").click(function(){
				$("#tipo_publicacion").val("buscando_comprar_inicio");
			});
			
			$("#btn_visita").click(function(){
				$("#tipo_publicacion").val("buscando_comprar_visita");
			});
			 
			$("#btn_traductor").click(function(){
				$("#tipo_publicacion").val("buscando_comprar_traductor");
			}); 
			 
			$("#btn_pagoseguro").click(function(){
				$("#tipo_publicacion").val("buscando_comprar_pagoseguro");
			});	
			 
			$("#btn_juridico").click(function(){
				$("#tipo_publicacion").val("buscando_comprar_juridico");
			});	
			$("#btn_iampremium").click(function(){
				$("#tipo_publicacion").val("buscando_comprar_iampremium");
			});	
