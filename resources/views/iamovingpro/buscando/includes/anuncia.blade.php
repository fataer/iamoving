  ...
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-content col-md-12">
      <div class="modal-header">
			...
			<h4 id="modal-request-title">INFORMÁTE GRATIS</h4>
...
<br>
      ...
      <div class="modal-body" style="padding: 0.5rem;">
            <form id="publicarForm" action="{{ url('publicar_gratis') }}" method="post"  enctype="multipart/form-data">
	            	...
	            	¡Te llamaremos para resolver dudas!
	            		</div>
                    ...
                    <div class="row">
                        <div class="form-group col-md-12">
                            <input placeholder="Teléfono móvil" type="text" id="phone" name="phone" class="form-control"  oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"  required onkeyup="preventSpecials(event)">
                        </div>
                    </div>
