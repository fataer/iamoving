	...
	<div class="container my-0 mb-2">
				 <div class="container my-0">
					...
					<!--Este texto solo visible para escritorio-->
						<h2 class="font-weight-bold d-none d-sm-none d-md-block">We improve your experience of renting, buying and selling<!--<a  @click.prevent="modalInfo"><img src="/img/info.png"  width="25" height="25" style="margin-bottom:5px;" alt="info"></a>--></h2>
						<!--Este texto solo visible para smartphone-->
						<h5 class="font-weight-bold d-none d-block d-sm-block d-md-none">We improve your experience of renting, buying and selling<!--<a  @click.prevent="modalInfo"><img src="/img/info.png"  width="25" height="25" style="margin-bottom:5px;" alt="info"></a>--></h5>
					</div>
				 </div>
				<!--<div  class="container my-0">
						 <div class="row mt-1">
							<div class="col-md-2">
								...
								<h5 class="display-5 text-center my-0" ><b><i>Sin dramas, sin comisiones y de particular a particular</i></b><h5>
								</div>
				...
				<div  class="container my-0">
						 <div class="row mt-2">
							<div class="col-md-2">
								...
								<div class="col-md-8 text-center">
							<h5 class="display-5 text-center my-1" >Today, at home, we can advertise, search and find a large number of properties, potential tenants and buyers.<h5>
							<h5 class="display-5 text-center my-1" >With the Internet and the excellent platforms available in the market, this has become a quick and practical task.<h5>
								</div>
				...
				<div class="container my-0" style="padding-right: 0px;padding-left: 0px;">		
					<div class="row  justify-content-center">
						<div class="col-12">
						<!--<p class="my-3"></p>-->
							<!--<div class="animated bounceInLeft delay-1s">-->
							<p class="my-0">
						  <button type="button" class="btn btn-warning btn-lg btn-block border-warning"
						  style="font-weight:bold;color:#2D2D37;border-radius:0%; !important;;outline:none !important;outline-width: 0 !important; box-shadow: none;-moz-box-shadow: none;-webkit-box-shadow: none;" >
						  BUT...
						  </button>
							</p>
							<div class=" my-0" id="collapseExample1">
							   <div class="card  bg-transparent border-warning my-0">
									  <div class="card-body text-success  my-0">
									  <!--Este texto solo visible para escritorio-->
											  <h2 class="card-text text-center mt-1 mb-0 d-none d-sm-none d-md-block">We all know the nightmare and how difficult it is to find the tenant, buyer or your ideal property</h3>
										<!--Este texto solo visible para smartphone-->
											  <h5 class="card-text text-center mt-1 mb-0 d-block d-sm-block d-md-none"><b>We all know the nightmare and how difficult it is to find the tenant, buyer or your ideal property</b></h5>
											  
											  <!--<p class="card-text text-center"><b>Al publicar tu inmueble:</b> miles de llamadas de agencias, interesados que no cumplen tus requisitos, emails, “interesados” que vienen a pasar el rato y no aportan nada, visitas frustradas y mucha, pero mucha pérdida de tiempo y dinero. ¿Cómo identificar quien realmente está interesado en tu inmueble? ¿Cómo saber que se trata de un inquilino fiable? ¿Cómo saber que no se trata de ocupas buscando pisos que están vacíos?<p>
											  <p class="card-text text-center"><b>Buscando casas:</b> hay miles de inmuebles en los portales inmobiliarios, pero ¿cuál de ellos muestran la verdad?  ¿cuál de ellos vale la pena visitar en persona? Anuncios fraudulentos, la falta de información y las fotos engañosas, oblíganos a visitar miles de pisos, desembocando en muchísima pérdida de tiempo y dinero. Sin contar los contratos abusivos que firmamos, convirtiéndose en stress y frustraciones económicas.<p>-->
					<!--<div class="row">
					  <div class="col-sm-6 mb-3 mb-md-0">
						  ...
						  <div class="card-body text-success">
							<p class="card-text text-center">
													  ...
													  Al publicar tu inmueble
													  </button>						
							</p>
							<p class="card-text text-center">Miles de llamadas de interesados que no cumplen tus requisitos, emails, “interesados” que vienen a pasar el rato y no aportan nada, visitas frustradas y mucha, pero mucha pérdida de tiempo y dinero. ¿Cómo identificar quien realmente está interesado en tu inmueble? ¿Cómo saber que se trata de un inquilino fiable? ¿Cómo saber que no se trata de ocupas buscando pisos que están vacíos?</p>						
						  </div>					
					  </div>
					  ...
					  <div class="col-sm-6">
						  <div class="card-body text-success">
							...
							<p class="card-text text-center">Hay miles de inmuebles en los portales inmobiliarios, pero ¿cuál de ellos muestran la verdad?  ¿cuál de ellos vale la pena visitar en persona? Anuncios fraudulentos, la falta de información y las fotos engañosas, oblíganos a visitar miles de pisos, desembocando en muchísima pérdida de tiempo y dinero. Sin contar los contratos abusivos que firmamos, convirtiéndose en stress y frustraciones económicas.</p>						
						  </div>										
					  </div>
					</div>-->
					...
					<div class="row grid-divider" >
						  ...
						  <div class="col-padding">
							  <div class="card-body text-success" style="padding:.01rem;">
								...
								<p class="card-text text-center">
									  <button type="button" class="btn btn-dark btn-lg btn-block border-warning"  aria-haspopup="true" 
									  style="font-weight:bold;color:#EADD1B;border-radius:0%; !important;;outline:none !important;outline-width: 0 !important; box-shadow: none;-moz-box-shadow: none;-webkit-box-shadow: none;" >
									  When publishing your property
									  </button>						
								</p>
								<h5 class="card-text text-center">Thousands of calls and emails from interested parties who do not meet your requirements, curious people who do not contribute anything, frustrated visits and a lot, but a lot of waste of time and money. How to identify who really is a potential buyer? How to know that it is a solvent tenant?</h5>																				
							  </div>
						  </div>
						</div>
						<div class="col-sm-6"  style="padding-right: 0px;padding-left: 0px;">
							  <div class="card-body text-success ml-3"  style="padding:.01rem;">
								...
								<h5 class="card-text text-center">There are thousands of properties on real estate portals, but which ones show the truth? Which one is worth visiting in person? Fraudulent advertisements, lack of information and misleading photos force us to visit thousands of flats, resulting in a huge waste of time and money.</h5>						
							  </div>	
						  </div>
					</div>
				</div>
											  ...
											  <!--Este texto solo visible para escritorio-->
											  <h2 class="card-text text-center mb-4 d-none d-sm-none d-md-block">Thinking about this, we will give you a hand</h2>
											  <!--Este texto solo visible para smartphone-->
											  <h3 class="card-text text-center mb-4 d-block d-sm-block d-md-none"><b>Thinking about this, we will give you a hand</b></h3>
											 <div class="container my-0">
												<!--<p>
												 <div class="row" >
												 <div class="col-sm-2"></div>
												  <div class="col-sm-3 mb-3 mb-md-0 border-warning">
													  <button type="button" class="btn btn-warning btn-lg btn-block border-warning dropdown-toggle"  data-toggle="collapse" 
													  data-target="#collapseExample01" aria-expanded="false" aria-controls="collapseExample01" aria-haspopup="true" 
													  style="font-weight:bold;color:#2D2D37;border-radius:0%; !important;;outline:none !important;outline-width: 0 !important; box-shadow: none;-moz-box-shadow: none;-webkit-box-shadow: none;" >
													  Tengo un inmueble
													  </button>
													<div class="collapse" id="collapseExample01">
													  <div class="card card-body bg-transparent border-warning" style="padding: 0.25rem;">
															<div class="card-body text-success">
															  <p class="card-text text-center"><a href="/alquiler" role="button" class="btn btn-iamoving btn-block">Alquiler</a></p>
															  <p class="card-text text-center"><a href="/vender" role="button"  class="btn btn-iamoving btn-block">Vender</a></p>
															</div>
													  </div>
													</div>
												  ...
												  <div class="col-sm-3">
												  <button type="button" class="btn btn-warning btn-lg btn-block border-warning dropdown-toggle"  data-toggle="collapse" 
												  data-target="#collapseExample21" aria-expanded="false" aria-controls="collapseExample21" aria-haspopup="true" 
												  style="font-weight:bold;color:#2D2D37;border-radius:0%; !important;;outline:none !important;outline-width: 0 !important; box-shadow: none;-moz-box-shadow: none;-webkit-box-shadow: none;" >
												  Buscando
												  </button>
													<div class="collapse" id="collapseExample21">
													  <div class="card card-body bg-transparent border-warning" style="padding: 0.25rem;">
															<div class="card-body text-success">
							  <p class="card-text text-center"><a href="/buscando-alquiler" role="button" class="btn btn-iamoving btn-block">Alquiler</a></p>
							  <p class="card-text text-center"><a href="/comprar" role="button" class="btn btn-iamoving btn-block">Comprar</a></p>
															</div>
													  </div>
													</div>
												...
												<div class="container my-0">
												 <div class="row mt-4">
													<div class="col-md-2">
														...
														<div class="col-md-8 text-center">
															<img src="/img/diana.png"  width="70" height="70" style="margin-bottom:10px;" alt="casa">
															<h4 class="text-center mb-0 d-none d-sm-none d-md-block"><b>WHAT DO WE GET? {{ $route }}</b></h4>
															<h5 class="text-center mb-0 d-sm-block d-md-none"><b>WHAT DO WE GET? {{ $route }}</b></h5>
														</div>
												 ...
												 <div class="row mt-4">
													...
													<div class="col-md-6">
													  <div class="pricing-box">
														<ul class="ml-2">
														  <li class="ml-0" style="list-style:none;list-style-image: url('/img/checking.menor.png');"><h5 class="display-5" >We save the most valuable asset, your time</h5></li>
														  <li class="ml-0" style="list-style:none;list-style-image: url('/img/checking.menor.png');"><h5 class="display-5" >We increase your rental and sale possibilities </h5></li>
														  <li class="ml-0" style="list-style:none;list-style-image: url('/img/checking.menor.png');"><h5 class="display-5" >We avoid unnecessary expenses in this process </h5></li>
														</ul>
													  </div>
													</div>
													<div class="col-md-3">
      			...
      			{!! csrf_field() !!} 
	          		<div class="col-md-12">
						...
						<!--<label><b>Ahorrando dinero</b></label>-->
	          				<ul>
								<li class="ml-5">
									It is a startup for the dissemination of virtual visits and facilitation of the processes of leasing or buying and selling real estate. We do not act as real estate agents or intermediaries, without benefiting in any way from the direct business between the parties or charging any type of commission to the owners, buyers or tenants.</li>
							</ul>
	          			</div>
		    ...
		    <div class="row mt-0 mb-3">
			    ...
			    <div class="col-md-6">
				    ...
				    <div class="section-title text-center" style="margin-bottom:0px;">
					    <h3 class="font-weight-bold subtitle_feature text-center" >WE JUST GOT IT!</h3>
				    </div>												
			    </div>
				<div class="col-md-3">
				</div>
		...
		<div>
          <!--  <div class="section-title text-center" style="margin-bottom:0px;">
            ...
            <div class="owl-carousel">
                                ...
                                <div id="box_{{$item->id}}" class="feature-item inmueble ">
                                    <a href="/VisitaVirtual/{{ $item->id }}"  target="_blank" style="text-decoration:none;">
                                        <div class="feature-pic set-bg" style="background-image: url(/storage/{{$item->path_image_primary}})">
                                            <div class="@if($item->is_sale == '1') sale-notic @else rent-notic @endif">@if($item->is_sale == '1') On Sell @else To Rent @endif</div>
            								...
            								<p id="text">
            								    @if($item->estado_inmueble == 'Vendido')
            								        <div class="rotar1">SOLD OUT</div>
            								    @endif
            								    @if($item->estado_inmueble == 'Alquilado')
            								        <div class="rotar1">RENTED</div>
            								    @endif
            								    @if($item->estado_inmueble == 'Reservado')
            								        <div class="rotar1">RESERVED</div>
            								    @endif
                                    ...
                                    <div class="feature-text border-0" style="cursor:hand;" onclick="window.open('/VisitaVirtual/{{$item->id }}', '_blank');">
                                        <div class="text-center feature-title">
                                            <h5><a href="/VisitaVirtual/{{$item->id }}" style="color:#EADD1B;" target="_blank">Reference {{$item->id}}</a></h5>
                                            <p><i class="fa fa-map-marker"></i> {{$item->road}}</p>
                                            @if($item->id == 85)
            								    <p class="price">Ask price</p>
            								@elsif($item->tipo_inmueble == 'Habitaciones' && $item->bedrooms > 1)
            								    <p class="price">From € {{ number_format($item->propiedad_precio, 0, ',', '.') }}</p>
            								@else
                                            ...
                                            <div class="room-info">
                                                <div class="rf-left">
                                                    ...
                                                    @if($item->bedrooms && $item->tipo_inmueble !='Local/Oficina')
                                                        <p><i class="fas fa-bed"></i> Bedrooms: {{$item->bedrooms}} </p>    
                                                    @endif
                                                    @if($item->bedrooms && $item->tipo_inmueble =='Local/Oficina')
                                                        <p><i class="fas fa-bed"></i> Rooms: {{$item->bedrooms}} </p>										    
                                                    @endif
                                                ...
                                                <div class="rf-right">
                                                    @if($item->estudio == 1)
                                                        <p><i class="fa fa-check-square"></i> Studio flat</p>    
                                                    @endif
                                                    @if($item->apartamento == 1)
                                                        <p><i class="fa fa-check-square"></i> Apartament</p>    
                                                    @endif
                                                    @if($item->chalet == 1)
                                                        <p><i class="fa fa-check-square"></i> House</p>    
                                                    @endif
                                                    @if($item->loft == 1)
                                                        <p><i class="fa fa-check-square"></i> Loft</p>
                                                    @endif
                                                    @if($item->piso == 1)
                                                        <p><i class="fa fa-check-square"></i> Flat</p>
                                                    @endif
                                                    @if($item->bajo == 1)
                                                        <p><i class="fa fa-check-square"></i> Ground floor flat</p>
                                                    @endif
                                                    @if($item->atico == 1)
                                                        <p><i class="fa fa-check-square"></i> Penthouse</p>
                                                    @endif
            										
            										@if($item->bathrooms)
                            						    <p><i class="fa fa-bath"></i> Bathrooms: {{$item->bathrooms}}</p>    
                            						@endif
                                                    @if($item->tipo_inmueble =='Local/Oficina' && !$item->bathrooms && $item->aseos)
                                                        <p><i class="fa fa-bath"></i> Toilets: {{$item->aseos}}</p>
                                                    @endif
                ...
                <div class="my-0 col-12">
                    <div class="row  justify-content-center align-items-center">
                        <a href="/inmuebles/en"  class="btn btn-warning">See more properties ..</a>
                    </div>
                </div>				
		<br>
		<br>		
			<br>
				<div class="section-title text-center my-4">
					<h3 class="font-weight-bold subtitle_feature">EXPERIENCES WITH IAMOVING</h3>
				</div>			
		...
		//$( ".owl-next").owlCarousel.html('<i class="fa fa-chevron-right"></i>');
            ...
            $('#form-reference').on('submit', function(e) {
                ...
                if($('#input-filter').val().trim().length > 0){
                    location.href = 'VisitaVirtual/' + $('#input-filter').val() + '/en';
                }else{
                    var category = 0;
                    ...
                    var url = '/iamovingpro/en/search?category=' + category;
                    if($("#city").val()!=""){
                        url += "&city=" + $("#city").val();
                        location.href = url;
                    }
