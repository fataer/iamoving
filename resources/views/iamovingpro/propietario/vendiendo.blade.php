...
<!--<div class="col-md-1 blog-share">
            ...
            <div class="col-md-10 singel-blog-content">
                ...
                <h2 class="mt-4 mb-2 text-center"><b>VENDE GRATIS Y SIN EXCLUSIVA</b></h2>
				...
				<div class="collapse  my-0" id="collapseExample0">
				  <div class="card  bg-transparent border-dark my-0">
						  ...
						  <div class="card-body text-success  my-0">
							...
							<p class="card-text text-center">Así, los interesados en visitar tu piso podrán hacer <b>una primera visita sin salir de casa</b> y conocer a fondo todos los detalles, antes de visitarla en persona. Trabajamos para ahorrarte tiempo con miles llamadas, emails y visitas que no aportan nada.</p>
						  </div>					
					  </div>
                  </div>					  
            </div>
			...
			<p class="my-3"></p>
				...
				<div class="collapse  my-0" id="collapseExample1">
				  <div class="card  bg-transparent border-dark my-0">
						  ...
						  <div class="card-body text-success  my-0">
								  <p class="card-text text-center">En iamoving.com, en nuestras redes sociales y en idealista también.</p>							
						  </div>					
					  </div>
                  </div>					  
            </div>
			...
			<p class="my-3"></p>
				...
				<div class="collapse  my-0" id="collapseExample3">
				  <div class="card  bg-transparent border-dark my-0">
						  ...
						  <div class="card-body text-success  my-0">
							<p class="card-text text-center">Una vez que el interesado haya realizado su visita virtual y esté convencido de que tu piso encaja con lo que está buscando, el podrás solicitar una visita presencial. Escoge el día y la hora que tú prefieras para enseñarle el piso, sin visitas frustradas. Entendemos que puede resultar difícil realizar las visitas de tu vivienda si está ocupado o si no vives cerca de la propiedad, te ayudaremos con las visitas.</p>
						  </div>					
					  </div>
                  </div>					  
            </div>
