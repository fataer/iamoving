...
@section('content')
<!-- page -->
<section class="page-section single-blog  mt-5"     style="padding-bottom: 35px;">
    <div class="container">
            <div class="row">
<!--<div class="col-md-1 blog-share">
            ...
            <div class="col-md-10 singel-blog-content">
                <div class="row justify-content-center">
                    <div class="col text-center">
                        <img src="/img/iamoving_free_grey_transparent.png" alt="Iamoving logo" width="175" class="m-0">
                    </div>
                </div>
                <!--<h2 class="my-4 text-center">¡De particular a particular!</h2>-->
               <!-- <h2 class="my-4 text-center"><b>Asegura tu alquiler y olvídate de todo</b></h2>-->

                <h2 class="mt-3 mb-3 text-center">
                    
                     Sin intermediación de IAMOVING
                
                </h2>				
                <p class="my-1 text-center">
                    
                     <b>Publica de forma independiente, como particular o inmobiliaria.</b>
               ...
               <!-- <p class="my-4 text-center">
                    ...
                    <b>Primer año totalmente gratuito.</b>
                ...
                <div class="col-md-12">
                    <video-card 
                        href="https://youtu.be/76JQ_tY4XbI"
                        source="https://www.youtube.com/embed/76JQ_tY4XbI" >-->
				...
				<!--<p class="my-0">
				  <button type="button" class="btn btn-iamoving btn-lg btn-block border-warning"  data-toggle="collapse" data-target="#collapseExample" aria-expanded="false" 
				  aria-controls="collapseExample" aria-haspopup="true" style="cursor:default;border-radius:0%; !important;outline:none !important;outline-width: 0 !important; box-shadow: none;-moz-box-shadow: none;-webkit-box-shadow: none;">
				      REALIZAMOS VISITAS
			      </button>
				</p>
				  ...
				  <div class="card card-body bg-transparent border-warning">
						  ...
						  <div class="card-body text-success">
							...
							<p class="card-text text-center my-0"> Entendemos que puede resultarte difícil realizar las vistas de su vivienda si está ocupado o </p>
							<p class="card-text text-center my-0">si no vive cerca de la propiedad, te ayudaremos con las visitas.</p>
				...
				<div class="collapse  my-0" id="collapseExample0">
				  <div class="card  bg-transparent border-dark my-0">
						  ...
						  <div class="card-body text-success  my-0">
							...
							<p class="card-text text-center">Un recorrido virtual es más realista que una serie de fotografías convencionales, el inquilino solo visita las viviendas que realmente le interesan y reduce las molestias para el propietario al filtrarse las visitas de curiosos. Hacemos fotos, videos, tomamos medidas y realizamos un informe detallado de tu casa. Sabemos que, a la hora de alquilar, todos los detalles son muy importantes. Por eso, ofrecemos también un recorrido virtual por los alrededores del inmueble.</p>
							<p class="card-text text-center">Así, los interesados en visitar tu piso podrán hacer una primera visita sin salir de casa y conocer a fondo todos los detalles, antes de visitarlo en persona. Trabajamos así para ahorrarte tiempo con miles llamadas, emails por más informaciones y evitando visitas frustradas que no aportan en nada.</p>
						  </div>					
					  </div>
                  </div>					  
            </div>
			...
			<p class="my-3"></p>
				...
				<p class="my-0">
				  <button type="button" class="btn btn-dark btn-lg btn-block border-dark dropdown-toggle"  data-toggle="collapse" 
				  data-target="#collapseExample10" aria-expanded="false" aria-controls="collapseExample10" aria-haspopup="true" 
				  style="font-weight:bold;color:#ffffff;border-radius:0%; !important;;outline:none !important;outline-width: 0 !important; box-shadow: none;-moz-box-shadow: none;-webkit-box-shadow: none;" >
				  REPORTAJE AUDIOVISUAL
			      </button>
				</p>
				<div class="collapse  my-0" id="collapseExample10">
				  <div class="card  bg-transparent border-dark my-0">
						  ...
						  <div class="card-body text-success  my-0">
							...
							<!--<p class="card-text text-center">Así, los interesados en visitar tu piso podrán hacer una <b>primera visita sin salir de casa</b> y conocer a fondo todos los detalles, antes de visitarlo en persona. Trabajamos así para ahorrarte tiempo con miles llamadas, emails por más informaciones y evitando visitas frustradas que no aportan en nada.</p>-->
						  </div>					
					  </div>
                  </div>					  
            </div>
			...
			<p class="my-3"></p>
				...
				<div class="collapse  my-0" id="collapseExample1">
				  <div class="card  bg-transparent border-dark my-0">
						  ...
						  <div class="card-body text-success  my-0">
								  <p class="card-text text-center">Publicitamos tu inmueble en nuestra plataforma, en nuestras redes sociales, en departamentos de recursos humanos de grandes multinacionales, en embajadas y también en escuelas de másteres y universidades.</p>							
						  </div>					
					  </div>
                  </div>					  
            </div>
			...
			<p class="my-3"></p>
				...
				<div class="collapse  my-0" id="collapseExample2">
				  <div class="card  bg-transparent border-dark my-0">
						  ...
						  <div class="card-body text-success  my-0">
							  <p class="card-text text-center">Una vez que el interesado haya realizado la visita virtual y esté convencido de que tu piso encaja perfectamente con lo que está buscando, el podrá solicitar una visita presencial, en ese momento te enviamos su perfil de inquilino: nombre, edad, dónde trabaja, sueldo aprox., etc. para que veas si este perfil del inquilino te cuadra. Si es el tipo de inquilino que estás buscando, podrás confirmar la visita o, en caso contrario, rechazarla.</p>
						  </div>					
					  </div>
                  </div>					  
            </div>
           <!-- <div class="col-12">
			<p class="my-3"></p>
				...
				<div class="collapse  my-0" id="collapseExample3">
				  <div class="card  bg-transparent border-dark my-0">
						  ...
						  <div class="card-body text-success  my-0">
							<p class="card-text text-center">Escoge el día, la hora y el inquilino que tú prefieras para enseñarle el piso, conocerle en persona. ¡Sin visitas frustradas! Entendemos que puede resultar difícil realizar las visitas de tu vivienda si está ocupado o si no vive cerca de la propiedad, te ayudaremos con las visitas.</p>
						  </div>					
					  </div>
                  </div>					  
            </div>
			...
			<p class="my-3"></p>
				...
				<p class="my-0">
				  <button type="button" class="btn btn-dark btn-lg btn-block border-dark dropdown-toggle"  data-toggle="collapse" 
				  data-target="#collapseExample31" aria-expanded="false" aria-controls="collapseExample31" aria-haspopup="true" 
				  style="font-weight:bold;color:#ffffff;border-radius:0%; !important;;outline:none !important;outline-width: 0 !important; box-shadow: none;-moz-box-shadow: none;-webkit-box-shadow: none;" >
				  HACEMOS EL CONTRATO DE ALQUILER
			      </button>
				</p>
				<div class="collapse  my-0" id="collapseExample31">
				  <div class="card  bg-transparent border-dark my-0">

						  <div class="card-body text-success  my-0">
							<p class="card-text text-center">Si lo necesitas, hacemos el contrato de alquiler y te ayudamos con todas tus dudas, preguntas o cláusulas que desees incluir, te ofrecemos una asistencia legal personalizada.</p>
						  </div>					
					  </div>
                  </div>					  
            </div>	-->		
				...
				<div class="collapse  my-0" id="collapseExample4">
				  <div class="card  bg-transparent border-dark my-0">
						  ...
						  <div class="card-body text-success  my-0">
							...
							<p class="card-text text-center">Entendemos que puede resultar difícil realizar las visitas de tu vivienda si está ocupado o si no vive cerca de la propiedad, te ayudaremos con las visitas.</p>
						  </div>					
					  </div>
                  </div>					  
            </div>-->
			...
			<p class="my-3"></p>
				...
				<div class="collapse  my-0" id="collapseExample5">
				  <div class="card  bg-transparent border-dark my-0">
						  ...
						  <div class="card-body text-success  my-0">
								  <p class="card-text text-center">Me encantó la visita, me cuadra el inquilino, pero ¿puedo comprobar que sea fiable y no un inquilino moroso? Sí, a través de un análisis de solvencia, morosidad y viabilidad, comprobaremos que el potencial inquilino sea fiable y no un inquilino moroso. Eliminando todos aquellos inquilinos que falsifican sus nóminas para mostrarse solventes y sin contar los inquilinos con solvencia económica y buen trabajo pero que van de piso en piso sin pagar el alquiler.</p>							
						  </div>					
					  </div>
                  </div>					  
            </div>
			...
			<p class="my-3"></p>
				...
				<div class="collapse  my-0" id="collapseExample6">
				  <div class="card  bg-transparent border-dark my-0">
						  ...
						  <div class="card-body text-success  my-0">
							  <p class="card-text text-center">Directamente entre inquilino y propietario. Si lo necesitas, te ayudamos con el contrato y una atención jurídica personalizada.</p>
						  </div>					
					  </div>
                  </div>					  
            </div>
			...
			<p class="my-3"></p>
				...
				<p class="my-0">
				  ...
				  style="font-weight:bold;color:#ffffff;border-radius:0%; !important;;outline:none !important;outline-width: 0 !important; box-shadow: none;-moz-box-shadow: none;-webkit-box-shadow: none;" >
				  PROTECCIÓN DE ALQUILER, GARANTIZAMOS EL PAGO
			      </button>
				</p>
				<div class="collapse  my-0" id="collapseExample7">
				  <div class="card  bg-transparent border-dark my-0">
						  ...
						  <div class="card-body text-success  my-0">
							<p class="card-text text-center"><b>Pago garantizado</b>: ¡La confianza no se compra, se gana! Así es como lo protegemos y garantizamos el pago de tu hogar durante los primeros 12 meses del contrato.</p>
							<p class="card-text text-center"><b>Daños materiales ocasionados por el inquilino</b>: Te garantizamos una indemnización por actos vandálicos ocasionados por el inquilino. Si el inquilino no ha pagado el alquiler y además causa desperfectos en la vivienda, te compensamos.</p>						
							<p class="card-text text-center"><b>Defensa jurídica</b>: Ofrecemos defensa jurídica al arrendador frente a conflictos derivados del contrato, incluido el desahucio, la reclamación de daños y perjuicios. Así como la defensa penal del arrendador, acciones y honorarios profesionales.</p>													
							<p class="card-text text-center"><b>Daños materiales causados por incendio</b>: También te garantizamos el perjuicio sufrido derivado de la pérdida de alquiler de la vivienda, con origen en la rescisión forzosa de contrato por inhabitabilidad total como consecuencia directa de los daños materiales causados por incendio, explosión o caída de rayo.</p>						
							<p class="card-text text-center"><b>Sustitución de cerradura</b>: En caso de robo o intento de robo en la vivienda alquilada o incluso en caso de desahucio de garantizamos la sustitución de cerradura de la puerta principal de acceso a la vivienda alquila.</p>													
						  </div>					
					  </div>
                  </div>					  
            </div>
			...
			<p class="my-3"></p>
				...
				<p class="my-0">
				  <button type="button" class="btn btn-dark btn-lg btn-block border-dark dropdown-toggle"  data-toggle="collapse" 
				  data-target="#collapseExample8" aria-expanded="false" aria-controls="collapseExample8" aria-haspopup="true" 
				  style="font-weight:bold;color:#ffffff;border-radius:0%; !important;;outline:none !important;outline-width: 0 !important; box-shadow: none;-moz-box-shadow: none;-webkit-box-shadow: none;" >
				  INVENTARIO DE BIENES Y MUEBLES
			      </button>
				</p>
				<div class="collapse  my-0" id="collapseExample8">
				  <div class="card  bg-transparent border-dark my-0">

						  <div class="card-body text-success  my-0">
								  <p class="card-text text-center">Hacemos fotos, videos y un informe detallado de tu inmueble, es la forma más eficaz de tener controlado todo que se deja en el interior de una vivienda cuando va a ser alquilada.  Ahórrarte malentendidos y frustraciones económicas a final del contrato a través de nuestro inventario super detallado.</p>							
						  </div>					
					  </div>
                  </div>					  
            </div>-->
        <!--    <div class="col-12">
			<p class="my-3"></p>
				...
				<p class="my-0">
				  <button type="button" class="btn btn-dark btn-lg btn-block border-dark dropdown-toggle"  data-toggle="collapse" 
				  data-target="#collapseExample9" aria-expanded="false" aria-controls="collapseExample9" aria-haspopup="true" 
				  style="font-weight:bold;color:#ffffff;border-radius:0%; !important;;outline:none !important;outline-width: 0 !important; box-shadow: none;-moz-box-shadow: none;-webkit-box-shadow: none;" >
				  SERVICIO DE MANTENIMIENTO
			      </button>
				</p>
				<div class="collapse  my-0" id="collapseExample9">
				  <div class="card  bg-transparent border-dark my-0">

						  <div class="card-body text-success  my-0">
							  <p class="card-text text-center">En caso de que lo prefieras, nos ocuparemos de gestionar todas las reparaciones de tu casa, buscamos, comprobamos y filtramos a expertos en servicios, desde un grifo que gotea, hasta una reforma integral. Entendemos que puede resultar difícil, si estás ocupado o si no vives cerca de la propiedad para realizar las gestiones y mantenimiento de su vivienda ¡Nosotros cuidaremos de tu hogar!</p>
						  </div>					
					  </div>
                  </div>					  
            </div>-->						
				<!--<p class="my-0">
				  <button type="button" class="btn btn-iamoving btn-lg btn-block border-warning"  data-toggle="collapse" data-target="#collapseExample" aria-expanded="false" 
				  aria-controls="collapseExample" aria-haspopup="true" style="cursor:default;border-radius:0%; !important;outline:none !important;outline-width: 0 !important; box-shadow: none;-moz-box-shadow: none;-webkit-box-shadow: none;">
				      PÉRDIDA DE ALQUILER POR INCENDIOS
			      </button>
				</p>
				  ...
				  <div class="card card-body bg-transparent border-warning">
						  ...
						  <div class="card-body text-success">
							...
							<p class="card-text text-center my-0">También te garantizamos el perjuicio sufrido derivado de la pérdida </p>
							<p class="card-text text-center my-0">de alquiler de la vivienda, con origen en la rescisión </p>
							<p class="card-text text-center my-0">forzosa de contrato por inhabitabilidad total como consecuencia directa </p>
							<p class="card-text text-center my-0">de los daños materiales causados por incencio, explosión o caida de rayo.</p>
				...
				<!--</div>				-->
											...
											<div class="row mt-1 mb-4">
												...
												<div class="col-md-10 ml-2" style="background-color:white;">
													<ul class="ml-0">
...
<div class="text-center my-3">
                                                         <p></p>
                          <!--  <img src="/img/icono.png" alt="iamoving" class="m-0"  width="350">
                                                        <p></p> -->
														<button type="button" class="btn btn-lg" style="background-color:#333333;color:#ffffff;font-weight:bold;" data-toggle="modal" data-target="#modalAnuncia">Infórmate Gratis</button>
                </div>				 
      			...
      			{!! csrf_field() !!} 
	          		<div class="col-md-12">
	          			<div class="form-group">
	          				<ul>
								<li class="ml-5">
									Si después de 15 días aún no lo hemos alquilado y llegado el vencimiento de la exclusividad, éste se prorrogará automáticamente por 15 días más, salvo que el propietario manifieste por escrito su intención de no prorrogar con cinco días de antelación como mínimo, antes de la fecha de vencimiento del acuerdo de exclusividad o de cualquiera de las prórrogas.
								</li>
							</ul>
...
@section('scripts')
    ...
    <script>
        $(document).ready(function() { 
            $("#tipo_publicacion").val("alquiler_free");
