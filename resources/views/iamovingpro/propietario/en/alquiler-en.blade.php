...
<div class="col-md-12 text-center mb-0">										
									...
									<div class="col-md-2">
										...
										<p class="my-5 text-center">
												...
												<!--<button type="button" class="btn btn-iamoving btn-lg" style="color:#333333;" data-toggle="modal" data-target="#modalAnuncia">Infórmate Gratis</button>-->
										</p>
				...
				<!--</div>-->	
														...
														<div class="card">
															<nav class="nav nav-pills nav-justified border-bottom" role="tablist">
																...
																<a class="nav-item nav-link" href="#tab22" data-toggle="tab"
																	...
																	<span class="display-5 d-block">TENANTS</span>
										...
										<div class="col-sm-5  d-block d-sm-block d-md-none">
											<ul class="ml-4">
											  ...
											  <li class="ml-1"><i class="icon ion-md-checkmark-circle-outline"></i><h5 class="display-5" > Know the profile of the interested party before each visit </h5></li>
											  <li class="ml-1"><i class="icon ion-md-checkmark-circle-outline"></i><h5 class="display-5" > No wasted time with frustrated calls and visits </h5></li>
											  
											</ul>
											<p  class="ml-1 mt-3" style="color: #2d2e35 !important;"><i class="fa fa-check"></i> We increase your chances of renting and you will save time and money</p>
										</div>
													...
													<ul class="ml-5">
														<ul class="ml-5">
															<ul class="ml-4">
															  ...
															  <li class="ml-5"><i class="icon ion-md-checkmark-circle-outline"></i><h5 class="display-5" >  Know the profile of the interested party before each visit </h5></li>
															  <li class="ml-5"><i class="icon ion-md-checkmark-circle-outline"></i><h5 class="display-5" > No wasted time with frustrated calls and visits </h5></li>
															  
															</ul>
															<p  class="ml-5 mt-3" style="color: #2d2e35 !important;"><i class="fa fa-check"></i> We increase your chances of renting and you will save time and money</p>
														</ul>
													</ul>
												</ul>
											</ul>
										...
										<div class="col-sm-5  d-block d-sm-block d-md-none">
											<ul class="ml-4">
											  ...
											  <li class="ml-1"><i class="icon ion-md-checkmark-circle-outline"></i><h5 class="display-5" > We verify all the flats avoiding you scams</h5></li>
											  <li class="ml-1"><i class="icon ion-md-checkmark-circle-outline"></i><h5 class="display-5" > No misleading photos or frustrated visits </h5></li>
											</ul>
											<p  class="ml-1 mt-3" style="color: #2d2e35 !important;"><i class="fa fa-check"></i> Without wasting time, the easy and safe way to rent</p>
										</div>
										<div class="ml-5 d-none d-sm-none d-md-block">
											<ul class="ml-4">
												<ul class="ml-5">
													<ul class="ml-5">
														<ul class="ml-5">
															<ul class="ml-4">
															  ...
															  <li class="ml-5"><i class="icon ion-md-checkmark-circle-outline"></i><h5 class="display-5" > We verify all the flats avoiding you scams</h5></li>
															  <li class="ml-5"><i class="icon ion-md-checkmark-circle-outline"></i><h5 class="display-5" > No misleading photos or frustrated visits </h5></li>
															</ul>
															<p  class="ml-5 mt-3" style="color: #2d2e35 !important;"><i class="fa fa-check"></i> Without wasting time, the easy and safe way to rent</p>
														</ul>
													</ul>
												</ul>
											</ul>
													  ...
													  <div class="row mt-3">
														...
														<div class="col-md-2">
															...
															<h2 class="card-text text-center">ARE YOU AN OWNER?</h2>
																  <p class="card-text text-center">WE IMPROVE YOUR WAY OF RENTING</p>

															
															<!--<span id="dots"></span><span id="more">-->
															<div class="text-success my-1">
																<p class="card-text text-center">In this way, no one wastes time visiting or receiving visits that do not contribute anything, the tenant only visits the properties that really interest them and we eliminate visits without potential to the property.</p>
															</div>											
															<div class="section-title text-center my-0"  style="padding-top: 10px;padding-bottom: 0px;">
																<h4 class="text-center mb-4"><b>MORE THAN 800 VIRTUAL VISITS CARRIED OUT</b></h4>
															</div>					
															<div class="text-success my-1">
					...
					<div class="row grid-divider" style="margin-right: 10px;">
						<div class="col-sm-6 mb-3">
						  <div class="col-padding">
							<h4 class="my-2 mb-4 text-center" ><b>INQUILINOS</b></h4>
						...
						<!--<div class="container my-2">
								  <div class="row mt-3">
									...
									<div class="col-md-2">
										...
										<span id="dots"></span><span id="more">
										<div class="text-success my-1">
											<p class="card-text text-center">De esta manera, nadie pierde el tiempo visitando o recibiendo visitas que no aportan nada, el inquilino solo visita los inmuebles que realmente les interesa y eliminamos las visitas sin potencial a la propiedad.</p>
										</div>											
										<div class="section-title text-center my-0"  style="padding-top: 10px;padding-bottom: 0px;">
																	...
																	<div class="my-0" id="collapseExample3">
																	  <div class="card  bg-transparent border-dark my-0">
																			  <div class="card-body text-success  my-0">
																				...
																				<h5 class="display-5 text-center text-center my-1" >2-You will receive requests for visits from those who really liked your flat, in addition, you will be able to know their profile before each visit.</b></h5>
																				<h5 class="display-5 text-center text-center my-1" ><b>You can choose whoever you prefer to show your apartment and meet him in person.</b></h5>
																				<!--<h5 class="display-5 text-center text-center my-1" >Escoge el día, la hora y los interesados que tú prefieras para enseñar el piso y conocerlos en persona.</h5>-->
																	...
																	<div class="my-0" id="collapseExample3">
																	  <div class="card  bg-transparent border-dark my-0">
																			  <div class="card-body text-success  my-0">
																				...
																				<h5 class="display-5 text-center text-center my-1" >3-<b>I loved the visit, but can I check if the interested party is solvent?</b></h5>
																				...
																				<h5 class="display-5 text-center text-center mt-3" >Yes, we provide you with a <b>Solvency Study</b> so that you can check the viability of the person interested in renting your flat. As times are, you have to be very careful who will be the future tenant.</h5>
																			  </div>					
																		 </div>
																	 </div>																	
																</div>
																	...
																	<div class="my-0" id="collapseExample3">
																	  <div class="card  bg-transparent border-dark my-0">
																			  <div class="card-body text-success  my-0">
																				...
																				<h5 class="display-5 text-center text-center my-1" >4-<b>Estudio de Solvencia</b></h5>
																				
																				<h5 class="display-5 text-center text-center mt-3" ><b>Me encantó la visita, pero ¿puedo verificar si la parte interesada es solvente?</b></h5>
																				<h5 class="display-5 text-center text-center mt-3" >Si, te brindamos con un <b>Estudio de Solvencia</b> para que puedas comprobar la viabilidad del interesado en alquilar tu piso. Según están los tiempos hay que vigilar muy bien quién será el futuro inquilino.</h5>
																			  </div>					
																		 </div>
																	 </div>	
			...
			<div class="container my-0 mt-3">
					...
					<div class="row  justify-content-center">
						<div class="col-12">
							...
							<p class="my-0">
							  ...
							  style="font-weight:bold;border-radius:0%; !important;;outline:none !important;outline-width: 0 !important; box-shadow: none;-moz-box-shadow: none;-webkit-box-shadow: none;" >
							  WE INCREASE YOUR RENTAL POSSIBILITIES 
							  </button>
							</p>
									  ...
									  <div class="card-body text-success my-0">
											...
											<div class="col-md-12 ml-2">
												...
												<ul class="ml-0">
												  ...
												  <li class="ml-0" style="list-style:none;"><h5 class="display-5" >Tenants say that a <b>Virtual Tour</b> gives them more confidence than a series of conventional photographs, being a decisive value when filtering their visits. Increasing your chances.</h5></li>								  								  
												  ...
												  <li class="ml-0" style="list-style:none;"><h5 class="display-5" >Our listing delivery model automatically answers questions from all prospects 24 hours a day, because one missed email or call will immediately reduce your chances of renting against the competition.</h5></li>								  					
				...
				<!--<div class="container mt-5 my-1" >
					<div class="row grid-divider" >
						<div class="col-sm-6 mb-3 mr-0" style="padding-right: 0px;padding-left: 0px;">
						  <div class="col-padding">
						 ...
						 <div class="row mt-0">
							...
							<div class="col-md-5 ml-3  d-none d-sm-none d-md-block">
								...
								<ul class="ml-5">
								  ...
								  <li class="ml-5"><i class="icon ion-md-checkmark-circle-outline"></i><h5 class="display-5" > Aumentamos por 10 tus posibilidades de alquilar <a  @click.prevent="modalAumentaArriba"><img src="/img/info_iamoving.png"  width="15" height="15" style="margin-bottom:5px;" alt="info"></a></h5></li>
							...
							<div class="col-sm-5  d-block d-sm-block d-md-none">
							  <div class="pricing-box">
								<ul class="ml-4">
								  ...
								  <li class="ml-0"><i class="icon ion-md-checkmark-circle-outline"></i><h5 class="display-5" > Aumentamos por 10 tus posibilidades de alquilar <a  @click.prevent="modalAumentaArriba"><img src="/img/info_iamoving.png"  width="15" height="15" style="margin-bottom:5px;" alt="info"></a></h5></li>
						...
						<!--	<div class="container my-0">
								  <div class="row mt-5">
									...
									<div class="col-md-2">
						              ...
						              <div class="sc-1jqkf70-0 jCQGKS">
                <section class="sc-iwsKbI hJtXAX">
                  <!--<div class="sc-10fklo0-0 jJsluQ sc-10rvb1h-0 iyBYz" direction="row">
                    <div class="m70hd6-0 hsUnyu">
                      <section class="sc-1jpmmt8-0 fZuWNc">
                        <h2 class="sc-bdVaJa hjBPaq">
                          <span>Condiciones con IAMOVING:</span>
                        </h2>
                        <h3 class="sc-bdVaJa hBnwDG">
                          <span>Te aprovechas de los beneficios exclusivos de IAMOVING</span>
                        </h3>
                      </section>
                    </div>
                    <div class="m70hd6-0 gvSOMz"></div>
                    <div class="m70hd6-0 fBCnjt">
                      <section class="sc-1jpmmt8-0 fZuWNc">
                        <h2 class="sc-bdVaJa hjBPaq">
                          <span>Compare las condiciones de las agencias</span>
                        </h2>
                        <h3 class="sc-bdVaJa hBnwDG">
                          <span>Tu dejas de aprovechar los beneficios exclusivos de IAMOVING</span>
                        </h3>
                      </section>
                    </div>
                  </div>-->
                  <div class="sc-10rvb1h-0 htIvPI" direction="row">
					<div class="m70hd6-0 fBCnjt tooltipEl" data-placement="top"  id="clickeable" onclick="location.href='/alquilando-con-iamoving/en';" style="cursor:pointer;height: 65%;" alt="See more..." >
                      <div class="jss33 jss37 jss34 sc-95xf8-0 ecJbVf" style="border:2px solid #333333; background-color:#333333;height: 65%;">
                        <div class="sc-1x6rk30-0 hAjjvO"  style="padding: 0 0;">
                          <div tabindex="-1" height="24">
                           <!-- <span class="jss259">-->
                             <!--<span ><h4 style="color:#ffffff;">Alquilando con IAMOVINGpro</h4></span>-->
                <div class="row justify-content-center">
                    <div class="col text-center">
                        <img src="/img/iamoving_white_transparent.png" alt="Iamoving logo" width="175" class="m-0">
                          ...
                          <b><h4><span style="color:#333333;"><a href="/alquilando-con-iamoving/en" style="color:#333333;font-size:1.1em;"></a></span></h4></b>
						 <!-- <b><h5><span style="color:#333333;"><b>Plan protección alquiler</b></span></h5></b>-->
                          <!--<span style="color:#FFFFFF;">Plan protección alquiler</span>-->
                        </div>
                        <p class="sc-1n10p5-0 jDJpTw sc-bdVaJa ibMzuR" style="padding: 11px; margin-bottom: 10px;">
						<span  style="color:#ffffff;">Totally free!</span>	
                         <!-- <span  style="color:#ffffff;">7 días de exclusividad, si después de una semana aún no lo hemos alquilado, quitamos la exclusividad y te mantenemos las mismas condiciones. ¡Totalmente gratuito!</span>-->
                        </p>
                        <ul class="jss200 jss201">
                          ...
                          <!--<li class="jss204 jss208 jss211">
                            ...
                            <div class="jss221 jss223">
                              <span class="sc-bdVaJa jiARkd">
                                <span  style="color:#ffffff;">Enseña tu piso desde cualquier lugar</span>
                              </span>
                            </div>
                          </li>-->						  
                          <li class="jss204 jss208 jss211">
                            ...
                            <div class="jss221 jss223">
                              <span class="sc-bdVaJa jiARkd">
                                <span  style="color:#ffffff;">Interested party profile</span>
                              </span>
                            </div>
                          </li>						  
                          <!--<li class="jss204 jss208 jss211">
                            ...
                            <div class="jss221 jss223">
                              <span class="sc-bdVaJa jiARkd">
                                <span><a href="/plan-proteccion-alquiler" style="color:#ffffff;font-size:1.1em;"><b><u>Protección de alquiler</u></b></a></span>
                              </span>
                            </div>
							  ...
							  <li class="jss204 jss208 jss211">
								<!--<svg class="jss215 jss216 jss214 sc-6ysmz4-0 kClokr" focusable="false" viewBox="0 0 24 24" aria-hidden="true" theme="[object Object]">
								  <g>
									<path style="color:#ffffff;" d="M9 16.17L4.83 12l-1.42 1.41L9 19 21 7l-1.41-1.41z"></path>
								  </g>
								</svg>-->
								<svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="check" class="svg-inline--fa fa-check fa-w-16" role="img" 
								xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"  style="height: 1.45em;width: 1.45em;">
                          ...
                          <li class="jss204 jss208 jss211">
                            ...
                            <div class="jss221 jss223">
                              <span class="sc-bdVaJa jiARkd">
                                <span  style="color:#ffffff;">We make the rental contract</span>
                              </span>
                            </div>
                          </li>								  
							  <li class="jss204 jss208 jss211">
								...
								<div class="jss221 jss223">
								  <span class="sc-bdVaJa jiARkd">
									<span  style="color:#ffffff;">Solvency study </span>
								  </span>
								</div>
							  </li>
							<!--  <li class="jss204 jss208 jss211">
								...
								<div class="jss221 jss223">
								  <span class="sc-bdVaJa jiARkd">
									<span  style="color:#ffffff;">Hacemos el contrato</span>
								  </span>
								</div>
							  </li>
							  <li class="jss204 jss208 jss211">
								...
								<div class="jss221 jss223">
								  <span class="sc-bdVaJa jiARkd">
									<span  style="color:#ffffff;">Pago garantizado del alquiler</span>
								  </span>
								</div>
							  </li>
							  	<li class="jss204 jss208 jss211">
								...
								<div class="jss221 jss223">
								  <span class="sc-bdVaJa jiARkd">
									<span  style="color:#ffffff;">Daños materiales</span>
								  </span>
								</div>
							  </li>
							  	<li class="jss204 jss208 jss211">
								...
								<div class="jss221 jss223">
								  <span class="sc-bdVaJa jiARkd">
									<span  style="color:#ffffff;">Defensa jurídica</span>
								  </span>
								</div>
							  </li>	
							  	<li class="jss204 jss208 jss211">
								...
								<div class="jss221 jss223">
								  <span class="sc-bdVaJa jiARkd">
									<span  style="color:#ffffff;">Daños causados por incendio</span>
								  </span>
								</div>
							  </li>	
							  							  	<li class="jss204 jss208 jss211">
								...
								<div class="jss221 jss223">
								  <span class="sc-bdVaJa jiARkd">
									<span  style="color:#ffffff;">Sustitución de cerradura</span>
								  </span>
								</div>
							  </li>	
							  	<li class="jss204 jss208 jss211">
								...
								<div class="jss221 jss223">
								  <span class="sc-bdVaJa jiARkd">
									<span  style="color:#ffffff;">Inventario de bienes y muebles</span>
								  </span>
								</div>
							  </li>	-->
							  	<!--<li class="jss204 jss208 jss211">
								...
								<div class="jss221 jss223">
								  <span class="sc-bdVaJa jiARkd">
									<span  style="color:#ffffff;">Servicio de mantenimiento</span>
								  </span>
								</div>
							  </li>	-->							  
...
<!--<div class="m70hd6-0 fBCnjt tooltipEl" data-placement="top"  id="clickeable" onclick="location.href='/alquilando-con-iamovingfree';" style="cursor:pointer;height: 65%;" alt="Ver más..." >
                      <div class="jss33 jss37 jss34 sc-95xf8-0 ecJbVf" style="border:2px solid #333333; background-color:#333333;height: 65%;">
                        <div class="sc-1x6rk30-0 hAjjvO"  style="padding: 0 0;">
                          <div tabindex="-1" height="24">
                ...
                <div class="row justify-content-center">
                    <div class="col text-center">
                        <img src="/img/iamoving_free_white_transparent.png" alt="Iamoving logo" width="175" class="m-0">
                    </div>
                </div>							
                          </div>
                          <b><h4><span style="color:#333333;"><a href="/alquilando-con-iamovingfree" style="color:#333333;font-size:1.1em;"></a></span></h4></b>
                        </div>
                        <p class="sc-1n10p5-0 jDJpTw sc-bdVaJa ibMzuR" style="padding: 11px; margin-bottom: 10px;">
						<span  style="color:#ffffff;">¡Publica y alquila por libre!</span>	
                        </p>
                        <ul class="jss200 jss201">
                          <li class="jss204 jss208 jss211">
								<svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="check" class="svg-inline--fa fa-check fa-w-16" role="img" 
                            ...
                            <div class="jss221 jss223">
                              <span class="sc-bdVaJa jiARkd">
                                <span  style="color:#ffffff;">Visita virtual</span>
                              </span>
                            </div>
                          </li>
                          <li class="jss204 jss208 jss211">
                            ...
                            <div class="jss221 jss223">
                              <span class="sc-bdVaJa jiARkd">
                                <span  style="color:#ffffff;">Reportaje audiovisual</span>
                              </span>
                            </div>
                          </li>						  
                          <li class="jss204 jss208 jss211">
                            ...
                            <div class="jss221 jss223">
                              <span class="sc-bdVaJa jiARkd">
                                <span  style="color:#ffffff;">Publicación</span>
                              </span>
                            </div>
                          </li>
                          ...
                          <li class="jss204 jss208 jss211">
                            ...
                            <div class="jss221 jss223">
                              <span class="sc-bdVaJa jiARkd">
                                <span  style="color:#ffffff;">Perfil del interesado</span>
                              </span>
                            </div>
                          </li>						  
							  ...
							  <li class="jss204 jss208 jss211">
								...
								<div class="jss221 jss223">
								  <span class="sc-bdVaJa jiARkd">
									<span  style="color:#ffffff;">Estudio de solvencia  </span>
								  </span>
								</div>
							  </li>
					...
					<!-- <div class="m70hd6-0 gvSOMz">
                      <span class="sc-1wk3z2y-0 jWLPEz">
                        <div class="jss261 jss262 sc-13q38wx-0 jugaIX" theme="[object Object]">Vs.</div>
                      </span>
                    </div>-->
                    <div class="m70hd6-0 fBCnjt" style="height: 75%;">
                      <div class="jss33 jss37 jss34 sc-95xf8-0 ecJbVh" style="border:2px solid #333333;height: 75%;">
                        <div class="sc-1x6rk30-0 hAjjvO" style="padding: 0 0;">
                          <div tabindex="-1" color="" height="24">
                           <!-- <span class="jss259">-->
                              <span><h4><b>Out of IAMOVING</b></h4></span>
                           <!-- </span>-->
                          </div>
                        </div>
                        <p class="sc-1n10p5-0 jDJpTw sc-bdVaJa ibMzuR" style="padding: 11px; margin-bottom: 10px;">
                          <span  style="color:#333333;">Your nightmare begins:</span>
                        </p>						
                        <ul class="jss200 jss201">
                          ...
                          <li class="jss204 jss208 jss211">
                            ...
                            <div class="jss221 jss223">
                              <span class="sc-bdVaJa jiARkd">
                                <span>Thousands of unwanted calls</span>
                              </span>
                            </div>
                          </li>
                          <li class="jss204 jss208 jss211">
                          ...
                          <li class="jss204 jss208 jss211">
                            ...
                            <div class="jss221 jss223">
                              <span class="sc-bdVaJa jiARkd">
                                <span>Insolvent Interested Parties</span>
                              </span>
                            </div>
                          </li>
                          <li class="jss204 jss208 jss211">
                            ...
                            <div class="jss221 jss223">
                              <span class="sc-bdVaJa jiARkd">
                                <span>Expenses with photographic report and advertisements</span>
                              </span>
                            </div>
                          </li>						  
                          <li class="jss204 jss208 jss211">
                          ...
                          <li class="jss204 jss208 jss211">
                            ...
                            <div class="jss221 jss223">
                              <span class="sc-bdVaJa jiARkd">
                                <span>A lot of waste of time</span>
                              </span>
                            </div>
                          </li>						  
                         <!-- <li class="jss204 jss208 jss211">
                            ...
                            <div class="jss221 jss223">
                              <span class="sc-bdVaJa jiARkd">
                                <span>Gastos con reportaje fotográfico y anuncios en portales inmobiliarios</span>
                              </span>
                            </div>
                          </li>-->
                         <!-- <li class="jss204 jss208 jss211">
							...
							<!--<i class="far fa-smile" style="height: 1.45em;width: 1.45em;"></i>-->
                           <!-- <div class="jss221 jss223">
                              <span class="sc-bdVaJa jiARkd">
                                <span>Pago incierto (estas en manos del inquilino)</span>
                              </span>
                            </div>
                          </li>
                          <li class="jss204 jss208 jss211">
                            ...
                            <div class="jss221 jss223">
                              <span class="sc-bdVaJa jiARkd">
                                <span>Vivienda desprotegida contra daños</span>
                              </span>
                            </div>
                          </li>	-->							  
                         <!-- <li class="jss204 jss208 jss211">
                            ...
                            <div class="jss221 jss223">
                              <span class="sc-bdVaJa jiARkd">
                                <span>Gastos en comisiones(con agencias y plataformas)</span>
                              </span>
                            </div>
                          </li>-->
                         <!-- <li class="jss204 jss208 jss211">
                            ...
                            <div class="jss221 jss223">
                              <span class="sc-bdVaJa jiARkd">
                                <span>Gastos de  en comisiones</span>
                              </span>
                            </div>
                          </li>-->
                          <!--<li class="jss204 jss208 jss211">
                            ...
                            <div class="jss221 jss223">
                              <span class="sc-bdVaJa jiARkd">
                                <span>Sin defensa jurídica</span>
                              </span>
                            </div>
                          </li>	-->						  
                         <!-- <li class="jss204 jss208 jss211">
                            ...
                            <div class="jss221 jss223">
                              <span class="sc-bdVaJa jiARkd">
                                <span>Gastos con reportaje fotográfico y con anuncio en portales inmobiliarios</span>
                              </span>
                            </div>
                          </li>	
                          <li class="jss204 jss208 jss211">
                            ...
                            <div class="jss221 jss223">
                              <span class="sc-bdVaJa jiARkd">
                                <span>Inquilino insolvente</span>
                              </span>
                            </div>
                          </li>	-->						  
                         <!-- <li class="jss204 jss208 jss211">
                              ...
                              <span class="sc-bdVaJa jiARkd">
                                <span>Pérdida de tiempo</span>
											...
											<p class="my-2 text-center">
												<button type="button" id="btn_alquilar" name="btn_alquilar" class="btn btn-iamoving btn-lg" style="color:default;" data-toggle="modal" data-target="#modalAnuncia">Inform for Free</button>
											</p>						
...
<div id="modalAumentandoArriba" class="modal fade" role="dialog">
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <h4 id="modal-request-title" class="modal-title">Aumentamos por 10 tus posibilidades de alquilar</h4>
      </div>
      <div class="modal-body">
      			{!! csrf_field() !!} 
	          		<div class="col-md-12">
	          			<div class="form-group">
	          				...
	          				<label><b>7-La mayoría de los inquilinos huyen de las inmobiliarias</b></label>
	          				<ul>
								<li class="ml-5">
									En Iamoving no hay agencias ni intermediarios, somos una referencia a todos los inquilinos que no quieren alquilar a través de las inmobiliarias. De este modo, los inquilinos pueden encontrar fácilmente los pisos de particulares en nuestra plataforma, ya que tu anuncio no estará mezclado entre miles de agencias, como suele pasar en los portales inmobiliarios.
     ...
     <!-- <div class="modal-header">
      ...
      <div class="modal-body">
      			{!! csrf_field() !!} 
	          		<div class="col-md-12">
	          			<div class="form-group">
	          				<label><b>Enviamos las fotos y el contenido audiovisual en alta resolución y en baja resolución, ya que algunos en portales no es posible subir videos en alta resolución.</b></label>
	          				<!--<ul>
								<li class="ml-5">
