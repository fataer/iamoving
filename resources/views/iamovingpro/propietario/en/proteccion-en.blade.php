            ...
            <div class="col-md-10 singel-blog-content">
              <!--  <div class="row justify-content-center">
                    <div class="col text-center">
                        <img src="/img/iamoving_pro_grey_transparent.png" alt="Iamoving logo" width="175" class="m-0">
                    </div>
                </div>-->
               ...
               <!-- <h2 class="my-4 text-center"><b>Asegura tu alquiler y olvídate de todo</b></h2>-->
                ...
                <p class="my-1 text-center">
                     ...
                     Save the most valuable thing, your time.
                
                </p>
                <p class="my-1 text-center">
                
                   We eliminate 80% of unnecessary visits.

                
                </p>
                <p class="my-1 text-center">
                
                Free and without exclusive.
               ...
               <!-- <p class="my-4 text-center">
				...
				<p class="my-4 text-center">
																		<button type="button" class="btn btn-lg" style="background-color:#333333;color:#ffffff;font-weight:bold;" data-toggle="modal" data-target="#modalAnuncia">Inform for Free</button>
				</p>
				<!--<div class="row justify-content-center">		
                <div class="col-md-12">
                    <video-card 
				...
				<div class="collapse  my-0" id="collapseExample0">
				  <div class="card  bg-transparent border-dark my-0">
						  ...
						  <div class="card-body text-success  my-0">
							...
							<p class="card-text text-center">A virtual tour is more realistic than a series of conventional photographs, the tenant only visits the houses that really interest him and reduces the inconvenience for the owner by filtering out the visits of curious people. We take photos, videos, take measurements and make a detailed report of your home. We know that, when renting, all the details are very important. For this reason, we also offer a virtual tour of the surroundings of the property.</p>
							<p class="card-text text-center">Thus, those interested in visiting your flat will be able to make a <b>first visit without leaving home</b> and get to know all the details in depth, before visiting it in person. We work like this to save you time with thousands of calls, emails for more information and avoiding frustrated visits that do not contribute anything.</p>
						  </div>					
					  </div>
                  </div>					  
            </div>
			...
			<p class="my-3"></p>
				...
				<div class="collapse  my-0" id="collapseExample1">
				  <div class="card  bg-transparent border-dark my-0">
						  ...
						  <div class="card-body text-success  my-0">
								  <p class="card-text text-center">We advertise your property on our platform, our social networks, human resources departments of large multinationals, embassies, idealista, master's schools and universities.</p>							
						  </div>					
					  </div>
                  </div>					  
            </div>
			...
			<p class="my-3"></p>
				...
				<div class="collapse  my-0" id="collapseExample2">
				  <div class="card  bg-transparent border-dark my-0">
						  ...
						  <div class="card-body text-success  my-0">
							  <p class="card-text text-center">Once the interested party has made the virtual visit and is convinced that your apartment fits perfectly with what they are looking for, they can request a face-to-face visit, at which time we will send you their tenant profile: name, where they work, salary approx. , etc. so you can see if this tenant profile fits you. If it is the type of tenant you are looking for, you can confirm the visit or, if not, reject it.</p>
						  </div>					
					  </div>
                  </div>					  
            </div>
			...
			<p class="my-3"></p>
				...
				<div class="collapse  my-0" id="collapseExample3">
				  <div class="card  bg-transparent border-dark my-0">
						  ...
						  <div class="card-body text-success  my-0">
							<p class="card-text text-center">Choose the day, time and tenant you prefer to show him the apartment, meet him in person. No frustrated visits! We understand that it can be difficult to visit your home if you are busy or if you do not live near the property, we will help you with the visits.</p>
						  </div>					
					  </div>
                  </div>					  
            </div>
			...
			<p class="my-3"></p>
				...
				<div class="collapse  my-0" id="collapseExample31">
				  <div class="card  bg-transparent border-dark my-0">
						  ...
						  <div class="card-body text-success  my-0">
							<p class="card-text text-center">If you need it, we make the rental contract and help you with all your doubts.</p>
						  </div>					
					  </div>
                  </div>					  
            </div>			
			...
			<p class="my-3"></p>
				...
				<div class="collapse  my-0" id="collapseExample5">
				  <div class="card  bg-transparent border-dark my-0">
						  ...
						  <div class="card-body text-success  my-0">
								  <p class="card-text text-center">I loved the visit, the tenant suits me, but can I check that he is reliable and not a delinquent tenant? Yes, through an analysis of solvency, delinquency and viability, we will verify that the potential tenant is reliable and not a delinquent tenant. Eliminating all those tenants who falsify their pay slips to appear solvent and without counting the tenants with economic solvency and a good job but who go from floor to floor without paying rent.</p>							
						  </div>					
					  </div>
                  </div>					  
            </div>
      			...
      			{!! csrf_field() !!} 
	          		<div class="col-md-12">
	          			<div class="form-group">
	          				<ul>
								<li class="ml-5">
									If after 15 days we have not yet rented it and the exclusivity has expired, it will be automatically extended for a further 15 days, unless the owner states in writing his intention not to extend it at least five days in advance, before the expiration date of the exclusivity agreement or any of the extensions.
								</li>
							</ul>
