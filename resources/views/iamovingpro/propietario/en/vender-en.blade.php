								  ...
								  <div class="row mt-0">
									<div class="col-md-2">
										...
										<div class="col-md-8 text-center mb-0">
												<img src="/img/propicompra.png"  width="760" height="50" style="margin-bottom:0px;" alt="playa">  
																						</div>
...
<div class="col-md-12 text-center mb-0">										
									...
									<div class="col-md-2">
										...
										<p class="my-5 text-center">
												...
												<button type="button" id="btn_inicio" name="btn_inicio" class="btn-dark" style="color:yellow;"  data-toggle="modal" data-target="#modalAnuncia">Inform for Free</button>
										</p>
										...
										<div class="col-sm-5  d-block d-sm-block d-md-none">
											<ul class="ml-4">
											  <li class="ml-1"><i class="icon ion-md-checkmark-circle-outline"></i><h5 class="display-5" > Complete report, video, photos and detailed report of your house </h5></li>
											  <li class="ml-1"><i class="icon ion-md-checkmark-circle-outline"></i><h5 class="display-5" > No wasted time with calls always answering the same things </h5></li>
											  <li class="ml-1"><i class="icon ion-md-checkmark-circle-outline"></i><h5 class="display-5" > We eliminate thousands of unnecessary visits </h5></li>
											</ul>
											<p  class="ml-1 mt-3" style="color: #2d2e35 !important;"><i class="fa fa-check"></i> We increase your chances of selling and you will save time and money</p>
										</div>
											...
											<ul class="ml-4">
												<ul class="ml-5">
													<ul class="ml-5">
														<ul class="ml-5">
															<ul class="ml-4">
															  <li class="ml-5"><i class="icon ion-md-checkmark-circle-outline"></i><h5 class="display-5" > Complete report, video, photos and detailed report of your house </h5></li>
															  <li class="ml-5"><i class="icon ion-md-checkmark-circle-outline"></i><h5 class="display-5" > No wasted time with calls always answering the same things </h5></li>
															  <li class="ml-5"><i class="icon ion-md-checkmark-circle-outline"></i><h5 class="display-5" > We eliminate thousands of unnecessary visits </h5></li>
															</ul>
															<p  class="ml-5 mt-3" style="color: #2d2e35 !important;"><i class="fa fa-check"></i> We increase your chances of selling and you will save time and money</p>
														</ul>
													</ul>
												</ul>
											</ul>
										...
										<!--<ul class="ml-4">
										  <li class="ml-1"><i class="icon ion-md-checkmark-circle-outline"></i><h5 class="display-5" > Sin comisiones ni intermediarios, directo con el comprador </h5></li>
										...
										<div class="col-sm-5  d-block d-sm-block d-md-none">
											<ul class="ml-4">
											  <li class="ml-1"><i class="icon ion-md-checkmark-circle-outline"></i><h5 class="display-5" > Make your first visit without leaving home </h5></li>
											  <li class="ml-1"><i class="icon ion-md-checkmark-circle-outline"></i><h5 class="display-5" > No misleading information or photos </h5></li>
											  <li class="ml-1"><i class="icon ion-md-checkmark-circle-outline"></i><h5 class="display-5" > We verify all the flats avoiding you unnecessary visits </h5></li>
											</ul>
											<p  class="ml-1 mt-3" style="color: #2d2e35 !important;"><i class="fa fa-check"></i> We increase your chances of finding your home, saving time and money when buying </p>
										</div>
										<div class="ml-5 d-none d-sm-none d-md-block">
											<ul class="ml-4">
												<ul class="ml-5">
													<ul class="ml-5">
														<ul class="ml-5">
															<ul class="ml-4">
															  <li class="ml-5"><i class="icon ion-md-checkmark-circle-outline"></i><h5 class="display-5" > Make your first visit without leaving home </h5></li>
															  <li class="ml-5"><i class="icon ion-md-checkmark-circle-outline"></i><h5 class="display-5" > No misleading information or photos </h5></li>
															  <li class="ml-5"><i class="icon ion-md-checkmark-circle-outline"></i><h5 class="display-5" > We verify all the flats avoiding you unnecessary visits </h5></li>
															</ul>
															<p  class="ml-5 mt-3" style="color: #2d2e35 !important;"><i class="fa fa-check"></i> We increase your chances of finding your home, saving time and money when buying </p>
														</ul>
													</ul>
												</ul>
											</ul>
									...
									<!--
										...
										<div class="col-sm-5  d-block d-sm-block d-md-none">
											<ul class="ml-4">
											  <li class="ml-1"><i class="icon ion-md-checkmark-circle-outline"></i><h5 class="display-5" > Tomamos fotos y videos</h5></li>
											  <li class="ml-1"><i class="icon ion-md-checkmark-circle-outline"></i><h5 class="display-5" > Hacemos visitas</h5></li>
											...
											<p  class="ml-1 mt-3" style="color: #2d2e35 !important;"><i class="fa fa-check"></i> De este modo, puedes trabajar desde cualquier parte y reducir tus costes</p>
										</div>
										<div class="ml-5 d-none d-sm-none d-md-block">
											<ul class="ml-5">
												<ul class="ml-5">
													<ul class="ml-5">
														<ul class="ml-5">
															<ul class="ml-4">
															  <li class="ml-5"><i class="icon ion-md-checkmark-circle-outline"></i><h5 class="display-5" > Tomamos fotos y videos</h5></li>
															  <li class="ml-5"><i class="icon ion-md-checkmark-circle-outline"></i><h5 class="display-5" > Hacemos visitas</h5></li>
															...
															<p  class="ml-5 mt-3" style="color: #2d2e35 !important;"><i class="fa fa-check"></i> De este modo, puedes trabajar desde cualquier parte y reducir tus costes</p>
														</ul>
													</ul>
												</ul>
											</ul>
											...
											<div class="container my-2">
												<div class="row mt-3">
													...
													<div class="col-md-2">
														...
														<div class="section-title text-center my-0"  style="padding-top: 0px;padding-bottom: 0px;">
															<h4 class="text-center mb-0"><b>VIRTUAL TOUR</b></h4>
														</div>
														<h2 class="card-text text-center">ARE YOU AN OWNER?</h2>
														<p class="card-text text-center">WE IMPROVE YOUR WAY OF SELLING</p>

														
														<!--<span id="dots"></span><span id="more">-->
														<div class="text-success my-1">
															<p class="card-text text-center">In this way, nobody wastes time visiting or receiving visits that do not contribute anything, the buyer only visits the properties that really interest them and we eliminate all visits without potential to the property.</p>
														</div>											
														<div class="section-title text-center my-0"  style="padding-top: 10px;padding-bottom: 0px;">
															<h4 class="text-center mb-4"><b>+ THAN 800 VIRTUAL VISITS CARRIED OUT</b></h4>
														</div>					
														<div class="text-success my-1">
															<p class="card-text text-center">Our experience has shown that, for a variety of reasons, the Iamoving format is more realistic and effective than the normal format where only a series of photos of certain spaces and very basic information about the property are displayed.</p>
						   ...
						   <div class="row mt-5">
							...
							<div class="col-md-4">
							 ...
							 <p class="ml-0 text-center"><img src="/img/mobile.png"  width="70" height="70" style="margin-bottom:10px;" alt="diana"></p>
							  <h4 class="text-center mb-4"><b>HOW DOES IT WORK?</b></h4>
							  </div>
							</div>
							<div class="col-md-4">
							</div>
														...
														<div class="card">
															<nav class="nav nav-pills nav-justified border-bottom" role="tablist">
																<a class="nav-item nav-link active" href="#tab1" data-toggle="tab"
																	...
																	<span class="display-6 d-block">VIRTUAL VISIT</span>
																	
																</a>
																<a class="nav-item nav-link" href="#tab2" data-toggle="tab"
																	role="tab" aria-controls="tab2" aria-selected="false">
																	<span class="display-4 d-block">2</span>
																	<span class="display-6 d-block">PHYSICAL VISIT</span>
															...
															<div class="tab-content">
																<div role="tabpanel" class="tab-pane active" id="tab1">	
																	<div class="my-0" id="collapseExample3">
																	  <div class="card  bg-transparent border-dark my-0">
																			  <div class="card-body text-success  my-0">
																				<!--<h5 class="card-title">Success card title</h5>-->
																				<h5 class="display-5 text-center text-center my-1" >1-We go to your property and <b>create a complete experience of a virtual visit</b>🎥 for our users, we publish and thus they will be able to know every detail of your apartment before visiting it in person, avoiding many unnecessary visits.</h5>
																...
																<div role="tabpanel" class="tab-pane" id="tab2">
																	...
																	<div class="my-0" id="collapseExample3">
																	  <div class="card  bg-transparent border-dark my-0">
																			  <div class="card-body text-success  my-0">
																				<h5 class="display-5 text-center text-center my-1" >2-We publish and once our user has made the virtual visit and is convinced that the property really suits him, he will receive a request to show him your house in person.</h5>
																	...
																	<div class="my-0" id="collapseExample3">
																	  <div class="card  bg-transparent border-dark my-0">
																			  <div class="card-body text-success  my-0">
																				...
																				<h5 class="display-5 text-center text-center my-1" >3-Después que el interesado ha realizado su visita virtual y está convencido de que tu piso realmente le encaja, te llegará una solicitud para enseñarle en persona.</h5>
																			
																				<h5 class="display-5 text-center text-center mt-3" ><b>Escoge el día, la hora que tú prefieras para enseñar el piso y conocer en el potencial comprador en persona.</b></h5>
																			  </div>					
																		  </div>
																	  </div>	
						   ...
						   <div class="row mt-1">
							...
							<div class="col-md-4">
							 ...
							 <p class="ml-0 text-center"><img src="/img/diana.png"  width="70" height="70" style="margin-bottom:10px;" alt="diana"></p>
							  <h4 class="text-center mb-4"><b>WHAT DO WE GET?</b></h4>
							  </div>
							</div>
							<div class="col-md-4">
							</div>
					...
					<div class="row  justify-content-center">
						<div class="col-12">
							...
							<p class="my-0">
							  ...
							  WE SAVE THE MOST VALUABLE ASSET, YOUR TIME
							  </button>
							</p>
							<div class="collapse  my-0" id="collapseExample23">
							  <div class="card bg-transparent border-dark my-0">
										<div class="card-body text-success my-0">
											  ...
											  <h5 class="card-text text-center"><b>We save…</b></h5>
							<div class="col-md-12 ml-2">
								...
								<ul class="ml-0">
								  ...
								  <li class="ml-0 mt-4"><i class="icon ion-md-checkmark-circle-outline"></i><h5 class="display-5" > <b>Waste of time with unnecessary visits</b></h5></li>
								  <li class="ml-0" style="list-style:none;"><h5 class="display-5" >Time it would take to arrive at the property to make visits.</h5></li>
								  <li class="ml-0" style="list-style:none;"><h5 class="display-5" >Time wasted with visits that do not contribute anything.</h5></li>
								  <li class="ml-0" style="list-style:none;"><h5 class="display-5" >Plus the time it takes to get home.</h5></li>
								  <li class="ml-0 mt-4"><i class="icon ion-md-checkmark-circle-outline"></i><h5 class="display-5" > <b>Time with calls and emails</b></h5></li>
								  <li class="ml-0" style="list-style:none;"><h5 class="display-5" >Without wasting time answering the same questions hundreds of times, unfortunately most of the incoming emails and calls are not from potential buyers, making this process a huge waste of time. Our publication model will have all the answers to any question related to your property, 24 hours a day.</h5></li>								  
								  <li class="ml-0 mt-4"><i class="icon ion-md-checkmark-circle-outline"></i><h5 class="display-5" > <b>What do you like to do in your free time?</b></h5></li>
								  <li class="ml-0" style="list-style:none;"><h5 class="display-5" >Being with your family, friends or perhaps making money and not wasting time with thousands of frustrated calls, emails and visits.</h5></li>								  
								  ...
								  <li class="ml-5" style="list-style:none;"><h5 class="display-5" >La mayoría de los que están buscando pisos online afirman que no confían en la información y en las fotografías de los anuncios en los portales inmobiliarios.</h5></li>								  								  
								  <li class="ml-5" style="list-style:none;"><h5 class="display-5" >Los propietarios y agentes inmobiliarios, ambos con los mismos intereses, ALQUILAR O VENDER. Uno porque desea monetizar lo más rápido posible y el otro por sus comisiones.</h5></li>								  								  
								  ...
								  <li class="ml-5" style="list-style:none;"><h5 class="display-5" >Por lo tanto, nuestros usuarios saben que no ocultamos defectos o información sobre las propiedades y tampoco <b>“maquillamos” las fotos</b>, cosas puede ocurrir en este proceso. Siendo más confiable y dándoles más confianza en la toma de sus decisiones.</h5></li>								  								  
									<li class="ml-0 mt-4"><i class="icon ion-md-checkmark-circle-outline"></i><h5 class="display-5" > <b>¿Quién vive allí? (Información solo para quien está alquilando una habitación privada en un piso compartido)</b></h5></li>
					...
					<div class="row  justify-content-center">
						<div class="col-12">
							...
							<p class="my-0">
							  ...
							  style="font-weight:bold;border-radius:0%; !important;;outline:none !important;outline-width: 0 !important; box-shadow: none;-moz-box-shadow: none;-webkit-box-shadow: none;" >
							  WE INCREASE YOUR POSSIBILITIES OF SELLING 
							  </button>
							</p>
									  ...
									  <div class="card-body text-success my-0">
											...
											<div class="col-md-12 ml-2">
												...
												<ul class="ml-0">
												  ...
												  <li class="ml-0 mt-4"><i class="icon ion-md-checkmark-circle-outline"></i><h5 class="display-5" > <b>Many more contacts and visits in other channels</b></h5></li>								  
												  <li class="ml-0" style="list-style:none;"><h5 class="display-5" >The algorithms of the portals greatly improve the positioning of your ad when they have videos, more photos and more clicks.</h5></li>								  								  																								
												  <li class="ml-0 mt-4"><i class="icon ion-md-checkmark-circle-outline"></i><h5 class="display-5" > <b>Virtual Tour, you will be ahead</b></h5></li>								  
												  <li class="ml-0" style="list-style:none;"><h5 class="display-5" >Buyers say that a <b>Virtual Tour</b> gives them more confidence than a series of conventional photographs, being a decisive value when filtering their visits.</h5></li>								  								  
												  <li class="ml-0 mt-4"><i class="icon ion-md-checkmark-circle-outline"></i><h5 class="display-5" > <b>Attention to interested parties 24 hours a day</b></h5></li>								  
												  <li class="ml-0" style="list-style:none;"><h5 class="display-5" >Our ad delivery model automatically answers questions from all stakeholders 24 hours a day, because a missed email or call will immediately reduce your chances of selling against the competition.</h5></li>								  					

												  <li class="ml-0 mt-4"><i class="icon ion-md-checkmark-circle-outline"></i><h5 class="display-5" > <b>Interested parties from other provinces and other countries</b></h5></li>								  
												  <li class="ml-0" style="list-style:none;"><h5 class="display-5" >Not having to travel to see the property and being able to do it 24 hours a day, 365 days a year, generates an attraction for expatriates and investors who are in other provinces or even in other countries.</h5></li>								  					

												  <li class="ml-0 mt-4"><i class="icon ion-md-checkmark-circle-outline"></i><h5 class="display-5" > <b>A second opinion</b></h5></li>								  
												  <li class="ml-0" style="list-style:none;"><h5 class="display-5" >Another advantage is that, in addition to the fact that the interested party can visit the property as many times as they want on the day and in the place they prefer, they can also show the property to their family and friends before signposting, giving them more confidence and increasing your chances to sell.</h5></li>								  					
						...
						<div class="col-12">
							...
							<div class="col-md-12 ml-2">
								...
								<ul class="ml-0">
								  ...
								  <li class="ml-0 mt-4"><i class="icon ion-md-checkmark-circle-outline"></i><h5 class="display-5" > <b>No unnecessary visits</b></h5></li>								  
								  <li class="ml-0" style="list-style:none;"><h5 class="display-5" >Continuous expenses with visits that do not contribute anything, such as: transportation, fuel, parking, taxi, etc...</h5></li>								  								  
								  ...
								  <li class="ml-0" style="list-style:none;"><h5 class="display-5" >Nuestro modelo de visita virtual reduce automáticamente tu coste en personal para realización de visitas también.</h5></li>								  					-->
		...
		<!--	 <div class="row mt-0">
							...
							<div class="col-md-10 ml-2">
								...
								<ul class="ml-0">
								  ...
								  <li class="ml-5" style="list-style:none;"><h5 class="display-5" >Los inquilinos y compradores dicen que un <b>Tour Virtual</b> les da más confianza que una serie de fotografías convencionales, siendo un valor decisivo en la hora de filtrar sus visitas. Aumentando tus posibilidades.</h5></li>
								  ...
								  <li class="ml-5" style="list-style:none;"><h5 class="display-5" >Nuestro modelo de publicación de los anuncios responde automáticamente las preguntas de todos los interesados las 24 horas del día, ya que un correo electrónico o una llamada perdida reducirán de inmediato tus posibilidades de alquilar o vender frente a la competencia.</h5></li>								  
								  ...
								  <li class="ml-5" style="list-style:none;"><h5 class="display-5" >No tener que viajar para ver la propiedad y poder hacerlo las 24 horas del día, los 365 días del año, genera una atracción para <b>inversores, expatriados, estudiantes o turistas que se encuentran en otras provincias o incluso en otros países</b>.</h5></li>								  
								  <li class="ml-0 mt-4"><i class="icon ion-md-checkmark-circle-outline"></i><h5 class="display-5" > <b>Una segunda opinión</b></h5></li>
								  <li class="ml-5" style="list-style:none;"><h5 class="display-5" >Otra ventaja es que, además de que la parte interesada puede visitar la propiedad tantas veces como lo desee en el día y en el lugar que prefiera, también puede mostrar la propiedad a su familia y amigos antes de señalizar, dándoles más confianza y aumentando tus posibilidades de alquilar.</h5></li>								  
								  <li class="ml-0 mt-4"><i class="icon ion-md-checkmark-circle-outline"></i><h5 class="display-5" > <b>Sin conflicto de intereses</b></h5></li>
								  <li class="ml-5" style="list-style:none;"><h5 class="display-5" >La mayoría de los que están buscando pisos online afirman que no confían en la información y en las fotografías de los anuncios en los portales inmobiliarios.</h5></li>								  								  
								...
								<p class="mt-2 card-text text-center">
								  ...
								  <li class="ml-0"><i class="icon ion-md-checkmark-circle-outline"></i><h5 class="display-5" > <b>¿EL TIEMPO ES DINERO? Pues ahorramos muchísimo tiempo:</b> vender o alquilar un piso solo con fotografías, suele generar miles de vistas que no aportan en nada. Evitamos incontables visitas frustradas.</h5></li>
													...
													<!-- <div class="row mt-2 mb-3">
														...
														<div class="col-md-4">
														  <div class="text-center">
																   ...
																   aria-haspopup="true" style="font-weight:bold;color: #EADD1B;cursor:default;border-radius:0%; !important;outline:none !important;outline-width: 0 !important; box-shadow: none;-moz-box-shadow: none;-webkit-box-shadow: none;">
																					  PRECIO
																  </button>
			...
			<!--	<div class="container mt-5 my-1" >
					<div class="row grid-divider" >
						<div class="col-sm-6 mb-3 mr-0" style="padding-right: 10px;padding-left: 10px;">
						  <div class="col-padding">
							  <div class="card-body text-success" style="padding:.01rem;">
								<p class="card-text text-center">
								...
								<p class="card-text text-center mb-5 d-none d-sm-none d-md-block"><u>Se paga una vez que te entregamos todo el contenido audiovisual</u> (video, fotos y la publicación en iamoving.com).</p>						
								<p class="card-text text-center mb-0 d-none d-sm-none d-md-block">&nbsp;</p>						
						...
						<div class="col-sm-6"  style="padding-right: 0px;padding-left: 0px;">
							  <div class="card-body text-success ml-3"  style="padding:.01rem;">
								<p class="card-text text-center">
														<button type="button" class="btn btn-dark btn-lg btn-block border-warning"  aria-haspopup="true" 
														  style="font-weight:bold;color:#EADD1B;border-radius:0%; !important;;outline:none !important;outline-width: 0 !important; box-shadow: none;-moz-box-shadow: none;-webkit-box-shadow: none;" >
														  Plan Postpago
...
<span id="dots3"></span><span id="more4">
								<li class="ml-0"><i class="icon ion-md-checkmark-circle-outline"></i><h5 class="display-5" > <b>La mayoría de los compradores huyen de las inmobiliarias</b></h5></li> 
								<li class="ml-5" style="list-style:none;"><h5 class="display-5">En Iamoving no publicamos agencias ni intermediarios. De este modo, somos una referencia a todos los interesados que no quieren comprar a través de las inmobiliarias, los compradores pueden encontrar fácilmente los pisos de particulares en nuestra plataforma, ya que tu anuncio no estará mezclado entre miles de agencias, como suele pasar en los portales inmobiliarios.</h5></li>
								  <li class="ml-0"><i class="icon ion-md-checkmark-circle-outline"></i><h5 class="display-5" > <b>Los compradores saben que no cobramos comisión al propietario</b></h5></li>
								  <li class="ml-5" style="list-style:none;"><h5 class="display-5" >No recibimos ninguna comisión del propietario, así que, nuestros usuarios saben que el propietario no incrementa el precio de la venta para cubrir las comisiones de agencias, plataformas o intermediarios, como de costumbre.</h5></li>
								  <li class="ml-0"><i class="icon ion-md-checkmark-circle-outline"></i><h5 class="display-5" > <b>No recibimos ningún tipo de comisión al comprador</b></h5></li>
								  <li class="ml-5" style="list-style:none;"><h5 class="display-5" >A veces puede ocurrir que el comprador también tenga pagar comisiones al comprar un inmueble, bajando su interés de compra. Con Iamoving tu no va a estar encareciendo costes al comprador, es totalmente gratis para ambas las partes.</h5></li>								  
				...
				<!--<div class="container mt-5 my-1"  style="background-color:white;">
					<div class="row grid-divider" style="margin-right: 10px;">
						<div class="col-sm-6 mb-3">
						  <div class="col-padding">
							<h4 class="my-2 mb-4 text-center" ><b>COMPRADORES</b></h4>
								<p class="ml-4 text-center">
								 <div class="row mt-0">
									...
									<div class="col-md-12  d-none d-sm-none d-md-block">
										...
										<ul class="ml-4">
								  <li class="ml-1"><i class="icon ion-md-checkmark-circle-outline"></i><h5 class="display-5" > Sin agencias, trato directo con el propietario </h5></li>
								  <li class="ml-1"><i class="icon ion-md-checkmark-circle-outline"></i><h5 class="display-5" > Sin comisiones ocultas escondidas dentro del precio </h5></li>
								  <li class="ml-1"><i class="icon ion-md-checkmark-circle-outline"></i><h5 class="display-5" > Verificamos todos los pisos, evitando estafas </h5></li>
								  <li class="ml-1"><i class="icon ion-md-checkmark-circle-outline"></i><h5 class="display-5" > Sin fotos engañosas ni visitas frustradas </h5></li>
								</ul>
								<p  class="ml-1 mt-3" style="color: #2d2e35 !important;"><i class="fa fa-check"></i> La forma más rápida, segura y económica de comprar</p>
							...
							<div class="col-sm-5  d-block d-sm-block d-md-none">
							  <div class="pricing-box">
								<ul class="ml-4">
								  <li class="ml-5"><i class="icon ion-md-checkmark-circle-outline"></i><h5 class="display-5" > Sin agencias, trato directo con el propietario </h5></li>
								  <li class="ml-5"><i class="icon ion-md-checkmark-circle-outline"></i><h5 class="display-5" > Sin comisiones ocultas escondidas dentro del precio </h5></li>
								  ...
								  <li class="ml-5"><i class="icon ion-md-checkmark-circle-outline"></i><h5 class="display-5" > Sin fotos engañosas ni visitas frustradas </h5></li>
									...
									<p  class="ml-5 mt-4" style="color: #2d2e35 !important;"><i class="fa fa-check"></i> La forma más rápida, segura y económica de comprar</p>										
									  </div>
									</div>							
						...
						<div class="col-sm-6">
						 ...
						 <div class="row mt-0">
							<div class="col-md-12  d-none d-sm-none d-md-block">
								<ul class="ml-4">
								  <li class="ml-1"><i class="icon ion-md-checkmark-circle-outline"></i><h5 class="display-5" > Sin inmobiliarias ni intermediarios, trato directo con el comprador </h5></li>
								  <li class="ml-1"><i class="icon ion-md-checkmark-circle-outline"></i><h5 class="display-5" > Sin comisiones ni cuota fija, no pagas nada si vendes </h5></li>
								  <li class="ml-1"><i class="icon ion-md-checkmark-circle-outline"></i><h5 class="display-5" > Publicidad 100% gratuita y sin tarifa de renovación </h5></li>
								  <li class="ml-1"><i class="icon ion-md-checkmark-circle-outline"></i><h5 class="display-5" > Sin pérdida de tiempo con llamadas ni con visitas frustradas </h5></li>
								</ul>
								<p  class="ml-1 mt-3" style="color: #2d2e35 !important;"><i class="fa fa-check"></i> Aumentamos tus posibilidades de vender y ahorrarás tiempo y dinero</p>
							</div>

							<div class="col-sm-5  d-block d-sm-block d-md-none">
							  <div class="pricing-box">
								<ul class="ml-4">
								  <li class="ml-5"><i class="icon ion-md-checkmark-circle-outline"></i><h5 class="display-5" > Sin inmobiliarias ni intermediarios, trato directo con el comprador </h5></li>
								  <li class="ml-5"><i class="icon ion-md-checkmark-circle-outline"></i><h5 class="display-5" > Sin comisiones ni cuota fija, no pagas nada si vendes  </h5></li>
								  <li class="ml-5"><i class="icon ion-md-checkmark-circle-outline"></i><h5 class="display-5" > Publicidad 100% gratuita y sin tarifa de renovación </h5></li>
								  <li class="ml-5"><i class="icon ion-md-checkmark-circle-outline"></i><h5 class="display-5" > Sin pérdida de tiempo con llamadas ni con visitas frustradas </h5></li>
								</ul>
								<p  class="ml-5 mt-4" style="color: #2d2e35 !important;"><i class="fa fa-check"></i> Aumentamos tus posibilidades de vender y ahorrarás tiempo y dinero</p>
							  </div>
							</div>							
...
<!--							<div class="d-none d-md-block d-lg-block d-xl-block">
					...
					<!--	<div class="container my-0">
								  <div class="row mt-5">
									...
									<div class="col-md-2">
										...
										<div class="text-success my-1">
											<p class="card-text text-center">Vamos al inmueble, tomamos fotos, medimos, hacemos un informe detallado de cada espacio y un video que simula la experiencia de visitar físicamente la propiedad y te dejaremos un enlace correspondiente a la visita.</p>
										</div>	
			...
			<!--	<div class="container mt-5 my-1">
					<div class="row grid-divider" style="margin-right: 10px;">
						<div class="col-sm-6 mb-3">
						  <div class="col-padding">
						  <p class="ml-4 text-center"><img src="/img/free_iamoving.png"  width="70" height="70" style="margin-bottom:10px;" alt="movil"></p>
							<h4 class="my-2 mb-4 text-center" ><b>GRATIS</b></h4>
						<p class="ml-4 text-center">¿Eres propietario? Si quieres, publicamos totalmente gratis la visita virtual de tu inmueble en nuestra plataforma y en nuestras redes sociales.</p>
						  </div>
						</div>
						<div class="col-sm-6">
						  <div class="col-padding">
							<p class="ml-4 text-center"><img src="/img/visita.png"  width="70" height="70" style="margin-bottom:10px;" alt="visita"></p>
							<h4 class="my-2 mb-4 text-center"><b>VISITA CON EL POTENCIAL COMPRADOR, ANTES CONOZCA EL PERFIL DEL INTERESADO </b></h4>
							<p class="ml-4 text-center">Después de que nuestro usuario haga su visita virtual y esté convencido de que tu casa realmente se ajusta a lo que está buscando, podrá solicitar una visita presencial, en este momento esta solicitud se te enviará directamente, sin ninguna intermediación,  
								<span id="dots2">...</span><span id="more2">con su perfil de comprador: nombre, teléfono, correo electrónico, etc. </p>
								</span></p>
						 ...
						 <div class="row mt-0">
							...
							<div class="col-md-5 ml-3  d-none d-sm-none d-md-block">
								...
								<ul class="ml-5">
								  ...
								  <li class="ml-5"><i class="icon ion-md-checkmark-circle-outline"></i><h5 class="display-5" > Aumentamos por 10 tus posibilidades de vender <a  @click.prevent="modalAumentaArriba"><img src="/img/info_iamoving.png"  width="15" height="15" style="margin-bottom:5px;" alt="info"></a></h5></li>
							...
							<div class="col-sm-5  d-block d-sm-block d-md-none">
							  <div class="pricing-box">
								<ul class="ml-4">
								  ...
								  <li class="ml-0"><i class="icon ion-md-checkmark-circle-outline"></i><h5 class="display-5" > Aumentamos por 10 tus posibilidades de vender <a  @click.prevent="modalAumentaArriba"><img src="/img/info_iamoving.png"  width="15" height="15" style="margin-bottom:5px;" alt="info"></a></h5></li>
...
<div class="row justify-content-center">
					<div class="m70hd6-0 fBCnjt tooltipEl" data-placement="top" id="clickeable" onclick="location.href='/vendiendo-con-iamoving/en';" style="cursor:pointer;" alt="Ver más" >
                      <div class="jss33 jss37 jss34 sc-95xf8-0 ecJbVf" style="border:2px solid #333333; background-color:#333333">
                        <div class="sc-1x6rk30-0 hAjjvO" >
                          <div tabindex="-1" color="" height="24">
                           <!-- <span class="jss259">-->
                             <!-- <span><h4><b>CON EXCLUSIVA</b></h4></span>-->
                           <!-- </span>-->
                          </div>
                          <!--<b><h4><span style="color:#ffffff;">IAMOVINGpro</span></h4></b>-->
                <div class="row justify-content-center">
                    <div class="col text-center">
                        <img src="/img/iamoving_white_transparent.png" alt="Iamoving logo" width="175" class="m-0">
                    </div>
                </div>						  
                          <!--<span style="color:#FFFFFF;">Plan protección alquiler</span>-->
						  <p class="my-0 sc-1n10p5-0 jDJpTw sc-bdVaJa ibMzuR">
                          <span  style="color:#ffffff;">Sell for free and without exclusive</span>
                        </p>
                        </div>
                       <!-- <p class="my-0 sc-1n10p5-0 jDJpTw sc-bdVaJa ibMzuR">
                          <span  style="color:#ffffff;">Ahórrate lo más valioso, tu tiempo.</span>
                        </p>-->
                        <ul class="jss200 jss201">						
                          ...
                          <li class="jss204 jss208 jss211">
								...
								<!--carita feliz<svg aria-hidden="true" focusable="false" data-prefix="far" data-icon="smile" class="svg-inline--fa fa-smile fa-w-16"
                            ...
                            <div class="jss221 jss223">
                              <span class="sc-bdVaJa jiARkd">
                                <span  style="color:#ffffff;">Virtual visit</span>
                              </span>
                            </div>
                          </li>
                          <li class="jss204 jss208 jss211">
                            ...
                            <div class="jss221 jss223">
                              <span class="sc-bdVaJa jiARkd">
                                <span  style="color:#ffffff;">Publication</span>
                              </span>
                            </div>
							  ...
							  <li class="jss204 jss208 jss211">
								...
								<div class="jss221 jss223">
								  <span class="sc-bdVaJa jiARkd">
									<span  style="color:#ffffff;">Foreign buyers</span>
								  </span>
								</div>
							  </li>								  
							  <li class="jss204 jss208 jss211">
								...
								<div class="jss221 jss223">
								  <span class="sc-bdVaJa jiARkd">
									<span  style="color:#ffffff;">We make visits</span>
								  </span>
								</div>
							  </li>
							  <!--<li class="jss204 jss208 jss211">
								...
								<div class="jss221 jss223">
								  <span class="sc-bdVaJa jiARkd">
									<span  style="color:#ffffff;">Asesoramiento jurídico</span>
								  </span>
								</div>
							  </li>-->
							 <!-- <li class="jss204 jss208 jss211">
								...
								<div class="jss221 jss223">
								  <span class="sc-bdVaJa jiARkd">
									<span  style="color:#ffffff;">1% iva no incluido</span>
								  </span>
								</div>
							  </li>	-->						  
                    ...
                    <div class="m70hd6-0 fBCnjt">
                      <div class="jss33 jss37 jss34 sc-95xf8-0 ecJbVh" style="border:2px solid #333333;">
					  <!--<div class="sc-1x6rk30-0 hAjjvO" >-->
                         <div class="sc-1x6rk30-0 hAjjvO" >
                          <div tabindex="-1" color="" height="24">
                           <!-- <span class="jss259">-->
                          ...
                          <b><h4><span style="color:#333333;">Selling out ofIAMOVING</span></h4></b>
                          <!--<span style="color:#FFFFFF;">Plan protección alquiler</span>-->
						<p class="my-0 sc-1n10p5-0 jDJpTw sc-bdVaJa ibMzuR">
                          <span  style="color:#333333;">When publishing your apartment outside of IAMOVING, your nightmare begins:</span>
                        </p>						  
                        </div>
                       <!-- <p class="my-0 sc-1n10p5-0 jDJpTw sc-bdVaJa ibMzuR">
                          <span  style="color:#333333;">Al publicar tu piso fuera de iamoving, comienza tu pesadilla:</span>
                        </p>-->
                        <ul class="jss200 jss201">
                          <li class="jss204 jss208 jss211">
                            <svg class="jss215 undefined jss214 sc-6ysmz4-0 fEgzNb" focusable="false" viewBox="0 0 24 24" aria-hidden="true" theme="[object Object]">
                              <g>
                            ...
                            <div class="jss221 jss223">
                              <span class="sc-bdVaJa jiARkd">
                                <span  style="color:#333333;">Thousands of unwanted calls</span>
                              </span>
                            </div>
                          </li>
                          <li class="jss204 jss208 jss211">
                            ...
                            <div class="jss221 jss223">
                              <span class="sc-bdVaJa jiARkd">
                                <span  style="color:#333333;">Curious people who come to hang out and do not contribute anything, frustrated visits</span>
                              </span>
                            </div>
                            ...
                            <svg class="jss215 undefined jss214 sc-6ysmz4-0 fEgzNb" focusable="false" viewBox="0 0 24 24" aria-hidden="true" theme="[object Object]">
                              <g>
								...
								<div class="jss221 jss223">
								  <span class="sc-bdVaJa jiARkd">
									<span  style="color:#333333;">A lot of waste of time</span>
								  </span>
								</div>
							  </li>
							  <li class="jss204 jss208 jss211">
                            <svg class="jss215 undefined jss214 sc-6ysmz4-0 fEgzNb" focusable="false" viewBox="0 0 24 24" aria-hidden="true" theme="[object Object]">
                              <g>
								...
								<div class="jss221 jss223">
								  <span class="sc-bdVaJa jiARkd">
									<span  style="color:#333333;">Expenses with photographic report and advertisements in real estate portals</span>
								  </span>
								</div>
							  </li>								  
							  <!--<li class="jss204 jss208 jss211">
                            <svg class="jss215 undefined jss214 sc-6ysmz4-0 fEgzNb" focusable="false" viewBox="0 0 24 24" aria-hidden="true" theme="[object Object]">
                              <g>
								...
								<div class="jss221 jss223">
								  <span class="sc-bdVaJa jiARkd">
									<span  style="color:#333333;">Sin apoyo jurídico</span>
								  </span>
								</div>
							  </li>-->
                        </ul>
												...
												<button type="button" id="btn_vender" name="btn_vender" class="btn btn-iamoving btn-lg" style="color:default;" data-toggle="modal" data-target="#modalAnuncia">Inform for Free</button>
											</p>
       ...
       <div class="container my-0 mt-4">
							...
							<div class="swiper-slide">
											...
											<div class="card">
												...
												<div class="testimonial">
														...
														<h3 class="title">Miguel Propietario <a href="/VisitaVirtual/705">Referencia 705</a></h3></h3>
            ...
            <br>
                @include('iamovingpro.propietario.en.includes.anuncia-en')
      			...
      			{!! csrf_field() !!} 
	          		<div class="col-md-12">
	          			<div class="form-group">
	          				...
	          				<ul>
								<li class="ml-5">
									Sin perder tiempo respondiendo las mismas preguntas cientos de veces, la mayoría de los correos electrónicos y las llamadas entrantes no son de potenciales compradores, lo que hace que este proceso sea una gran pérdida de tiempo. Nuestro modelo de publicación tendrá todas las respuestas a cualquier pregunta relacionada con tu propiedad, las 24 horas del día.
								</li>
							</ul>
...
<div id="modalAumentando" class="modal fade" role="dialog">
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <h4 id="modal-request-title" class="modal-title">Aumentamos tus posibilidades de vender</h4>
      </div>
      <div class="modal-body">
      			{!! csrf_field() !!} 
	          		<div class="col-md-12">
	          			<div class="form-group">
	          				...
	          				<ul>
								<li class="ml-5">
									Los compradores dicen que un recorrido virtual les da más confianza que una serie de fotografías convencionales, siendo un valor decisivo en la hora de filtrar sus visitas. Aumentando tus posibilidades, ya que un tour virtual vale más que mil imágenes.
								</li>
							</ul>
	          				<label><b>2-Atención a compradores ​​las 24 horas del día</b></label>
	          				<ul>
								<li class="ml-5">
									Nuestro modelo de publicación de los anuncios responde automáticamente las preguntas de todos los interesados las 24 horas del día, ya que un correo electrónico o una llamada perdida reducirán de inmediato tus posibilidades de vender frente a la competencia.
								</li>
							
							</ul>
	          				<label><b>3-Interesado de otras provincias y otros países</b></label>
	          				<ul>
								<li class="ml-5">
									No tener que viajar para ver la propiedad y poder hacerlo las 24 horas del día, los 365 días del año, genera una atracción para aquellos interesados ​​que residen en otras provincias o incluso en otros países <b>(profesionales expatriados o inversores)</b>.
								</li>
							</ul>
	          				<label><b>4-Una segunda opinión</b></label>
	          				<ul>
								<li class="ml-5">
									Otra ventaja es que, además de que la parte interesada puede visitar la propiedad tantas veces como lo desee en el día y en el lugar que prefiera, también puede mostrar la propiedad a su familia y amigos antes de alquilar o señalizar, dándoles más confianza y aumentando tus posibilidades de vender.
								</li>
							
							</ul>
	          				<label><b>5-Sin conflicto de intereses</b></label>
	          				<ul>
								<li class="ml-5">
									La mayoría de los que están buscando pisos online afirman que no confían en la información y en las fotografías de los anuncios en los portales inmobiliarios. Los propietarios y agentes inmobiliarios, ambos con los mismos intereses, <b>VENDER</b>. Uno porque desea monetizar su alquiler lo más rápido posible y el otro por sus comisiones.
								</li>
								<li class="ml-5">
									Iamoving no recibe comisión del propietario ni del comprador, somos neutrales, mostramos la verdad sin ningún conflicto de intereses.
								</li>
								<li class="ml-5">
	          				...
	          				<!--<label><b>6-Préstamo hipotecario</b></label>
	          				<ul>
								<li class="ml-5">
									No cobramos nada por llevar a cabo un estudio personalizado de acuerdo con las necesidades del interesado en comprar tu casa. El potencial comprador tendrá un especialista financiero asignado para responder sus preguntas y acompañarlo durante todo el proceso. Hacemos la vida más fácil para el comprador y aumentamos tu capacidad de venta.
								</li>
							</ul>
	          				<label><b>7-Los compradores huyen de las inmobiliarias</b></label>
	          				<ul>
								<li class="ml-5">
									En Iamoving no hay agencias ni intermediarios. De este modo, somos una referencia a todos los interesados que no quieren comprar a través de las inmobiliarias, los compradores pueden encontrar fácilmente los pisos de particulares en nuestra plataforma, ya que tu anuncio no estará mezclado entre miles de agencias, como suele pasar en los portales inmobiliarios.
								</li>
							
							</ul>
	          				<label><b>8-Los compradores saben que no cobramos comisión al propietario</b></label>
	          				<ul>
								<li class="ml-5">
									No recibimos ninguna comisión del propietario, así que, nuestros usuarios saben que el propietario no incrementa el precio de la venta para cubrir las comisiones de agencias, plataformas o intermediarios, como de costumbre.
								</li>
							
							</ul>
	          				<label><b>9-No recibimos ningún tipo de comisión al comprador</b></label>
	          				<ul>
								<li class="ml-5">
									A veces puede ocurrir que el comprador también tenga pagar comisiones al comprar un inmueble, bajando su interés de compra. Con Iamoving tu no va a estar encareciendo costes al comprador, es totalmente gratis para ambas las partes.
								</li>
							</ul>
...
<div id="modalAumentandoArriba" class="modal fade" role="dialog">
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <h4 id="modal-request-title" class="modal-title">Aumentamos por 10 tus posibilidades de vender</h4>
      </div>
      <div class="modal-body">
      			{!! csrf_field() !!} 
	          		<div class="col-md-12">
	          			<div class="form-group">
	          				<label><b>1-Tour virtual, estarás por delante</b></label>
	          				<ul>
								<li class="ml-5">
									Los compradores dicen que un recorrido virtual les da más confianza que una serie de fotografías convencionales, siendo un valor decisivo en la hora de filtrar sus visitas. Aumentando tus posibilidades de visitas.
								</li>
							</ul>
	          				<label><b>2-Atención a compradores ​​las 24 horas del día</b></label>
	          				<ul>
								<li class="ml-5">
									Nuestro modelo de publicación de los anuncios responde automáticamente las preguntas de todos los compradores las 24 horas del día, ya que un correo electrónico o una llamada perdida reducirán de inmediato tus posibilidades de vender frente a la competencia.
								</li>
	          				...
	          				<ul>
								<li class="ml-5">
No tener que viajar para ver la propiedad y poder hacerlo las 24 horas del día, los 365 días del año, genera una atracción para aquellos interesados ​​que residen en otras provincias o incluso en otros países (profesionales expatriados o inversores del extranjero).
								</li>
							</ul>
	          				<label><b>4-Una segunda opinión</b></label>
	          				<ul>
								<li class="ml-5">
									Otra ventaja es que, además de que la parte interesada puede visitar la propiedad tantas veces como lo desee en el día y en el lugar que prefiera, también puede mostrar la propiedad a su familia y amigos antes de dejar una señal, dándole más confianza y aumentando tus posibilidades de venta.
								</li>
	          				...
	          				<ul>
								<li class="ml-5">
									La mayoría de los que están buscando pisos online afirman que no confían en la información y en las fotografías de los anuncios en los portales inmobiliarios. Los propietarios y agentes inmobiliarios, ambos con los mismos intereses, VENDER. Uno porque desea monetizar su venta lo más rápido posible y el otro por sus comisiones.
								</li>
								<li class="ml-5">
									Iamoving no recibe comisión del propietario ni del comprador, somos neutrales, mostramos la verdad sin ningún conflicto de intereses.
								</li>
								<li class="ml-5">
									Por lo tanto, nuestros usuarios saben que no ocultamos defectos o información sobre las propiedades y tampoco “maquillamos” las fotos, cosas puede suceder en este proceso. Siendo más confiable y dándole más confianza en la toma de sus decisiones.
								</li>								
							</ul>
	          				<label><b>6-Préstamo hipotecario</b></label>
	          				<ul>
	          				...
	          				<label><b>7-La mayoría de los compradores huyen de las inmobiliarias</b></label>
	          				<ul>
								<li class="ml-5">
									En Iamoving no hay agencias ni intermediarios. De este modo, somos una referencia a todos los interesados que no quieren comprar a través de las inmobiliarias, los compradores pueden encontrar fácilmente los pisos de particulares en nuestra plataforma, ya que tu anuncio no estará mezclado entre miles de agencias, como suele pasar en los portales inmobiliarios.            
								</li>
...
<div id="modalEvitando" class="modal fade" role="dialog">
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-content">
     <!-- <div class="modal-header">
        <h4 id="modal-request-title" class="modal-title">Sin comisiones y evitamos todos los gastos económicos innecesarios</h4>
      </div>-->
      <div class="modal-body">
      			{!! csrf_field() !!} 
	          		<div class="col-md-12">
	          			<div class="form-group">
	          				<label><b>Si  quieres, te entregamos todas las imágenes y el video, sin marcas de agua y sin mencionar el nombre de IAMOVING, permitiéndote la libertad de usarlo como mejor te parezca.</b></label>
	          				<!--<ul>
								<li class="ml-5">
									Gastos con visitas frustradas, tales como: transporte, combustible, parking, etc.
								</li>
							</ul>
	          				<label><b>2-Sin comisiones</b></label>
	          				<ul>
								<li class="ml-5">
        ...
        $(document).ready(function() { 
            ...
            function processJson(data) {
                ...
                if(data.success){
                    ...
                    Swal.fire(
                        'We are sorry',
                        'We were unable to receive your information. Try again',
                        'error'
                    );
                }
            }
            ...
            $('#publicarForm').ajaxForm({ 
                ...
                beforeSubmit: function(arr, $form, options) {                  
                    ...
                    $("#btnSend").html('Sending your information');
