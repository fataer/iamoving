...
<!--							<div class="d-none d-md-block d-lg-block d-xl-block">
     ...
     <div class="row mt-3 mb-3">
		...
		<!-- <div class="container my-5">
					...
					<div class="text-success my-1">
						<p class="card-text text-center">Basta enviar por WhatsApp o email el enlace <a href="https://www.iamoving.com/VisitaVirtual/568" target="_blank">https://www.iamoving.com/VisitaVirtual/568</a> de tu visita virtual que hemos realizado a todos los interesados que te contacten, mediante las plataformas inmobiliarias o a través de otros canales. Si lo preferires, escribe directamente en la descripción de tu propio anuncio, explicándoles.</p>
