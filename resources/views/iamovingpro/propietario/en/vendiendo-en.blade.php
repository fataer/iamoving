            ...
            <div class="col-md-10 singel-blog-content">
                ...
                <!--<div class="row justify-content-center">
                    <div class="col text-center">
                        <img src="/img/iamoving_pro_grey_transparent.png" alt="IAMPRO logotipo" width="175" class="m-0">
                    </div>
                </div>-->
                <!--<h2 class="my-4 text-center">¡De particular a particular!</h2>-->
                <h2 class="mt-4 mb-2 text-center"><b>SELL FREE AND WITHOUT EXCLUSIVE</b></h2>
				...
				<div class="collapse  my-0" id="collapseExample0">
				  <div class="card  bg-transparent border-dark my-0">
						  ...
						  <div class="card-body text-success  my-0">
							...
							<p class="card-text text-center">A virtual tour is more realistic than a series of conventional photographs, the buyer only visits the houses that really interest him and reduces the inconvenience for the owner by filtering the visits of curious people. We take photos, videos, take measurements and make a detailed report of your home. We know that, when it comes to selling, all the details are very important. For this reason, we also offer a virtual tour of the surroundings of the property.</p>
							<p class="card-text text-center">Thus, those interested in visiting your flat will be able to make <b>a first visit without leaving home</b> and get to know all the details in depth, before visiting it in person. We work to save you time with thousands of calls, emails and visits that do not contribute anything.</p>
						  </div>					
					  </div>
                  </div>					  
            </div>
			...
			<p class="my-3"></p>
				...
				<div class="collapse  my-0" id="collapseExample1">
				  <div class="card  bg-transparent border-dark my-0">
						  ...
						  <div class="card-body text-success  my-0">
								  <p class="card-text text-center">On iamoving.com, on our social networks and on idealista too.</p>							
						  </div>					
					  </div>
                  </div>					  
            </div>
			...
			<p class="my-3"></p>
				...
				<div class="collapse  my-0" id="collapseExample2">
				  <div class="card  bg-transparent border-dark my-0">
						  ...
						  <div class="card-body text-success  my-0">
							  <p class="card-text text-center">By not having to travel to see the property and being able to do so 24 hours a day, 365 days a year, it attracts buyers who reside in other provinces or even in other countries, thus increasing the chances of sale.</p>
						  </div>					
					  </div>
                  </div>					  
            </div>
			...
			<p class="my-3"></p>
				...
				<div class="collapse  my-0" id="collapseExample3">
				  <div class="card  bg-transparent border-dark my-0">
						  ...
						  <div class="card-body text-success  my-0">
							<p class="card-text text-center">Once the interested party has made his virtual visit and is convinced that your apartment fits what he is looking for, he can request a face-to-face visit. Choose the day and time that you prefer to show him the flat, without frustrated visits. We understand that it can be difficult to visit your home if it is occupied or if you do not live near the property, we will help you with the visits.</p>
						  </div>					
					  </div>
                  </div>					  
            </div>
      			...
      			{!! csrf_field() !!} 
	          		<div class="col-md-12">
	          			<div class="form-group">
	          				<ul>
								<li class="ml-5">
									If after 45 days we have still not sold it and the exclusivity has expired, it will be automatically extended for 15 more days, unless the owner states in writing his intention not to extend it at least five days in advance, before the expiration date of the exclusivity agreement or any of the extensions.
								</li>
							</ul>
